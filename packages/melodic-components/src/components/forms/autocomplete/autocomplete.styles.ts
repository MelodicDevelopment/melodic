...
export const autocompleteStyles = () => css`
	...
	*::after {
	...
	.ml-autocomplete__label {
		font-size: var(--ml-autocomplete-label-font-size, var(--ml-text-sm));
		font-weight: var(--ml-autocomplete-label-font-weight, var(--ml-font-medium));
		color: var(--ml-autocomplete-label-color, var(--ml-color-text-secondary));
		line-height: var(--ml-autocomplete-label-line-height, var(--ml-leading-tight));
	}

	.ml-autocomplete__required {
		color: var(--ml-autocomplete-required-color, var(--ml-color-danger));
	...
	.ml-autocomplete__trigger {
		display: flex;
		align-items: center;
		gap: var(--ml-autocomplete-gap, var(--ml-space-2));
		width: 100%;
		max-width: 100%;
		overflow: hidden;
		padding: var(--ml-autocomplete-padding, var(--ml-space-2-5) var(--ml-space-3-5));
		background-color: var(--ml-autocomplete-bg, var(--ml-color-input-bg));
		border: var(--ml-autocomplete-border-width, var(--ml-border)) solid var(--ml-autocomplete-border-color, var(--ml-color-border));
		border-radius: var(--ml-autocomplete-border-radius, var(--ml-radius));
		box-shadow: none;
		color: var(--ml-autocomplete-color, var(--ml-color-text));
		font-family: var(--ml-autocomplete-font-family, var(--ml-font-sans));
		font-size: var(--ml-autocomplete-font-size, var(--ml-text-sm));
		cursor: text;
		text-align: left;
		transition:
			border-color var(--ml-autocomplete-transition-duration, var(--ml-duration-150)) var(--ml-autocomplete-transition-easing, var(--ml-ease-in-out)),
			box-shadow var(--ml-autocomplete-transition-duration, var(--ml-duration-150)) var(--ml-autocomplete-transition-easing, var(--ml-ease-in-out));
	}

	.ml-autocomplete:not(.ml-autocomplete--disabled) .ml-autocomplete__trigger:hover {
		border-color: var(--ml-autocomplete-hover-border-color, var(--ml-color-border-strong));
	}

	.ml-autocomplete__trigger:focus-within {
		outline: none;
		border-color: var(--ml-autocomplete-focus-border-color, var(--ml-color-primary));
		box-shadow: var(--ml-autocomplete-focus-shadow, var(--ml-shadow-focus-ring));
	}

	.ml-autocomplete--disabled .ml-autocomplete__trigger {
		background-color: var(--ml-autocomplete-disabled-bg, var(--ml-color-input-disabled-bg));
		cursor: not-allowed;
		color: var(--ml-autocomplete-disabled-color, var(--ml-color-text-muted));
	}

	.ml-autocomplete__search-icon {
		color: var(--ml-autocomplete-icon-color, var(--ml-color-text-muted));
		flex-shrink: 0;
		height: 20px;
		display: flex;
		align-items: center;
	...
	.ml-autocomplete__input::placeholder {
		color: var(--ml-autocomplete-placeholder-color, var(--ml-color-text-muted));
	}
	...
	.ml-autocomplete__clear {
		...
		background: transparent;
		padding: 2px;
		color: var(--ml-autocomplete-clear-color, var(--ml-color-text-muted));
		cursor: pointer;
		display: inline-flex;
		align-items: center;
		...
		transition: color var(--ml-duration-100) var(--ml-autocomplete-transition-easing, var(--ml-ease-in-out)),
			background-color var(--ml-duration-100) var(--ml-autocomplete-transition-easing, var(--ml-ease-in-out));
	}

	.ml-autocomplete__clear:hover {
		color: var(--ml-autocomplete-clear-hover-color, var(--ml-color-text));
		background-color: var(--ml-autocomplete-clear-hover-bg, var(--ml-color-surface-raised));
	}
	...
	.ml-autocomplete__tag {
		...
		height: var(--ml-autocomplete-tag-height, 20px);
		border-radius: var(--ml-autocomplete-tag-border-radius, var(--ml-radius-full));
		border: var(--ml-autocomplete-border-width, var(--ml-border)) solid var(--ml-autocomplete-tag-border-color, var(--ml-color-border));
		background-color: var(--ml-autocomplete-tag-bg, var(--ml-color-surface));
		font-size: var(--ml-autocomplete-tag-font-size, var(--ml-text-xs));
		font-weight: var(--ml-autocomplete-tag-font-weight, var(--ml-font-medium));
		color: var(--ml-autocomplete-tag-color, var(--ml-color-text));
		line-height: 1;
		white-space: nowrap;
		max-width: 100%;
		overflow: hidden;
	...
	.ml-autocomplete__tag-remove {
		...
		margin-left: var(--ml-space-0-5);
		margin-right: -4px;
		color: var(--ml-autocomplete-tag-remove-color, var(--ml-color-text-secondary));
		cursor: pointer;
		display: inline-flex;
		align-items: center;
		justify-content: center;
	...
	.ml-autocomplete__tag-remove:hover {
		color: var(--ml-autocomplete-tag-remove-hover-color, var(--ml-color-text));
		background-color: var(--ml-autocomplete-tag-remove-hover-bg, var(--ml-color-surface-raised));
	}
	...
	.ml-autocomplete__dropdown {
		...
		margin: 0;
		z-index: 50;
		background-color: var(--ml-autocomplete-dropdown-bg, var(--ml-color-surface));
		border: var(--ml-autocomplete-border-width, var(--ml-border)) solid var(--ml-autocomplete-dropdown-border-color, var(--ml-color-border));
		border-radius: var(--ml-autocomplete-dropdown-border-radius, var(--ml-radius));
		box-shadow: var(--ml-autocomplete-dropdown-shadow, var(--ml-shadow-lg));
		max-height: var(--ml-autocomplete-dropdown-max-height, 280px);
		overflow-y: auto;
		padding: var(--ml-autocomplete-dropdown-padding, var(--ml-space-1-5));
		display: flex;
		flex-direction: column;
		gap: var(--ml-space-1);
	}
	...
	.ml-autocomplete__empty {
		padding: var(--ml-autocomplete-option-padding, var(--ml-space-2) var(--ml-space-3));
		font-size: var(--ml-autocomplete-option-font-size, var(--ml-text-sm));
		color: var(--ml-autocomplete-placeholder-color, var(--ml-color-text-muted));
	}
	...
	.ml-autocomplete__option {
		...
		gap: var(--ml-autocomplete-gap, var(--ml-space-2));
		padding: var(--ml-autocomplete-option-padding, var(--ml-space-2) var(--ml-space-3));
		border-radius: var(--ml-autocomplete-option-border-radius, var(--ml-radius-sm));
		cursor: pointer;
		font-size: var(--ml-autocomplete-option-font-size, var(--ml-text-sm));
		font-weight: var(--ml-autocomplete-option-font-weight, var(--ml-font-medium));
		color: var(--ml-autocomplete-option-color, var(--ml-color-text));
		transition: background-color var(--ml-duration-100) var(--ml-autocomplete-transition-easing, var(--ml-ease-in-out));
	}

	.ml-autocomplete__option:hover:not(.ml-autocomplete__option--disabled) {
		background-color: var(--ml-autocomplete-option-hover-bg, var(--ml-color-surface-raised));
	}
	...
	.ml-autocomplete__option--selected {
		background-color: var(--ml-autocomplete-option-selected-bg, var(--ml-color-primary-subtle));
	}
	...
	.ml-autocomplete__option--disabled {
		color: var(--ml-autocomplete-option-disabled-color, var(--ml-color-text-muted));
		cursor: not-allowed;
	}
	...
	.ml-autocomplete__option--selected .ml-autocomplete__option-icon {
		color: var(--ml-autocomplete-option-check-color, var(--ml-color-primary));
	}
	...
	.ml-autocomplete__option-subtitle {
		font-size: var(--ml-autocomplete-option-subtitle-font-size, var(--ml-text-xs));
		font-weight: var(--ml-font-normal);
		color: var(--ml-autocomplete-option-subtitle-color, var(--ml-color-text-muted));
		overflow: hidden;
		text-overflow: ellipsis;
		white-space: nowrap;
	}
	...
	.ml-autocomplete__error {
		font-size: var(--ml-autocomplete-hint-font-size, var(--ml-text-sm));
		line-height: var(--ml-autocomplete-label-line-height, var(--ml-leading-tight));
	}

	.ml-autocomplete__hint {
		color: var(--ml-autocomplete-hint-color, var(--ml-color-text-muted));
	}

	.ml-autocomplete__error {
		color: var(--ml-autocomplete-error-color, var(--ml-color-danger));
	}

	.ml-autocomplete--error .ml-autocomplete__trigger {
		border-color: var(--ml-autocomplete-error-border-color, var(--ml-color-danger));
	}

	.ml-autocomplete--error .ml-autocomplete__trigger:focus-within {
		box-shadow: var(--ml-autocomplete-error-focus-shadow, var(--ml-shadow-ring-error));
	}
