export { focusTrap, createFocusTrap, getDeepActiveElement, isDeepFocusWithin } from './focus-trap.js';
export type { FocusTrap, FocusTrapOptions, FocusTrapDeactivateOptions } from './focus-trap.js';
