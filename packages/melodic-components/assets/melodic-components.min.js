...
const Nr = {
  ...
  "--ml-card-footer-bg": "var(--ml-gray-800)"
	...
	${Object.entries(Te).map(([e, t]) => `${e}: ${t};`).join(`
	`)}
...
var te = "system", he = /* @__PURE__ */ new Set(), Y = null;
function Gi() {
  return te;
}
function Lr() {
  return te === "system" ? window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light" : te;
}
function Fr(e) {
  if (Y && (Y(), Y = null), te = e, e === "system") {
    const t = window.matchMedia("(prefers-color-scheme: dark)"), r = () => {
      const a = t.matches ? "dark" : "light";
      document.documentElement.setAttribute("data-theme", a), me("system", a);
    };
    t.addEventListener("change", r), Y = () => t.removeEventListener("change", r);
    const l = t.matches ? "dark" : "light";
    document.documentElement.setAttribute("data-theme", l), me("system", l);
  } else
    document.documentElement.setAttribute("data-theme", e), me(e, e);
}
function Ui(e) {
...
function Xi(e, t) {
  const r = pr(e, t), l = document.createElement("style");
...
function Ji(e, t) {
  const r = {};
  return t.primary && (r["--ml-color-primary"] = t.primary), t.secondary && (r["--ml-color-secondary"] = t.secondary), t.success && (r["--ml-color-success"] = t.success), t.warning && (r["--ml-color-warning"] = t.warning), t.danger && (r["--ml-color-danger"] = t.danger), pr(e, r);
}
function Vr(e, t, r) {
...
function ae(e, t, r = {}) {
  const { placement: l = "bottom", middleware: a = [] } = r, o = e.getBoundingClientRect(), s = t.getBoundingClientRect(), { x: d, y: c } = Vr(o, s, l);
  let m = {
    x: d,
    y: c,
    placement: l,
...
function Br(e) {
  ...
  for (; r; ) {
    ...
    if (l instanceof Element) {
      const { overflow: a, overflowX: o, overflowY: s } = getComputedStyle(l);
      /auto|scroll|overlay|hidden/.test(a + o + s) && t.push(l), r = l;
    } else break;
  }
  return t;
}
function we(e, t, r, l = {}) {
  const { ancestorScroll: a = !0, ancestorResize: o = !0, elementResize: s = !0, animationFrame: d = !1 } = l, c = [];
  if (a) {
    const m = Br(e);
    for (const p of m)
...
function oe(e = 0) {
  ...
  return {
    name: "offset",
    fn(l) {
      const { x: a, y: o, placement: s } = l, d = re(s);
      let c = a, m = o;
      switch (d) {
        case "top":
          m -= t, c += r;
...
function De(e, t, r, l) {
  ...
  return {
    top: l - t,
    right: e + r.width - a.width + l,
    bottom: t + r.height - a.height + l,
    left: l - e
  };
}
function Ae(e, t) {
...
function ie(e = {}) {
  ...
  return {
    name: "flip",
    fn(r) {
      const { x: l, y: a, placement: o, rects: s } = r, d = re(o);
      if (!Ae(De(l, a, s.floating, t), d)) return;
      const c = jr(o), m = e.fallbackPlacements ?? [c];
      for (const p of m) {
        const u = qr(s.reference, s.floating, p);
        if (!Ae(De(u.x, u.y, s.floating, t), re(p))) return {
          x: u.x,
          y: u.y,
          placement: p
        };
...
function se(e = {}) {
  ...
  return {
    name: "shift",
    fn(a) {
      const { x: o, y: s, rects: d } = a, c = {
        width: window.innerWidth,
        height: window.innerHeight
      };
      let m = o, p = s;
      if (l || r) {
        const u = t, v = c.width - d.floating.width - t;
        m = Math.max(u, Math.min(m, v));
      }
      if (l || r) {
        const u = t, v = c.height - d.floating.height - t;
        p = Math.max(u, Math.min(p, v));
      }
      return {
        x: m,
        y: p
...
function ur(e) {
  ...
  return {
    name: "arrow",
    fn(l) {
      const { rects: a, placement: o } = l, s = re(o), d = t.getBoundingClientRect(), c = d.width, m = d.height;
      let p, u;
      if (s === "top" || s === "bottom") {
        p = a.reference.left + a.reference.width / 2 - l.x - c / 2;
        const v = r, _ = a.floating.width - c - r;
        p = Math.max(v, Math.min(p, _));
      } else {
        u = a.reference.top + a.reference.height / 2 - l.y - m / 2;
        const v = r, _ = a.floating.height - m - r;
        u = Math.max(v, Math.min(u, _));
      }
...
function ke(e) {
  return Array.from(e.querySelectorAll(Hr)).filter((t) => !(t.offsetParent === null && t.style.position !== "fixed" || getComputedStyle(t).visibility === "hidden"));
}
function hr(e) {
  return ke(e)[0] ?? null;
}
...
function Wr(e, t = {}) {
  ...
  function d(u) {
    ...
    u.shiftKey ? document.activeElement === _ && (u.preventDefault(), k.focus()) : document.activeElement === k && (u.preventDefault(), _.focus());
  }
  function c() {
    if (!o) {
      if (o = !0, s = document.activeElement, e.addEventListener("keydown", d), r) r.focus();
      else if (a) {
        const u = hr(e);
        u && u.focus();
      }
  ...
  function m() {
    if (!o) return;
    o = !1, e.removeEventListener("keydown", d);
    const u = l ?? s;
...
var W = !1, Ie = !1;
function vr() {
  Ie || (Ie = !0, document.addEventListener("keydown", () => {
    W = !0;
...
function rs(e, t = "focus-visible") {
  ...
  return e.addEventListener("focus", r), e.addEventListener("blur", l), () => {
    e.removeEventListener("focus", r), e.removeEventListener("blur", l), e.classList.remove(t);
  };
}
var D = null;
function Gr() {
...
var gr = class {
  ...
  attach(e, t) {
    this._viewport = e, this._options = t, this._resizeObserver = new ResizeObserver((r) => {
      for (const l of r) this._compute(l.contentRect.height);
  ...
  _compute(e) {
    ...
    const { rowHeight: t, itemCount: r, onUpdate: l, enabled: a, buffer: o = 3 } = this._options, s = r();
    if (a && !a()) {
      l(0, s);
      return;
    }
    const d = this._viewport.scrollTop, c = t();
    l(Math.max(0, Math.floor(d / c) - o), Math.min(s, Math.ceil((d + e) / c) + o));
  }
};
const Ur = () => "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replaceAll(/[xy]/g, function(e) {
  const t = Math.trunc(Math.random() * 16);
  return (e === "x" ? t : t & 3 | 8).toString(16);
});
var Me = /* @__PURE__ */ new WeakMap(), Yr = class br {
  constructor(t) {
    this._factory = null, this._hasEvents = !1, this._canCompile = !1, this.analyzeAndCompile(t);
  }
  static compile(t) {
    let r = Me.get(t);
    return r || (r = new br(t), Me.set(t, r)), r;
  }
  /**
  ...
  */
  analyzeAndCompile(t) {
    ...
    for (const w of t) if (w.includes("@")) {
      this._hasEvents = !0;
      return;
    }
    let r = t[0];
    for (let w = 1; w < t.length; w++) r += `\${${w - 1}}` + t[w];
    const l = r.match(/^<([\w-]+)([^>]*)>(.*)$/s);
    if (!l) return;
    const [, a, o, s] = l, d = `</${a}>`;
    if (!s.endsWith(d)) return;
    const c = s.slice(0, -d.length), m = [], p = /([\w-]+)\s*=\s*(?:"([^"]*)"|'([^']*)'|\$\{(\d+)\})/g;
    let u;
    for (; (u = p.exec(o)) !== null; ) {
      const w = u[1], R = u[2] ?? u[3], C = u[4];
      if (C !== void 0) m.push({
        name: w,
        valueIndex: parseInt(C, 10)
      });
      else if (R !== void 0) {
        const E = R.match(/\$\{(\d+)\}/);
        E ? m.push({
          name: w,
          valueIndex: parseInt(E[1], 10)
        }) : m.push({
          name: w,
          valueIndex: null,
          staticValue: R
    ...
    const v = [], _ = c, k = /\$\{(\d+)\}/g;
    let y = 0, x;
    for (k.lastIndex = 0; (x = k.exec(_)) !== null; )
      x.index > y && v.push({ static: _.slice(y, x.index) }), v.push({ valueIndex: parseInt(x[1], 10) }), y = x.index + x[0].length;
    y < _.length && v.push({ static: _.slice(y) }), this._factory = (w) => {
      const R = document.createElement(a);
      for (const E of m) if (E.valueIndex !== null) {
        const S = w[E.valueIndex];
        S != null && S !== !1 && R.setAttribute(E.name, S === !0 ? "" : String(S));
      } else E.staticValue !== void 0 && R.setAttribute(E.name, E.staticValue);
      let C = "";
      for (const E of v) "static" in E ? C += E.static : C += w[E.valueIndex] ?? "";
...
function $(e, t, r) {
  return ne((l, a) => {
    if (!a) {
      ...
      const s = document.createComment("repeat-start"), d = document.createComment("repeat-end");
      o.replaceChild(s, l), o.insertBefore(d, s.nextSibling);
      const c = {
...
function Pe(e, t, r, l) {
  const a = l.items, o = /* @__PURE__ */ new Map(), s = [];
  ...
  if (a.length === e.length) {
    ...
    for (let _ = 0; _ < e.length; _++) {
      const k = t(e[_], _);
      if (_ >= a.length || a[_].key !== k) {
        v = !1;
        break;
      }
    }
    if (v) {
      for (let _ = 0; _ < e.length; _++) r(e[_], _).renderInto(a[_].container);
      return;
    }
  }
  if (l.useCompiledPath === void 0 && e.length > 0) {
    const v = r(e[0], 0), _ = Yr.compile(v.strings);
    l.useCompiledPath = _.canUseFastPath(), l.useCompiledPath && (l.compiledTemplate = _);
  }
  const d = /* @__PURE__ */ new Map(), c = /* @__PURE__ */ new Map();
  for (const v of a)
    d.set(v.key, v), c.set(v.key, c.size);
  for (let v = 0; v < e.length; v++) {
    const _ = e[v], k = t(_, v);
    if (d.has(k)) {
      const y = d.get(k);
      d.delete(k), r(_, v).renderInto(y.container), s.push({
        item: y,
        oldIndex: c.get(k) ?? -1,
        isNew: !1
      });
    } else {
      const y = Xr(_, v, k, r, l);
      s.push({
        item: y,
        oldIndex: -1,
        isNew: !0
  ...
  for (const v of d.values()) Zr(v);
  if (s.length === 0) {
    l.keyToIndex = o, l.items = [];
    return;
  }
  const m = el(s), p = l.startMarker.parentElement;
  let u = l.endMarker;
  for (let v = s.length - 1; v >= 0; v--) {
    const _ = s[v];
    _.isNew ? Jr(_.item, p, u) : m.has(v) || Qr(_.item, u), u = _.item.start;
  }
  l.keyToIndex = o, l.items = s.map((v) => v.item);
}
function Xr(e, t, r, l, a) {
  const o = l(e, t);
  let s, d;
  if (a.useCompiledPath && a.compiledTemplate) {
    const c = a.compiledTemplate.createDirect(o.values);
    c ? (s = [c], d = document.createDocumentFragment(), d.appendChild(c)) : (d = document.createDocumentFragment(), s = o.renderOnce(d));
  } else
    d = document.createDocumentFragment(), s = o.renderOnce(d);
  return {
    key: r,
    value: e,
    container: d,
...
function el(e) {
  ...
  const l = tl(t), a = /* @__PURE__ */ new Set();
  for (const o of l) {
    const s = r[o];
    s !== void 0 && a.add(s);
  }
...
function n(e, t, r) {
  return ne((l, a) => {
    if (!a) {
      ...
      const s = document.createComment("when-start"), d = document.createComment("when-end");
      o.replaceChild(s, l), o.insertBefore(d, s.nextSibling);
      const c = {
        condition: !1,
        template: t(),
      ...
      return e ? X(c, !0) : c.falseTemplate && X(c, !1), c.condition = e, c;
    }
    if (!a.startMarker.parentNode) throw new Error("when() directive: markers were removed from DOM");
    if (e && !a.condition)
      Oe(a), a.template = t(), X(a, !0);
    else if (!e && a.condition)
      Oe(a), r && (a.falseTemplate = r(), X(a, !1));
    else if (e && a.condition) {
      const o = t();
      a.container && o.renderInto(a.container), a.template = o;
    } else if (!e && !a.condition && r) {
      const o = r();
      a.container && o.renderInto(a.container), a.falseTemplate = o;
    }
...
function X(e, t) {
  ...
  l.renderInto(a), e.container = a, e.nodes = Array.from(a.childNodes);
...
function h(e) {
  return ne((t, r) => {
    ...
    for (const [o, s] of Object.entries(e)) s && (l.classList.add(o), a.add(o));
    if (r)
      for (const o of r) a.has(o) || l.classList.remove(o);
    return a;
  });
}
function j(e) {
  return ne((t, r) => {
    const l = t, a = /* @__PURE__ */ new Set();
    for (const [o, s] of Object.entries(e)) s !== void 0 && (l.style.setProperty(o.replace(/([A-Z])/g, "-$1").toLowerCase(), String(s)), a.add(o));
    if (r)
      for (const o of r) a.has(o) || l.style.removeProperty(o.replace(/([A-Z])/g, "-$1").toLowerCase());
    return a;
  });
}
var Z = /* @__PURE__ */ new Map(), rl = (e) => {
  if (Z.has(e)) return Z.get(e);
  const t = e.toLowerCase();
  for (const [r, l] of Z) if (r.toLowerCase() === t) return l;
};
function $e(e, t) {
  Z.set(e, t);
}
...
function il(e, t, r) {
  ...
  const l = ol(t), a = al(l.target);
  if (!a) {
    console.warn(`portal directive: target "${l.target}" not found`);
    return;
  }
  if (e.parentNode === a) return;
  const o = document.createComment("portal-placeholder");
  return e.parentNode?.insertBefore(o, e), e.removeAttribute(":portal"), a.appendChild(e), () => {
...
var de = `m${Math.random().toString(36).slice(2, 9)}`, sl = `<!--${de}-->`, Ce = `__${de}_`, Ne = new RegExp(`${Ce}(\\d+)__`, "g"), Q = (e) => `${Ce}${e}__`, H = /* @__PURE__ */ new Map(), Le = /* @__PURE__ */ new WeakMap();
function Fe(e) {
  let t = Le.get(e);
  return t === void 0 && (t = e.join(de), Le.set(e, t)), t;
}
var nl = class K {
  constructor(t, r) {
  ...
  */
  renderOnce(t) {
    const r = Fe(this.strings), l = this.getTemplate(r), a = l.element.content.cloneNode(!0), o = this.prepareParts(a, l);
    return this.commit(o), t.appendChild(a), t.__parts = o, t.__templateKey = r, Array.from(t.childNodes);
  }
  renderInto(t) {
    const r = Fe(this.strings), { element: l } = this.getTemplate(r), a = t.__templateKey;
    if (a && a !== r) {
      const s = t.__parts;
      s && this.cleanupParts(s), delete t.__parts;
    }
    if (!t.__parts) {
      const s = l.content.cloneNode(!0), d = this.prepareParts(s, this.getTemplate(r));
      t.__parts = d, t.__templateKey = r, this.commit(d), t.textContent = "", t.appendChild(s);
      return;
    }
  ...
  getTemplate(t) {
    ...
    const o = this.getAttributePreProcessor(l);
    let s = null, d = null;
    for (let x = 1; x < this.strings.length; x++) {
      const w = this.strings[x], R = x - 1, C = /([@.:]?[\w:-]+)\s*=\s*["']?$/.exec(a), E = /([@.:]?[\w:-]+)\s*=\s*(["'])([^"']*)$/.exec(a);
      let S = "___";
      if (s) a += Q(R);
      else {
        const T = E?.[1]?.charAt(0), z = T !== void 0 && Object.keys(o).includes(T);
        if (E && !z)
          a += Q(R), s = E[1], d = E[2];
        else {
          if (C) {
            S = "__";
            const N = C[1].charAt(0);
            Object.keys(o).includes(N) && (S = N);
          }
          if (S === "__" && C) {
            a += Q(R), s = C[1];
            const N = /(["'])$/.exec(C[0]);
      ...
      a += w, s && (d ? w.includes(d) && (s = null, d = null) : /[\s>]/.test(w) && (s = null, d = null));
    }
    const c = document.createElement("template");
    c.innerHTML = a;
    const m = [];
    let p = 0;
    const u = [], v = /* @__PURE__ */ new Map(), _ = /* @__PURE__ */ new Map(), k = /* @__PURE__ */ new Map();
    for (const x of l) switch (x.type) {
      case "event":
        v.set(x.index, x);
        break;
      case "property":
    ...
    const y = (x, w) => {
      if (x.nodeType === Node.COMMENT_NODE) {
        ...
        const C = x;
        for (let E = C.attributes.length - 1; E >= 0; E--) {
          const S = C.attributes[E];
          if (S.name.startsWith("__event-")) {
            const T = parseInt(S.name.match(/__event-(\d+)__/)?.[1] || "0"), z = v.get(T);
            z && m.push({
              path: [...w],
              type: "event",
              index: z.index,
          ...
          } else if (S.name.startsWith("__prop-")) {
            const T = parseInt(S.name.match(/__prop-(\d+)__/)?.[1] || "0"), z = _.get(T);
            z && m.push({
              path: [...w],
              type: "property",
              index: z.index,
          ...
          } else if (S.name.startsWith("__action-")) {
            const T = parseInt(S.name.match(/__action-(\d+)__/)?.[1] || "0"), z = k.get(T);
            z && m.push({
              path: [...w],
              type: "action",
              index: z.index,
          ...
          } else if (S.name.startsWith(":")) m.push({
            path: [...w],
            type: "action",
            index: -1,
            name: S.name.slice(1),
          ...
          else if (S.value.includes(Ce)) {
            const T = this.parseAttributeValue(S.value);
            if (T) {
              const z = T.indices.length > 1 || T.strings.some((N) => N.length > 0);
              m.push({
                path: [...w],
                type: "attribute",
                index: T.indices[0],
  ...
  getAttributePreProcessor(t) {
    return {
      "@": (r, l, a, o) => (t.push({
        ...
        index: r,
        name: a?.slice(1)
      }), l.slice(0, -(o?.[0].length ?? 0)) + `__event-${r}__=""`),
      ".": (r, l, a, o) => (t.push({
        type: "property",
        index: r,
        name: a?.slice(1)
      }), l.slice(0, -(o?.[0].length ?? 0)) + `__prop-${r}__=""`),
      ":": (r, l, a, o) => (t.push({
        type: "action",
        index: r,
        name: a?.slice(1)
  ...
  prepareParts(t, r) {
    const l = [], { partPaths: a } = r;
    for (const o of a) {
      let s = t;
      for (const d of o.path) s = s.childNodes[d];
      if (o.type === "node") {
        const d = document.createTextNode("");
        s.parentNode.replaceChild(d, s), l.push({
          type: "node",
          index: o.index,
          node: d
        });
        ...
        const d = s;
        d.removeAttribute(`__event-${o.index}__`), l.push({
          type: "event",
          index: o.index,
          name: o.name,
          node: d
        ...
        const d = s;
        d.removeAttribute(`__prop-${o.index}__`), l.push({
          type: "property",
          index: o.index,
          name: o.name,
          node: d
        ...
        const d = s;
        o.index >= 0 ? d.removeAttribute(`__action-${o.index}__`) : d.removeAttribute(`:${o.name}`), l.push({
          type: "action",
          index: o.index,
          name: o.name,
          node: d,
        ...
        const d = s;
        d.removeAttribute(o.name), l.push({
          type: "attribute",
          index: o.index,
          name: o.name,
          node: d,
  ...
  parseAttributeValue(t) {
    const r = [], l = [];
    let a = 0, o;
    for (Ne.lastIndex = 0; (o = Ne.exec(t)) !== null; )
  ...
  */
  ensureMarkers(t) {
    ...
    if (!r) return;
    const l = document.createComment("part-start"), a = document.createComment("part-end");
    r.insertBefore(l, t.node), r.insertBefore(a, t.node.nextSibling), t.startMarker = l, t.endMarker = a;
  }
  /**
  ...
  cleanupParts(t) {
    for (const r of t) {
      if (r.actionCleanup) try {
        ...
        console.error("Action directive cleanup failed:", l);
      } finally {
  ...
  */
  renderArray(t, r) {
    ...
    const l = t.endMarker.parentNode, a = this.getKeyedValues(r);
    if (a) {
      ...
      for (const p of a) {
        const u = s.items.get(p.key);
        if (u)
          this.updateArrayItem(u, p.value, l, t.endMarker), d.set(p.key, u);
        else {
          const v = this.createArrayItem(p.value, l, t.endMarker);
          d.set(p.key, {
            key: p.key,
            value: p.value,
      ...
      for (const [p, u] of s.items.entries()) if (!d.has(p)) for (const v of u.nodes) v.parentNode?.removeChild(v);
      let m = t.startMarker.nextSibling;
      for (const p of c) {
        const u = d.get(p);
        for (const v of u.nodes) {
          if (v === m) {
            m = m?.nextSibling ?? null;
            continue;
          }
          l.insertBefore(v, m ?? t.endMarker);
        }
      }
      t.arrayState = {
        items: d,
        keys: c
      }, t.renderedNodes = c.flatMap((p) => d.get(p).nodes);
      return;
    }
    this.clearRenderedNodes(t);
    const o = [];
    for (const s of r) if (s instanceof K) {
      const d = document.createDocumentFragment();
      s.renderInto(d);
      const c = Array.from(d.childNodes);
      o.push(...c), l.insertBefore(d, t.endMarker);
    } else if (s instanceof Node)
      o.push(s), l.insertBefore(s, t.endMarker);
    else if (s != null) {
      const d = document.createTextNode(String(s));
      o.push(d), l.insertBefore(d, t.endMarker);
    }
    t.renderedNodes = o;
  }
  getKeyedValues(t) {
    ...
    const r = [];
    for (const l of t) if (l && typeof l == "object" && l.__keyed === !0) {
      const a = l;
      r.push({
        key: a.key,
        value: a.value
  ...
  createArrayItem(t, r, l) {
    const a = document.createDocumentFragment();
    t instanceof K ? t.renderInto(a) : t instanceof Node ? a.appendChild(t) : t != null && a.appendChild(document.createTextNode(String(t)));
  ...
  updateArrayItem(t, r, l, a) {
    ...
    if (r !== t.value) {
      ...
      t.container = document.createDocumentFragment(), r instanceof Node ? t.container.appendChild(r) : r != null && t.container.appendChild(document.createTextNode(String(r))), t.nodes = Array.from(t.container.childNodes), l.insertBefore(t.container, a), t.value = r;
    }
  }
  commit(t) {
    for (const r of t) {
      const l = this.values[r.index], a = r.type === "attribute" && r.attributeIndices && r.attributeStrings;
      if (!(!a && !J(l) && r.type !== "action" && r.previousValue === l)) {
        switch (r.type) {
          case "node":
            r.node && (J(l) ? r.directiveState = l.render(r.node, r.directiveState) : l instanceof K ? this.renderNestedTemplate(r, l) : l instanceof Node ? this.renderNode(r, l) : Array.isArray(l) ? this.renderArray(r, l) : (this.clearRenderedNodes(r), r.node.textContent = String(l ?? "")));
            break;
          case "attribute":
            if (r.node && r.name) {
              const o = r.node;
              if (J(l)) r.directiveState = l.render(o, r.directiveState);
              else if (a) {
                const s = r.attributeStrings, d = r.attributeIndices;
                let c = s[0] ?? "";
                for (let m = 0; m < d.length; m++) {
                  const p = this.values[d[m]];
                  c += `${p ?? ""}${s[m + 1] ?? ""}`;
                }
                if (r.previousValue === c) break;
                c === "" && s.every((m) => m === "") ? o.removeAttribute(r.name) : o.setAttribute(r.name, c), r.previousValue = c;
                continue;
              } else l == null || l === !1 ? o.removeAttribute(r.name) : l === !0 ? o.setAttribute(r.name, "") : o.setAttribute(r.name, String(l));
            }
            break;
          case "property":
            r.node && r.name && (J(l) ? r.directiveState = l.render(r.node, r.directiveState) : r.node[r.name] = l);
            break;
          case "event":
            if (r.node && r.name) {
              const o = r.node;
              if (r.previousValue === l) break;
              r.previousValue && typeof r.previousValue == "function" && o.removeEventListener(r.name, r.previousValue), typeof l == "function" && o.addEventListener(r.name, l);
            }
            break;
          case "action":
            if (r.node && r.name) {
...
function cl(e, t) {
  if (!t) return;
  const { content: r, placement: l } = dl(t);
  if (!r) return;
...
$e("tooltip", cl);
const M = (e) => typeof e == "string" ? e : typeof e == "symbol" ? e.toString() : e.name;
function U(e = {}) {
  return function(t) {
    const r = e.token ?? t, l = e.dependencies?.map((a) => M(a));
    B.bind(r, t, {
...
var pe = class {
  ...
  withDependencies(e) {
    return this._dependencies = e.map((t) => M(t)), this;
  }
  withArgs(e) {
  ...
  bind(e, t, r) {
    let l, a, o;
    typeof t == "function" ? (l = e, a = t, o = r) : (l = e, a = e, o = t);
    const s = M(l), d = new pe(s, l, "class");
    return d.setClass(a), o?.singleton !== void 0 && d.setSingleton(o.singleton), o?.dependencies && d.withDependencies(o.dependencies), o?.args && d.withArgs(o.args), this._bindings.set(s, d), d;
  }
  bindValue(e, t) {
    const r = M(e), l = new pe(r, e, "value");
    return l.setInstance(t), l.setSingleton(!0), this._bindings.set(r, l), l;
  }
  bindFactory(e, t, r) {
    const l = M(e), a = new pe(l, e, "factory");
    return a.setFactory(t), r?.singleton !== void 0 && a.setSingleton(r.singleton), this._bindings.set(l, a), a;
  }
  get(e) {
    const t = M(e), r = this._bindings.get(t);
  ...
  resolve(e, t) {
    ...
    if (this._constructionStack.has(t)) {
      const l = Array.from(this._constructionStack).join(" -> ") + ` -> ${t}`;
  ...
  construct(e, t) {
    ...
    let l = [];
    const a = r.params;
    if (a && Array.isArray(a)) for (let o = 0; o < a.length; o++) {
      const s = a[o];
      if (s && typeof s == "object" && s.__injectionToken) {
        const d = s.__injectionToken, c = this._bindings.get(d);
        if (!c) throw new Error(`Dependency '${d}' not found (required by '${t}')`);
        l.push(this.resolve(c, d));
      } else l.push(void 0);
    }
...
function F(e) {
  return function(t, r) {
    ...
    t[l] = e, Object.defineProperty(t, r, {
      get() {
        const a = `__cached_${String(r)}`;
        return this[a] || (this[a] = B.get(e)), this[a];
      },
      enumerable: !0,
      configurable: !0
    });
...
const fr = Symbol("melodic.signal"), pl = (e) => typeof e == "function" && fr in e;
var je = "melodic-styles", ul = `style[${je}], link[rel="stylesheet"][${je}]`, Se = [], ue = null;
const hl = (e) => {
  if (gl()) {
    Be(e);
    return;
  }
  ue || (ue = vl()), ue.then(() => Be(e));
};
var vl = async () => {
  const e = document.querySelectorAll(ul);
  if (e.length !== 0)
    for (const t of e) {
      ...
      }), qe(Array.from(t.sheet?.cssRules ?? []).map((r) => r.cssText).join(`
`)));
    }
}, Be = (e) => {
  const t = e.adoptedStyleSheets ?? [], r = Se.filter((l) => !t.includes(l));
  r.length > 0 && (e.adoptedStyleSheets = [...t, ...r]);
}, qe = (e) => {
  const t = e.trim();
  if (t.length > 0) {
    const r = new CSSStyleSheet();
    r.replaceSync(t), Se.push(r);
  }
}, gl = () => Se.length > 0, bl = class extends HTMLElement {
  constructor(e, t) {
    super(), this._unsubscribers = [], this._renderScheduled = !1, this._booleanProperties = /* @__PURE__ */ new Set(), this._meta = e, this._component = t, this._component.elementRef = this, this._root = this.attachShadow({ mode: "open" }), hl(this._root), this._style = this.renderStyles(), this.observe(), this._component.onInit && this._component.onInit();
  }
  get component() {
  ...
  attributeChangedCallback(e, t, r) {
    const l = e.replace(/-([a-z])/g, (a, o) => o.toUpperCase());
    if (this._component[l] !== void 0) {
      let a = r;
      this._booleanProperties.has(l) && (a = r !== null && r !== "false"), this._component[l] = a;
    }
    this.scheduleRender(), this._component.onAttributeChange !== void 0 && this._component.onAttributeChange(e, t, r);
  }
  renderStyles() {
    const e = document.createElement("style");
    return this._meta.styles && Ve(this._meta.styles(), e), this._root.appendChild(e);
  }
  render() {
    this._meta.template && (Ve(this._meta.template(this._component, this.getAttributeValues()), this._root), this._style.parentNode !== this._root && this._root.appendChild(this._style)), this._component.onRender !== void 0 && this._component.onRender();
  }
  scheduleRender() {
  ...
  observe() {
    ...
    for (; r && r !== Object.prototype; ) {
      for (const a of Object.getOwnPropertyNames(r)) t.has(a) || (t.add(a), e.push(a));
      r = Object.getPrototypeOf(r);
    }
    const l = e.filter((a) => {
      const o = this._component[a];
      return a.startsWith("_") ? !1 : pl(o) ? (this.subscribeToSignal(o), !1) : typeof o == "function" ? !1 : a !== "elementRef" && a !== "constructor";
    });
    for (const a of l) {
      const o = this.getPropertyDescriptor(this._component, a), s = Object.getOwnPropertyDescriptor(this, a)?.value;
      let d = s === void 0 ? this._component[a] : s;
      typeof d == "boolean" && this._booleanProperties.add(a);
      let c = () => d, m = (p) => {
        d !== p && (this._component.onPropertyChange?.(a, d, p), d = p, this.scheduleRender());
      };
      if (o?.get) {
        const p = o.get;
        c = () => p.call(this._component) ?? d;
      }
      if (o?.set) {
        const p = o.set, u = m;
        m = (v) => {
      ...
      Object.defineProperty(this._component, a, {
        get: c,
        set: m,
        enumerable: !0,
        configurable: !0
      ...
      const r = class extends bl {
        constructor() {
          ...
          if (o && Array.isArray(o)) for (const s of o) {
            const d = o[s];
            d && typeof d == "object" && d.__injectionToken ? a.push(B.get(d.__injectionToken)) : a.push(void 0);
          }
          super(e, Reflect.construct(t, a));
        }
        static #e = this.observedAttributes = e.attributes ?? [];
      }, l = t;
      l.selector = e.selector, customElements.define(e.selector, r);
    }
  };
}
var ve = class {
  constructor(e, t) {
    ...
    r = r.replace(this._reParam, (l, a, o) => (this._names.push(o), a === ":" ? "([^/]*)" : "(.*)")), this._routeRegex = /* @__PURE__ */ new RegExp("^" + r + "$"), this._prefixRegex = /* @__PURE__ */ new RegExp("^" + r + "(?:/|$)");
  }
  parse(e) {
    let t = 0, r, l;
    const a = {}, o = e.match(this._routeRegex);
    if (!o) return null;
    for (; t < this._names.length; ) {
      if (r = this._names[t++], l = o[t], this._rules && r in this._rules && !this.validateRule(this._rules[r], l)) return null;
      a[r] = l;
    }
    return a;
  }
  parsePrefix(e) {
    ...
    if (!t) return null;
    const r = {};
    for (let a = 0; a < this._names.length; a++) {
      const o = this._names[a], s = t[a + 1];
      if (this._rules && o in this._rules && !this.validateRule(this._rules[o], s)) return null;
      r[o] = s;
    }
    const l = this.calculateMatchedPath(e);
    return {
      params: r,
      matchedPath: l,
      remainingPath: e.slice(l.length).replace(/^\//, "")
    };
  }
  stringify(e) {
    let t, r = this._route;
    for (const l in e)
      t = /* @__PURE__ */ new RegExp("[:*]" + l + "\\b"), r = r.replace(t, e[l]);
...
function _r(e, t, r, l, a) {
  for (const o of e) {
    const s = new ve(o.path);
    ...
    if (d !== null) {
      ...
      return Object.assign(a, d), l.push(m), {
        matches: l,
        params: a,
        isExactMatch: !0
      };
    ...
    if (o.children || o.loadChildren) {
      ...
      if (c && c.params !== null) {
        ...
        return Object.assign(a, c.params), l.push(p), o.children && c.remainingPath ? _r(o.children, c.remainingPath, m, l, a) : {
          matches: l,
          params: a,
...
function ge(e, t, r = "") {
  const l = _r(e, t.startsWith("/") ? t.slice(1) : t, r, [], {});
  return {
    matches: l.matches,
    params: l.params,
...
function fl(e, t, r = {}) {
  ...
  function a(o, s) {
    for (const d of o) {
      if (d.name === s) {
        const c = new ve(d.path);
        return l.push(c.stringify(r)), !0;
      }
      if (d.children) {
        const c = new ve(d.path).stringify(r);
        if (a(d.children, s))
  ...
  return a(e, t) ? "/" + l.filter(Boolean).join("/") : null;
}
function g(e, t, r, l) {
  var a = arguments.length, o = a < 3 ? t : l === null ? l = Object.getOwnPropertyDescriptor(t, r) : l, s;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") o = Reflect.decorate(e, t, r, l);
  else for (var d = e.length - 1; d >= 0; d--) (s = e[d]) && (o = (a < 3 ? s(o) : a > 3 ? s(t, r, o) : s(t, r)) || o);
...
var be = class {
  ...
  setMatchResult(t) {
    ...
    for (let o = 0; o < t.matches.length; o++) {
      const s = t.matches[o];
      l.push(s), Object.assign(a, s.params);
      const d = {
        depth: o,
        routes: s.children ?? [],
        currentMatch: s,
      ...
      this._contexts.set(o, d), r = s.fullPath;
    }
  }
  setResolvedData(t, r) {
  ...
  getMergedRouteData(t) {
    const r = t ?? this._matchStack.length - 1, l = {};
    for (let a = 0; a <= r && a < this._matchStack.length; a++) {
      const o = this._matchStack[a];
      o.route.data && Object.assign(l, o.route.data);
    }
    return l;
  }
  getMergedResolvedData(t) {
    const r = t ?? this._matchStack.length - 1, l = {};
    for (let a = 0; a <= r; a++) {
      const o = this._resolvedData.get(a);
      o && Object.assign(l, o);
    }
    return l;
  }
...
var Ee = (e, t, r, l) => new PopStateEvent("History", { state: {
  type: e,
  data: t,
  url: l,
...
history.pushState = (e, t, r) => {
  ...
  const l = new CustomEvent("NavigationEvent", { detail: Ee("push", e, t, r) });
  window.dispatchEvent(l);
};
var xl = history.replaceState;
history.replaceState = (e, t, r) => {
  ...
  const l = new CustomEvent("NavigationEvent", { detail: Ee("replace", e, t, r) });
  window.dispatchEvent(l);
};
var P = class {
  constructor() {
    this._routes = [], this._currentMatches = [], this._resolversExecutedForPath = null, this._currentPath = `${window.location.pathname}${window.location.search}`, this._contextService = new be(), window.addEventListener("NavigationEvent", (t) => {
  ...
  async runResolvers(t) {
    ...
    const l = await this.runResolversInternal(t);
    return this._resolversExecutedForPath = null, l;
  }
  async navigate(t, r = {}) {
    const { data: l, replace: a = !1, queryParams: o, skipGuards: s = !1, skipResolvers: d = !1, scrollToTop: c = !0 } = r;
    let m = t;
    if (o && Object.keys(o).length > 0 && (m = `${t}?${new URLSearchParams(o).toString()}`), !s && this._currentMatches.length > 0) {
      const u = await this.runDeactivationGuards(m);
      if (u !== !0)
        return typeof u == "string" ? this.navigate(u, {
          ...r,
          skipGuards: !0
        }) : {
          success: !1,
    ...
    if (!s && p.matches.length > 0) {
      const u = await this.runGuards(p);
      if (u !== !0)
        return typeof u == "string" ? this.navigate(u, {
          ...r,
          skipGuards: !0
    ...
    if (!d && p.matches.length > 0) {
      const u = await this.runResolversInternal(p);
      if (!u.success) return {
        success: !1,
        error: u.error ?? "Navigation blocked by resolver"
      };
      this._resolversExecutedForPath = m;
    }
    if (a ? history.replaceState(l, "", m) : history.pushState(l, "", m), this._currentPath = m, c) {
      const u = m.includes("#") ? m.split("#")[1] : null;
      if (u) {
  ...
  async runDeactivationGuards(t) {
    for (const r of this._currentMatches) {
      ...
      for (const a of l) {
        ...
        o.targetPath = t;
        const s = await this.executeGuard(a, "canDeactivate", o);
        if (s !== !0) return s;
      }
    }
    return !0;
  ...
  async runGuards(t) {
    for (const r of t.matches) {
      const l = r.route.canActivate ?? [];
      for (const a of l) {
        const o = this.createGuardContext(r, t), s = await this.executeGuard(a, "canActivate", o);
        if (s !== !0) return s;
      }
    }
    return !0;
  }
  async executeGuard(t, r, l) {
    const a = t[r];
    if (!a) return !0;
    try {
      const o = a.call(t, l);
  ...
  async runResolversInternal(t) {
    ...
    for (let r = 0; r < t.matches.length; r++) {
      const l = t.matches[r], a = l.route.resolve;
      if (!a) continue;
      const o = {}, s = this.createResolverContext(l, t);
      for (const [d, c] of Object.entries(a)) try {
        o[d] = await this.executeResolver(c, s);
      } catch (m) {
        return console.error(`Resolver '${d}' failed:`, m), {
          success: !1,
          error: `Resolver '${d}' failed: ${m instanceof Error ? m.message : String(m)}`
        };
      }
  ...
  async handlePopState(t) {
    const r = `${window.location.pathname}${window.location.search}`, l = await this.runDeactivationGuards(r);
    if (l !== !0) {
      typeof l == "string" ? await this.navigate(l, {
        replace: !0,
        skipGuards: !0
    ...
    this._currentPath = r;
    const a = new CustomEvent("NavigationEvent", { detail: Ee("push", t.state, "", window.location.pathname) });
...
P = g([U(), O("design:paramtypes", [])], P);
var He, Ke = "melodic:outlet-register", fe = class {
  constructor() {
  ...
  onInit() {
    ...
    window.addEventListener("NavigationEvent", t), this._navigationCleanup = () => window.removeEventListener("NavigationEvent", t), this.elementRef.addEventListener(Ke, ((r) => {
    ...
    for (; t; ) {
      ...
      if (r instanceof ShadowRoot) {
        if (t = r.host, t.tagName.toLowerCase() !== "router-outlet") {
          const l = t.shadowRoot?.querySelector("router-outlet");
          if (l && l !== this.elementRef) {
            this._parentOutlet = l.component, this._depth = (this._parentOutlet?._depth ?? -1) + 1;
            return;
          }
        }
      } else {
        const l = t.closest?.("router-outlet");
        if (l && l !== this.elementRef) {
          this._parentOutlet = l.component, this._depth = (this._parentOutlet?._depth ?? -1) + 1;
          return;
        }
  ...
  */
  async matchAndRender(t) {
    ...
    if (l.matches.length > 0) {
      const a = await this._router.runResolvers(l);
      if (!a.success) {
        console.error("Resolver failed:", a.error), await this.render404();
        return;
      }
    }
    if (this._router.setCurrentMatches(l), l.matches.length > 0) {
      ...
      this._context = {
        ...
        basePath: "",
        parent: void 0
      }, await this.renderMatch(a, l);
    } else await this.render404();
  }
  async renderFromContext() {
    if (!this._context || this.routes.length === 0) return;
    const t = this._context.remainingPath, r = ge(this.routes, t, this._context.basePath);
    if (r.redirectTo) {
    ...
    if (r.matches.length > 0) {
      ...
      this._context = {
        ...this._context,
        currentMatch: l,
        ancestorMatches: [...this._context.ancestorMatches, l],
        params: {
          ...this._context.params,
          ...l.params
        }
      }, await this.renderMatch(l, r);
    } else await this.render404();
  }
  async renderMatch(t, r) {
    const l = t.route;
    if (l.component === this._currentComponent) {
      this.updateChildOutlets();
      return;
    }
    if (l.loadChildren && !t.children) try {
      const a = await l.loadChildren();
      t.children = a.routes, l.children = a.routes;
    } catch (a) {
      console.error("Failed to load child routes:", a), await this.render404();
      return;
    }
    if (l.loadComponent) try {
      await l.loadComponent();
    } catch (a) {
      console.error("Failed to load component:", a), await this.render404();
      return;
    }
    l.component && await this.renderComponent(l.component);
  }
  async renderComponent(t) {
    ...
    l.__parentOutlet = this, r.appendChild(l), this._currentElement = l, queueMicrotask(() => this.updateChildOutlets());
  }
  updateChildOutlets() {
...
g([F(P), O("design:type", typeof (He = typeof P < "u" && P) == "function" ? He : Object)], fe.prototype, "_router", void 0);
fe = g([b({
...
var We, _e = class {
  ...
  onCreate() {
    ...
    r && (this.activeClass = r), this.updateAnchorHref(), this.elementRef.addEventListener("click", (a) => {
      if (a.preventDefault(), a.ctrlKey || a.metaKey || a.shiftKey) {
  ...
  onAttributeChange(t, r, l) {
    t === "href" ? (this.href = l, this.updateAnchorHref(), this.updateActiveState()) : t === "active-class" && (this.activeClass = l, this.updateActiveState());
  }
  onPropertyChange(t) {
  ...
  updateActiveState() {
    const t = window.location.pathname, r = this.href.startsWith("/") ? this.href : `/${this.href}`, l = t.replace(/\/$/, "") || "/", a = r.replace(/\/$/, "") || "/";
    let o;
...
g([F(P), O("design:type", typeof (We = typeof P < "u" && P) == "function" ? We : Object)], _e.prototype, "_router", void 0);
_e = g([b({
...
function yl(e, t, r) {
  ...
  const { href: a, activeClass: o = "active", exactMatch: s = !1, replace: d = !1, data: c = null, queryParams: m = {} } = l, p = B.get(P), u = () => {
    let y = a;
  ...
  const v = () => {
    const y = window.location.pathname, x = a.startsWith("/") ? a : `/${a}`, w = y.replace(/\/$/, "") || "/", R = x.replace(/\/$/, "") || "/";
    let C;
    s ? C = w === R : C = w === R || w.startsWith(R + "/"), C ? (e.classList.add(o), e.tagName.toLowerCase() === "a" && e.setAttribute("aria-current", "page")) : (e.classList.remove(o), e.removeAttribute("aria-current")), e.setAttribute("router-link", "");
  }, _ = (y) => {
    const x = y;
  ...
  return e.addEventListener("click", _), window.addEventListener("NavigationEvent", k), v(), (() => {
    e.removeEventListener("click", _), window.removeEventListener("NavigationEvent", k);
  });
}
$e("routerLink", yl);
var xr = null;
...
function kl(e) {
  ...
  return a.set = (o) => {
    ...
    a.set(o(t));
  }, a.subscribe = (o) => (r.add(o), () => r.delete(o)), a.unsubscribe = (o) => {
    r.delete(o);
  }, a.destroy = () => {
    r.clear();
  }, Object.defineProperty(a, fr, {
    value: !0,
    enumerable: !1,
    configurable: !1
  }), a;
...
const Cl = ce("RX_INIT_STATE"), Sl = ce("RX_ACTION_PROVIDERS"), El = ce("RX_EFFECTS_PROVIDERS"), Rl = ce("RX_STATE_DEBUG");
var q = class {
  constructor() {
    this._debug && console.info("RX State Debugging: Enabled");
  }
  select(t, r) {
    return $l(() => r(this._state[t]()));
  }
  logState() {
    console.log(this.getCurrentState());
  }
  dispatch(t, r) {
    const l = typeof t == "string" ? t : void 0, a = typeof t == "string" ? r : t;
    this._debug && (console.log(`Action: ${a.type}`), console.log("Payload:", a.payload), console.log("Current State:", this.getCurrentState())), l ? this.dispatchWithKey(l, a) : this.dispatchWithoutKey(a);
  }
  dispatchWithKey(t, r) {
    if (!this._reducerMap[t]) throw new Error(`Reducer not found for key: ${t}`);
    const l = this._reducerMap[t].reducers.find((a) => a.action.type === r.type);
    if (l !== void 0) {
      const a = l.reducer(this._state[t](), r);
      this._state[t].set(a), this._debug && console.log("New State:", this.getCurrentState());
    }
    this.getEffectsForAction(t, r).forEach((a) => {
      a.effect(r).then((o) => {
  ...
  dispatchWithoutKey(t) {
    ...
    if (r !== void 0) {
      const a = r.actionReducer.reducer(this._state[r.key](), t);
      this._state[r.key].set(a), this._debug && console.log("New State:", this.getCurrentState());
    }
    const l = this.getEffectsForAction(t);
    l !== void 0 && l.actionEffects.forEach((a) => {
      a.effect(t).then((o) => {
        o !== void 0 && (Array.isArray(o) || (o = [o]), o.forEach((s) => {
          this.dispatch(s);
        }));
  ...
  getReducerForAction(t) {
    ...
    for (const l of r) {
      const a = (this._reducerMap[l]?.reducers || []).find((o) => o.action.type === t.type);
      if (a) return {
        key: l,
        actionReducer: a
      };
  ...
  getEffectsForActionWithoutKey(t) {
    const r = Object.keys(this._reducerMap);
    for (const l of r) {
      const a = this._effectMap[l];
      if (a) {
        const o = B.get(a).getEffects().filter((s) => s.actions.some((d) => d().type === t.type));
  ...
  getEffectsForActionWithKey(t, r) {
    const l = this._effectMap[t];
    return l ? B.get(l).getEffects().filter((a) => a.actions.some((o) => o().type === r.type)) : [];
  }
  getCurrentState() {
    return Object.keys(this._state).reduce((t, r) => (t[r] = this._state[r](), t), {});
  }
};
g([F(Cl), O("design:type", Object)], q.prototype, "_state", void 0);
g([F(Sl), O("design:type", Object)], q.prototype, "_reducerMap", void 0);
g([F(El), O("design:type", Object)], q.prototype, "_effectMap", void 0);
g([F(Rl), O("design:type", Boolean)], q.prototype, "_debug", void 0);
q = g([U(), O("design:paramtypes", [])], q);
function zl(e) {
  return i`
		<div
			class=${h({
...
var Xe = class {
  constructor() {
    this.value = "", this.variant = "outline", this.size = "md", this.disabled = !1, this.multiple = !1, this.values = [], this.handleSlotChange = () => {
      ...
      this.multiple ? (this.values.indexOf(r) >= 0 ? this.values = this.values.filter((l) => l !== r) : this.values = [...this.values, r], this.syncItems(), this.elementRef.dispatchEvent(new CustomEvent("ml:change", {
        bubbles: !0,
        composed: !0,
  ...
  syncItems() {
    this.elementRef.querySelectorAll("ml-button-group-item").forEach((t) => {
      const r = t.getAttribute("value") ?? "", l = this.multiple ? this.values.includes(r) : r === this.value;
      t.toggleAttribute("active", l), t.toggleAttribute("group-disabled", this.disabled), t.setAttribute("group-size", this.size), t.setAttribute("group-variant", this.variant);
    });
  }
};
Xe = g([b({
...
function Pl(e) {
  return i`
		<button
			...
			@click=${e.handleClick}
		>
			${n(!!e.icon, () => i`<ml-icon icon=${e.icon} size="sm"></ml-icon>`)}
			<slot></slot>
		</button>
	`;
}
		...
		>
			${n(!!e.label, () => i`
					<label class="ml-input__label" for="input">
						${e.label}
						${n(e.required, () => i`<span class="ml-input__required">*</span>`)}
					</label>
				`)}
			...
			${n(!!e.error, () => i`<span id="error" class="ml-input__error">${e.error}</span>`, () => i`${n(!!e.hint, () => i`<span id="hint" class="ml-input__hint">${e.hint}</span>`)}`)}
		</div>
	`;
}
const Ll = () => f`
		...
		>
			${n(!!e.label, () => i`
					<label class="ml-textarea__label" for="textarea">
						${e.label}
						${n(e.required, () => i`<span class="ml-textarea__required">*</span>`)}
					</label>
				`)}
			...
			<div class="ml-textarea__footer">
				${n(!!e.error, () => i`<span id="error" class="ml-textarea__error">${e.error}</span>`, () => i`${n(!!e.hint, () => i`<span id="hint" class="ml-textarea__hint">${e.hint}</span>`)}`)}
				${n(e.maxLength > 0, () => i`
  ...
  return i`
    ...
    "ml-checkbox--disabled": e.disabled
		...
		>
			...
			${n(!!e.label, () => i`<span class="ml-checkbox__label">${e.label}</span>`)}
		</label>
		${n(!!e.hint, () => i`<span class="ml-checkbox__hint">${e.hint}</span>`)}
	`;
}
const Bl = () => f`
	:host {
  ...
  return i`
    ...
    "ml-radio--disabled": e.disabled
		...
		>
			...
			${n(!!e.label, () => i`<span class="ml-radio__label">${e.label}</span>`)}
		</label>
		${n(!!e.hint, () => i`<span class="ml-radio__hint">${e.hint}</span>`)}
	`;
}
const Hl = () => f`
	:host {
		...
		>
			${n(!!e.label, () => i`
					<legend id="legend" class="ml-radio-group__legend">
						${e.label}
						${n(e.required, () => i`<span class="ml-radio-group__required">*</span>`)}
					</legend>
				`)}
			...
			${n(!!e.error, () => i`<span class="ml-radio-group__error">${e.error}</span>`, () => i`${n(!!e.hint, () => i`<span class="ml-radio-group__hint">${e.hint}</span>`)}`)}
		</fieldset>
	`;
}
const Wl = () => f`
...
var rt = class {
  ...
  updateChildRadios() {
    ...
    t.forEach((r) => {
      ...
      const l = r.value ?? r.getAttribute("value") ?? "";
      r.checked = this.value !== "" && l === this.value;
    });
  }
};
rt = g([b({
...
function Gl(e) {
  return i`
		...
		>
			${n(!!e.label, () => i`
					<legend id="legend" class="ml-radio-card-group__legend">
						${e.label}
						${n(e.required, () => i`<span class="ml-radio-card-group__required">*</span>`)}
					</legend>
				`)}
    ...
    [`ml-radio-card-group__options--${e.orientation}`]: !0
			...
			${n(!!e.error, () => i`<span class="ml-radio-card-group__error">${e.error}</span>`, () => i`${n(!!e.hint, () => i`<span class="ml-radio-card-group__hint">${e.hint}</span>`)}`)}
		</fieldset>
	`;
}
const Ul = () => f`
...
var lt = class {
  ...
  syncCards() {
    ...
    t.forEach((r) => {
      const l = (r.getAttribute("value") ?? "") === this.value;
      r.toggleAttribute("selected", l), r.toggleAttribute("group-disabled", this.disabled);
    });
  }
};
lt = g([b({
		...
		>
			...
			<div class="ml-radio-card__content">
				...
				<div class="ml-radio-card__text">
					${n(!!e.label, () => i`<span class="ml-radio-card__label">${e.label}</span>`)}
					${n(!!e.description, () => i`<span class="ml-radio-card__description">${e.description}</span>`)}
					<slot></slot>
				</div>
			</div>
  ...
  return i`
    ...
    "ml-toggle--disabled": e.disabled
		...
		>
			...
			${n(!!e.label, () => i`<span class="ml-toggle__label">${e.label}</span>`)}
		</label>
		${n(!!e.hint, () => i`<span class="ml-toggle__hint">${e.hint}</span>`)}
	`;
}
const Ql = () => f`
	:host {
		...
		>
			${n(!!e.label, () => i`
					<label class="ml-select__label">
						${e.label}
						${n(e.required, () => i`<span class="ml-select__required">*</span>`)}
					</label>
				`)}
			...
			<div class="ml-select__control">
				...
				<div
					class=${h({
    "ml-select__dropdown": !0,
    "ml-select__dropdown--open": e.isOpen
  })}
					role="listbox"
			...
			${n(!!e.error, () => i`<span class="ml-select__error">${e.error}</span>`, () => i`${n(!!e.hint, () => i`<span class="ml-select__hint">${e.hint}</span>`)}`)}
		</div>
	`;
}
function ea(e) {
  return i`
		${n(!!e.selectedOption?.icon, () => i`<ml-icon icon="${e.selectedOption?.icon ?? ""}" size="sm" class="ml-select__value-icon"></ml-icon>`)}
...
function ra(e, t, r) {
  ...
  return i`
		<div
			class=${h({
    "ml-select__option": !0,
    "ml-select__option--selected": l,
    "ml-select__option--focused": a,
    "ml-select__option--disabled": !!t.disabled
		...
		>
			${n(!!t.avatarUrl, () => i`<img class="ml-select__option-avatar" src="${t.avatarUrl}" alt="${t.avatarAlt || t.label}" />`)}
			${n(!t.avatarUrl && !!t.icon, () => i`<ml-icon icon="${t.icon}" size="sm" class="ml-select__option-icon"></ml-icon>`)}
			<span class="ml-select__option-label">${t.label}</span>
			${n(l, () => i`<ml-icon icon="check" size="sm" format="regular" class="ml-select__option-check"></ml-icon>`)}
		</div>
	`;
}
const la = () => f`
...
var it = class {
  constructor() {
    this.label = "", this.placeholder = "Select an option", this.hint = "", this.error = "", this.size = "md", this.disabled = !1, this.required = !1, this.multiple = !1, this.value = "", this.values = [], this.options = [], this.search = "", this.isOpen = !1, this.focusedIndex = -1, this._handleDocumentClick = this.onDocumentClick.bind(this), this._handleKeyDown = this.onKeyDown.bind(this), this._syncingValues = !1, this.toggle = () => {
      if (!this.disabled) {
        if (this.multiple) {
      ...
      this.disabled || this.isOpen || (this.isOpen = !0, this.focusedIndex = this.getInitialFocusIndex(), this.elementRef.dispatchEvent(new CustomEvent("ml:open", {
        bubbles: !0,
        composed: !0
      })));
    }, this.close = () => {
      this.isOpen && (this.isOpen = !1, this.focusedIndex = -1, this.search = "", this.elementRef.dispatchEvent(new CustomEvent("ml:close", {
        bubbles: !0,
        composed: !0
      })));
    }, this.selectOption = (t) => {
      ...
      t.stopPropagation(), !this.disabled && (this.values = this.values.filter((l) => l !== r), this.elementRef.dispatchEvent(new CustomEvent("ml:change", {
        bubbles: !0,
        composed: !0,
        detail: {
          values: [...this.values],
  ...
  onCreate() {
    document.addEventListener("click", this._handleDocumentClick), this.elementRef.addEventListener("keydown", this._handleKeyDown);
  }
  onDestroy() {
    document.removeEventListener("click", this._handleDocumentClick), this.elementRef.removeEventListener("keydown", this._handleKeyDown);
  }
  onPropertyChange(t) {
    if (!this._syncingValues) {
      ...
      if (t === "values") {
        const r = this.values;
        let l = [];
        typeof r == "string" ? l = r.split(",").map((a) => a.trim()).filter((a) => a.length > 0) : Array.isArray(r) && (l = r.filter((a) => typeof a == "string")), l = Array.from(new Set(l)), this.areValuesEqual(this.values, l) || this.updateValues(l), this.multiple || (this.value = l[0] ?? "", this.updateValues([]));
        return;
      }
  ...
  get filteredOptions() {
    ...
    return t ? this.options.filter((r) => {
      const l = r.label.toLowerCase().includes(t), a = r.value.toLowerCase().includes(t);
      return l || a;
    }) : this.options;
  }
  get hasValue() {
  ...
  onDocumentClick(t) {
    t.composedPath().includes(this.elementRef) || this.close();
  }
    ...
    switch (t.key) {
      ...
      case " ":
        ...
        if (t.preventDefault(), this.isOpen && this.focusedIndex >= 0) {
          const l = this.getActiveOptions()[this.focusedIndex];
          l && !l.disabled && this.selectOption(l);
        } else this.toggle();
        break;
      case "Escape":
  ...
  getInitialFocusIndex() {
    ...
    if (this.multiple && this.values.length > 0) {
      const r = t.findIndex((l) => this.values.includes(l.value) && !l.disabled);
      if (r >= 0) return r;
    }
    if (!this.multiple && this.value) {
      const r = t.findIndex((l) => l.value === this.value && !l.disabled);
      if (r >= 0) return r;
    }
  ...
  areValuesEqual(t, r) {
    ...
    for (let l = 0; l < t.length; l++) if (t[l] !== r[l]) return !1;
    return !0;
  }
};
it = g([b({
...
function aa(e) {
  return i`
    ...
    "ml-slider--error": !!e.error
		...
		>
			${n(!!e.label || e.showValue, () => i`
					<div class="ml-slider__header">
						${n(!!e.label, () => i`<label class="ml-slider__label">${e.label}</label>`)}
						${n(e.showValue, () => i`<span class="ml-slider__value">${e.value}</span>`)}
					</div>
				`)}
			...
			${n(!!e.error, () => i`<span class="ml-slider__error">${e.error}</span>`, () => i`${n(!!e.hint, () => i`<span class="ml-slider__hint">${e.hint}</span>`)}`)}
		</div>
	`;
}
const oa = () => f`
		...
		>
			${n(!!e.label, () => i`
					<label class="ml-form-field__label" for=${e.fieldId}>
						${e.label}
						${n(e.required, () => i`<span class="ml-form-field__required">*</span>`)}
					</label>
				`)}
			...
			${n(!!e.error, () => i`<span id=${e.errorId} class="ml-form-field__error">${e.error}</span>`)}
			${n(!e.error && !!e.hint, () => i`<span id=${e.hintId} class="ml-form-field__hint">${e.hint}</span>`)}
		</div>
	`;
}
const sa = () => f`
...
var nt = class {
  ...
  connectSlottedControl() {
    ...
    if (!t) return;
    const r = t.assignedElements({ flatten: !0 }), l = this.findFormControl(r);
    l && (l.id || (l.id = this.fieldId), this.describedBy && l.setAttribute("aria-describedby", this.describedBy), this.error ? l.setAttribute("aria-invalid", "true") : l.removeAttribute("aria-invalid"), this.required && l.setAttribute("aria-required", "true"), this.disabled && "disabled" in l && (l.disabled = !0));
  }
  findFormControl(t) {
    for (const r of t) {
      if (r instanceof HTMLInputElement || r instanceof HTMLSelectElement || r instanceof HTMLTextAreaElement) return r;
      if (r instanceof HTMLElement) {
        const a = r.getAttribute("role");
        if (a === "textbox" || a === "combobox" || a === "checkbox" || a === "radio" || a === "switch" || a === "slider" || r.tagName.toLowerCase().startsWith("ml-")) return r;
      }
      const l = this.findFormControl(Array.from(r.children));
      if (l) return l;
    }
    return null;
  }
...
function dt() {
  ...
  return ee(e.getFullYear(), e.getMonth(), e.getDate());
}
var ct = class {
  constructor() {
  ...
  onAttributeChange(t, r, l) {
    t === "value" && l && this.navigateToValue();
  }
  navigateToValue() {
  ...
  get monthLabel() {
    return `${ca[this.viewMonth]} ${this.viewYear}`;
  }
  get weekdays() {
    return ma;
  }
  get days() {
    const t = this.viewYear, r = this.viewMonth, l = new Date(t, r, 1).getDay(), a = new Date(t, r + 1, 0).getDate(), o = new Date(t, r, 0).getDate(), s = dt(), d = [], c = r === 0 ? 11 : r - 1, m = r === 0 ? t - 1 : t;
    for (let _ = l - 1; _ >= 0; _--) {
      const k = o - _, y = ee(m, c, k);
      d.push({
        date: k,
        month: c,
        year: m,
    ...
    for (let _ = 1; _ <= a; _++) {
      ...
      d.push({
        ...
        isCurrentMonth: !0,
        isToday: k === s,
        isSelected: k === this.value,
        isDisabled: this.isDisabled(k)
      });
    }
    const p = r === 11 ? 0 : r + 1, u = r === 11 ? t + 1 : t, v = d.length % 7;
    if (v > 0) {
      const _ = 7 - v;
      for (let k = 1; k <= _; k++) {
        const y = ee(u, p, k);
...
function pa(e) {
  return i`
    ...
    "ml-date-picker--open": e.isOpen
			...
			${n(!!e.label, () => i`
				<label class="ml-date-picker__label">
					${e.label}
					${n(e.required, () => i`<span class="ml-date-picker__required">*</span>`)}
				</label>
			`)}
    ...
    "ml-date-picker__value--placeholder": !e.value
			...
			${n(!!e.error, () => i`<span class="ml-date-picker__error">${e.error}</span>`, () => i`${n(!!e.hint, () => i`<span class="ml-date-picker__hint">${e.hint}</span>`)}`)}
		</div>
	`;
}
const ua = () => f`
...
var mt = class {
  ...
  startPositioning() {
    ...
    this._cleanupAutoUpdate?.(), this._cleanupAutoUpdate = we(t, r, l);
  }
  updatePosition(t, r) {
    const { x: l, y: a } = ae(t, r, {
    ...
    [`ml-alert--${e.variant}`]: !0
		...
		>
			...
			<div class="ml-alert__content">
				${n(!!e.title, () => i`<div class="ml-alert__title">${e.title}</div>`)}
...
var ut = class {
  ...
  show(t) {
    const r = this.ensureContainer(), l = document.createElement("ml-toast");
    t.variant && l.setAttribute("variant", t.variant), t.title && l.setAttribute("title", t.title), t.message && l.setAttribute("message", t.message), t.duration !== void 0 && l.setAttribute("duration", String(t.duration)), t.dismissible === !1 && l.setAttribute("dismissible", "false"), r.appendChild(l);
  }
  /** Show an info toast */
  info(t, r) {
    this.show({
    ...
    [`ml-toast--${e.variant}`]: !0
		...
		>
			...
			<div class="ml-toast__content">
				${n(!!e.title, () => i`<div class="ml-toast__title">${e.title}</div>`)}
				${n(!!e.message, () => i`<div class="ml-toast__message">${e.message}</div>`)}
			</div>
			${n(e.dismissible, () => i`
    ...
    "ml-progress--label-right": r
			...
			${n(t, () => i`
				<div class="ml-progress__header">
					${n(!!e.label, () => i`<span class="ml-progress__label">${e.label}</span>`)}
					${n(e.showValue, () => i`<span class="ml-progress__value">${e.displayValue}</span>`)}
				</div>
			`)}
			...
			<div class="ml-progress__bar-row">
				...
				${n(r, () => i`<span class="ml-progress__value">${e.displayValue}</span>`)}
			</div>

			${n(l, () => i`<span class="ml-progress__value ml-progress__value--bottom">${e.displayValue}</span>`)}
		</div>
	`;
}
function ka(e) {
  return i`
    ...
    [`ml-progress-circle--${e.size}`]: !0
			...
			${n(e.showValue || !!e.label, () => i`
				<div class="ml-progress-circle__center">
					${n(e.showValue, () => i`<span class="ml-progress-circle__value">${e.displayValue}</span>`)}
					${n(!!e.label, () => i`<span class="ml-progress-circle__label">${e.label}</span>`)}
				</div>
			`)}
		</div>
	`;
    ...
    [`ml-progress-half--${e.size}`]: !0
			...
			${n(e.showValue || !!e.label, () => i`
				<div class="ml-progress-half__center">
					${n(e.showValue, () => i`<span class="ml-progress-half__value">${e.displayValue}</span>`)}
					${n(!!e.label, () => i`<span class="ml-progress-half__label">${e.label}</span>`)}
				</div>
			`)}
		</div>
	`;
...
function Ca(e) {
  return e.shape === "circle" ? ka(e) : e.shape === "half-circle" ? $a(e) : wa(e);
}
const Sa = () => f`
	:host {
		display: block;
...
function Pa(e) {
  return i`
    ...
    "ml-avatar--rounded": e.rounded
		...
		>
			${n(!!e.src && !e._imageError, () => i` <img class="ml-avatar__image" src="${e.src}" alt="${e.alt}" @error=${e.handleImageError} /> `, () => i`${n(!!e.initials, () => i`<span class="ml-avatar__initials">${e.getInitials()}</span>`, () => i`
...
function Fa(e) {
  ...
  return i`
    ...
    [`ml-badge-group--${e.variant}`]: !0
		...
		>
			${n(!t && !!e.label, () => i`<span class="ml-badge-group__label ml-badge-group__label--${e.variant}">${e.label}</span>`)}
			<span class="ml-badge-group__text">
				<slot></slot>
			</span>
			${n(t && !!e.label, () => i`<span class="ml-badge-group__label ml-badge-group__label--${e.variant}">${e.label}</span>`)}
			${n(!!e.icon, () => i`<ml-icon icon=${e.icon} size="sm" class="ml-badge-group__icon"></ml-icon>`)}
		</span>
	`;
}
const Va = () => f`
...
function Ka(e) {
  return i`
		<div class="ml-li" role="listitem">
			${n(e.hasLeadingSlot, () => i`
					<div class="ml-li__leading">
						<slot name="leading"></slot>
					</div>
				`)}
			<div class="ml-li__content">
				${n(!!e.primary, () => i`<span class="ml-li__primary">${e.primary}</span>`)}
				${n(!!e.secondary, () => i`<span class="ml-li__secondary">${e.secondary}</span>`)}
				<slot></slot>
			</div>
			${n(e.hasTrailingSlot, () => i`
...
function Ya(e) {
  return i`
		<article class="ml-afi">
			<div class="ml-afi__left">
				<div class="ml-afi__avatar">
					${n(e.hasAvatarSlot, () => i`<slot name="avatar"></slot>`, () => i`
							<ml-avatar
								size=${e["avatar-size"]}
								src=${e["avatar-src"]}
			...
			<div class="ml-afi__body">
				<div class="ml-afi__header">
					<div class="ml-afi__meta">
						${n(!!e.name, () => i`<span class="ml-afi__name">${e.name}</span>`)}
						${n(!!e.timestamp, () => i`<span class="ml-afi__timestamp">${e.timestamp}</span>`)}
					</div>
					${n(e.indicator, () => i`
							<span
								class=${h({
    ...
    [`ml-afi__indicator--${e["indicator-color"]}`]: !0
				...
				${n(!!e.subtitle, () => i`<div class="ml-afi__subtitle">${e.subtitle}</div>`)}
				<div class="ml-afi__description">
					<slot></slot>
				</div>
				${n(e.hasContentSlot, () => i`
...
function Qa(e) {
  return i`
    ...
    "ml-table--virtual": e.virtual
			...
			${n(!!e.tableTitle || !!e.description, () => i`
				<div class="ml-table__header">
					<div class="ml-table__header-text">
						${n(!!e.tableTitle, () => i`<h3 class="ml-table__title">${e.tableTitle}</h3>`)}
						${n(!!e.description, () => i`<p class="ml-table__description">${e.description}</p>`)}
					</div>
    ...
    [`ml-table__th--${t.align ?? "left"}`]: !0
					...
					<tbody>
						${n(e.virtual && e.topSpacerHeight > 0, () => i`
							<tr class="ml-table__spacer">
								<td colspan="${e.colCount}" style="height: ${e.topSpacerHeight}px"></td>
							</tr>
						`)}
						${$(e.visibleRows, (t, r) => e.startIndex + r, (t, r) => {
    const l = e.startIndex + r;
    return i`
								<tr
									class=${h({
      "ml-table__row": !0,
      "ml-table__row--selected": e.isRowSelected(l)
    })}
									@click=${() => e.handleRowClick(t, l)}
								>
									${n(e.selectable, () => i`
										<td class="ml-table__check-cell">
											<input
												...
												@change=${(a) => e.handleSelectRow(l, a)}
												@click=${(a) => a.stopPropagation()}
												aria-label=${`Select row ${l + 1}`}
											/>
										</td>
									`)}
									${$(e.columns, (a) => a.key, (a) => i`
										<td class=${h({
      "ml-table__td": !0,
      [`ml-table__td--${a.align ?? "left"}`]: !0
						...
						${n(e.virtual && e.bottomSpacerHeight > 0, () => i`
							<tr class="ml-table__spacer">
...
var zt = class {
  constructor() {
    this.hasFooter = !1, this.hasHeaderActions = !1, this.selectable = !1, this.striped = !1, this.hoverable = !0, this.stickyHeader = !1, this.size = "md", this.tableTitle = "", this.description = "", this.virtual = !1, this.columns = [], this.rows = [], this.sortKey = "", this.sortDirection = "asc", this.selectedIndices = [], this.startIndex = 0, this.endIndex = 50, this._scroller = new gr(), this._viewport = null, this.isRowSelected = (t) => this.selectedIndices.includes(t), this.handleSort = (t) => {
      ...
      r.stopPropagation(), this.selectedIndices.includes(t) ? this.selectedIndices = this.selectedIndices.filter((l) => l !== t) : this.selectedIndices = [...this.selectedIndices, t], this.emitSelect();
  ...
  onCreate() {
    ...
    t && (t.querySelectorAll("slot").forEach((r) => {
      r.addEventListener("slotchange", () => {
        ...
        l === "footer" ? this.hasFooter = r.assignedNodes().length > 0 : l === "header-actions" && (this.hasHeaderActions = r.assignedNodes().length > 0);
      });
  ...
  _attachScroller() {
    ...
    t && (this._viewport = t.querySelector(".ml-table__wrapper"), this._viewport && this._scroller.attach(this._viewport, {
      ...
      onUpdate: (r, l) => {
        this.startIndex = r, this.endIndex = l;
      },
...
function to(e) {
  ...
  return i`
    ...
    "ml-data-grid--virtual": e.virtual
			...
			${n(!!e.gridTitle || !!e.description, () => i`
				<div class="ml-data-grid__toolbar">
					<div class="ml-data-grid__toolbar-text">
						${n(!!e.gridTitle, () => i`<h3 class="ml-data-grid__title">${e.gridTitle}</h3>`)}
						${n(!!e.description, () => i`<p class="ml-data-grid__description">${e.description}</p>`)}
					</div>
			...
			<div class="ml-data-grid__viewport">
				<div class="ml-data-grid__inner" style="min-width: ${r}px">
					...
					<div class="ml-data-grid__header-row" style="grid-template-columns: ${t}">
						...
						`)}
						${$(e.orderedColumns, (l) => l.key, (l) => i`
							<div
								class=${h({
    "ml-data-grid__th": !0,
    [`ml-data-grid__th--${l.align ?? "left"}`]: !0,
    "ml-data-grid__th--sortable": !!l.sortable,
    "ml-data-grid__th--sorted": e.sortKey === l.key,
    "ml-data-grid__th--pinned-left": l.pinned === "left",
    "ml-data-grid__th--pinned-right": l.pinned === "right",
    "ml-data-grid__th--drag-over": e.dragOverKey === l.key,
    "ml-data-grid__th--dragging": e.draggingKey === l.key,
    "ml-data-grid__th--resizing": e.resizingKey === l.key
  })}
								style=${l.pinned === "left" ? `left: ${e.getPinnedLeftOffset(l.key)}px` : ""}
								draggable=${l.reorderable !== !1 ? "true" : "false"}
								@dragstart=${(a) => e.handleDragStart(l.key, a)}
								@dragover=${(a) => e.handleDragOver(l.key, a)}
								@dragend=${e.handleDragEnd}
								@drop=${() => e.handleDrop(l.key)}
								@click=${() => e.handleSort(l)}
								aria-sort=${e.sortKey === l.key ? e.sortDirection === "asc" ? "ascending" : "descending" : "none"}
							>
								<span class="ml-data-grid__th-content">
									${l.label}
									${n(!!l.sortable, () => i`
										<span class="ml-data-grid__sort-icon">
											${e.sortKey === l.key ? e.sortDirection === "asc" ? i`<ml-icon icon="caret-up" size="xs"></ml-icon>` : i`<ml-icon icon="caret-down" size="xs"></ml-icon>` : i`<ml-icon icon="caret-up-down" size="xs"></ml-icon>`}
										</span>
									`)}
								</span>
								${n(l.resizable !== !1, () => i`
									<div
										...
										@pointerdown=${(a) => e.handleResizeStart(l.key, a)}
										@pointermove=${(a) => e.handleResizeMove(l.key, a)}
    ...
    "ml-data-grid__filter-cell--pinned-left": l.pinned === "left"
  })}
									style=${l.pinned === "left" ? `left: ${e.getPinnedLeftOffset(l.key)}px` : ""}
								>
									${n(!!l.filterable, () => i`
										<input
											...
											placeholder="Filter..."
											.value=${e.filters[l.key] ?? ""}
											@input=${(a) => e.handleFilterInput(l.key, a)}
										/>
									`)}
								</div>
							`)}
					...
					<!-- Data rows -->
					${$(e.visibleRows, (l, a) => e.startIndex + a, (l, a) => i`
							<div
								class=${h({
    "ml-data-grid__row": !0,
    "ml-data-grid__row--selected": e.isRowSelected(e.startIndex + a),
    "ml-data-grid__row--even": (e.startIndex + a) % 2 === 1
  })}
								style="grid-template-columns: ${t}"
								@click=${() => e.handleRowClick(l, e.startIndex + a)}
							>
								${n(e.selectable, () => i`
									<div class="ml-data-grid__td ml-data-grid__check-cell">
										<input
											type="checkbox"
											class="ml-data-grid__checkbox"
											.checked=${e.isRowSelected(e.startIndex + a)}
											@change=${(o) => e.handleSelectRow(e.startIndex + a, o)}
											@click=${(o) => o.stopPropagation()}
											aria-label=${`Select row ${e.startIndex + a + 1}`}
										/>
									</div>
								`)}
    ...
    "ml-data-grid__td--pinned-right": o.pinned === "right"
			...
			<div class="ml-data-grid__footer">
				<span class="ml-data-grid__footer-count">
					${n(e.selectable && e.selectedIndices.length > 0, () => i`${e.selectedIndices.length} of ${e.totalRows} rows selected`, () => i`${e.totalRows} rows`)}
				</span>
...
var Tt = class {
  constructor() {
    this.selectable = !1, this.striped = !1, this.hoverable = !0, this.size = "md", this.gridTitle = "", this.description = "", this.serverSide = !1, this.pageSize = 50, this.virtual = !0, this.showFilterRow = !1, this.columns = [], this.rows = [], this.sortKey = "", this.sortDirection = "asc", this.filters = {}, this.selectedIndices = [], this.currentPage = 1, this.startIndex = 0, this.endIndex = 50, this.colWidths = {}, this.colOrder = [], this.resizingKey = null, this.draggingKey = null, this.dragOverKey = null, this._scroller = new gr(), this._viewport = null, this._resizeStartX = 0, this._resizeStartWidth = 0, this.isRowSelected = (t) => this.selectedIndices.includes(t), this.handleSort = (t) => {
      ...
      r.stopPropagation(), this.selectedIndices = this.selectedIndices.includes(t) ? this.selectedIndices.filter((l) => l !== t) : [...this.selectedIndices, t], this._emitSelect();
    }, this.handleRowClick = (t, r) => {
      this.elementRef.dispatchEvent(new CustomEvent("ml:row-click", {
        bubbles: !0,
        composed: !0,
      ...
      const l = r.clientX - this._resizeStartX, a = this.columns.find((o) => o.key === t)?.minWidth ?? 80;
      this.colWidths = {
        ...this.colWidths,
        [t]: Math.max(a, this._resizeStartWidth + l)
      };
      ...
      const r = [...this.colOrder.length ? this.colOrder : this.columns.map((o) => o.key)], l = r.indexOf(this.draggingKey), a = r.indexOf(t);
      l !== -1 && a !== -1 && (r.splice(l, 1), r.splice(a, 0, this.draggingKey)), this.colOrder = r, this.elementRef.dispatchEvent(new CustomEvent("ml:column-reorder", {
        bubbles: !0,
        composed: !0,
  ...
  onPropertyChange(t, r, l) {
    t === "columns" && Array.isArray(l) && this._syncColumnState(l);
  }
  onCreate() {
  ...
  onRender() {
    ...
    if (t) {
      ...
      if (r) {
        ...
        l > 0 && this.elementRef.style.setProperty("--ml-grid-header-h", `${l}px`);
      }
    }
  ...
  _syncColumnState(t) {
    this.colOrder = t.map((l) => l.key);
    const r = {};
    for (const l of t) r[l.key] = this.colWidths[l.key] ?? l.width ?? 150;
    this.colWidths = r;
  }
  get filteredRows() {
    if (this.serverSide) return this.rows;
    const t = Object.entries(this.filters).filter(([, r]) => r !== "");
    return t.length ? this.rows.filter((r) => t.every(([l, a]) => String(r[l] ?? "").toLowerCase().includes(a.toLowerCase()))) : this.rows;
  }
  get sortedRows() {
    if (this.serverSide || !this.sortKey) return this.filteredRows;
    const t = this.sortKey, r = this.sortDirection === "asc" ? 1 : -1;
    return [...this.filteredRows].sort((l, a) => {
      const o = l[t], s = a[t];
      return o == null ? s == null ? 0 : 1 : s == null ? -1 : typeof o == "number" && typeof s == "number" ? (o - s) * r : String(o).localeCompare(String(s)) * r;
    });
  }
  ...
  getPinnedLeftOffset(t) {
    ...
    for (const l of this.orderedColumns) {
      if (l.key === t) return r;
      l.pinned === "left" && (r += this.columnWidths[l.key] ?? 150);
    }
    return 0;
  }
  get topSpacerHeight() {
...
function L(e) {
  const t = new Date(e), r = t.getHours(), l = t.getMinutes(), a = r >= 12 ? "PM" : "AM", o = r % 12 || 12;
  return l === 0 ? `${o} ${a}` : `${o}:${String(l).padStart(2, "0")} ${a}`;
}
function It(e) {
  return `${lo[e.getMonth()]} ${e.getFullYear()}`;
}
function io(e, t) {
  const r = xe[e.getMonth()], l = xe[t.getMonth()];
...
function Mt(e, t, r = 0) {
  const l = new Date(e, t, 1).getDay(), a = new Date(e, t + 1, 0).getDate(), o = new Date(e, t, 0).getDate(), s = /* @__PURE__ */ new Date(), d = I(s.getFullYear(), s.getMonth(), s.getDate()), c = [], m = (l - r + 7) % 7, p = t === 0 ? 11 : t - 1, u = t === 0 ? e - 1 : e;
  for (let y = m - 1; y >= 0; y--) {
    const x = o - y, w = I(u, p, x);
    c.push({
      date: x,
      month: p,
      year: u,
  ...
  const v = Math.ceil(c.length / 7) * 7, _ = t === 11 ? 0 : t + 1, k = t === 11 ? e + 1 : e;
  for (let y = 1; c.length < v; y++) {
    const x = I(k, _, y);
    c.push({
      date: y,
      month: _,
...
function so(e, t = 0) {
  const r = $r(e, t);
  return Array.from({ length: 7 }, (l, a) => V(r, a));
}
function Pt(e = 0) {
...
function Cr(e) {
  if (e.length === 0) return [];
  const t = [...e].sort((d, c) => {
    const m = A(d.start), p = A(c.start);
    if (m !== p) return m - p;
    const u = A(d.end) - m;
    return A(c.end) - p - u;
  }), r = [], l = /* @__PURE__ */ new Map();
  for (const d of t) {
    const c = A(d.start), m = A(d.end);
    let p = !1;
    for (let u = 0; u < r.length; u++) if (r[u][r[u].length - 1].end <= c) {
      r[u].push({ end: m }), l.set(d.id, u), p = !0;
      break;
    }
    p || (r.push([{ end: m }]), l.set(d.id, r.length - 1));
  }
  const a = [], o = /* @__PURE__ */ new Set();
  for (const d of t) {
    if (o.has(d.id)) continue;
    const c = [d];
    o.add(d.id);
    let m = A(d.end), p = l.get(d.id) + 1;
    for (const u of t)
      o.has(u.id) || A(u.start) < m && (c.push(u), o.add(u.id), m = Math.max(m, A(u.end)), p = Math.max(p, l.get(u.id) + 1));
    a.push({
      events: c,
      totalColumns: p
    });
  ...
  const s = [];
  for (const d of a) for (const c of d.events) {
    const m = A(c.start), p = A(c.end), u = l.get(c.id), v = d.totalColumns;
    s.push({
      event: c,
      gridRowStart: Ot(m),
      gridRowEnd: Ot(p),
...
function po(e, t, r) {
  return so(e, t).map((l) => {
    const a = I(l.getFullYear(), l.getMonth(), l.getDate()), o = le(r, a).filter((s) => !s.allDay);
    return {
      date: a,
      dayLabel: Re[l.getDay()],
      dayNumber: l.getDate(),
      isToday: kr(l),
      events: Cr(o)
    };
...
function uo(e, t) {
  const r = I(e.getFullYear(), e.getMonth(), e.getDate()), l = le(t, r).filter((a) => !a.allDay);
  return {
    date: r,
    dayLabel: Re[e.getDay()],
    dayNumber: e.getDate(),
    isToday: kr(e),
    events: Cr(l)
  };
...
function ho(e, t, r) {
  ...
  for (let o = 1; o <= a; o++) {
    const s = I(e, t, o);
    r.some((d) => d.start.split("T")[0] === s) && l.add(s);
  }
  return l;
}
var vo = {
  ...
  return i`
		...
		<div class="ml-cv__title-group">
			<div class="ml-cv__title-row">
				...
				${n(e.view !== "day", () => i` <span class="ml-cv__week-badge">Week ${e.weekNumber}</span> `)}
			</div>
...
function bo(e) {
  return i`
		...
		${n(!e.hideTodayButton, () => i`<button type="button" class="ml-cv__today-btn" @click=${e.goToToday}>Today</button>`)}

		${n(!e.hideViewSelector, () => i`
  ...
  return i`
		<div class="ml-cv__header">
			<div class="ml-cv__header-left">
				${n(e.hasHeaderLeftSlot, () => i`<slot name="header-left"></slot>`, () => go(e))}
			</div>

			<div class="ml-cv__header-right">
				${n(e.hasHeaderActionsSlot, () => i`<slot name="header-actions"></slot>`, () => bo(e))}
			</div>
		</div>
	`;
}
function _o(e, t) {
  ...
  return i`
    ...
    [`ml-cv__event-pill--${r}`]: !0
			...
			@click=${(l) => {
    l.stopPropagation(), e.handleEventClick(t);
  }}
		>
			${n(!t.allDay, () => i`
				<span class="ml-cv__event-pill-time">${L(t.start)}</span>
			`)}
    ...
    return i`
      ...
      "ml-cv__weekday--today": d === l
			...
			<div class="ml-cv__month-grid">
				${$(r, (o) => o.iso, (o) => {
    const s = o.events.slice(0, e.maxVisibleEvents), d = o.events.length - e.maxVisibleEvents;
    return i`
						<div
							class=${h({
      "ml-cv__day-cell": !0,
  ...
  return i`
    ...
    a.stopPropagation(), e.handleEventClick(t.event);
		...
		>
			...
			<div class="ml-cv__time-event-time">${L(t.event.start)} – ${L(t.event.end)}</div>
		</div>
	`;
}
function wo(e) {
  ...
  return i`
    ...
    "ml-cv__time-header-day--today": l.isToday
  })}>
						<span class="ml-cv__time-header-label">${l.dayLabel}</span>
						<span class="ml-cv__time-header-number">${l.dayNumber}</span>
					</div>
				`)}
			</div>
    ...
    "ml-cv__time-column--last": a === 6
  })}
							style="grid-row: 1 / ${49}; grid-column: ${a + 2};"
						></div>
					`)}

					<!-- Row grid lines -->
					${$(r, (l, a) => `row-${a}`, (l, a) => i`
						<div class="ml-cv__time-row" style="grid-row: ${a + 1}; grid-column: 1 / ${t.length + 2};"></div>
					`)}

					<!-- Time slot labels in gutter -->
					${$(r, (l, a) => `label-${a}`, (l, a) => i`
						<div class="ml-cv__time-label" style="grid-row: ${a + 1}; grid-column: 1;">${l.label}</div>
					`)}
    ...
    pe: o,
    colIdx: a
  }))), (l) => l.pe.event.id, (l) => yo(e, l.pe, l.colIdx))}
				</div>
			</div>
		</div>
	`;
...
function $o(e) {
  ...
  return i`
    ...
    "ml-cv__mini-cal-day--selected": o.iso === a
  })}
						@click=${() => e.handleMiniCalSelect(o.iso)}
					>
						${o.date}
						${n(l.has(o.iso), () => i`<span class="ml-cv__mini-cal-dot"></span>`)}
					</button>
				`)}
			</div>
		</div>
						...
						<div class="ml-cv__sidebar-event" @click=${() => e.handleEventClick(r)}>
							...
							<div class="ml-cv__sidebar-event-content">
								...
								<div class="ml-cv__sidebar-event-time">
									${r.allDay ? "All day" : `${L(r.start)} – ${L(r.end)}`}
								</div>
							</div>
						</div>
					`)}
    ...
    "ml-cv__time-header-day--today": t.isToday
					...
					<div class="ml-cv__time-scroll">
						<div class="ml-cv__time-body ml-cv__time-body--day" style="--cv-rows: ${48};">
							...
							<!-- Row grid lines -->
							${$(r, (l, a) => `row-${a}`, (l, a) => i`
								<div class="ml-cv__time-row" style="grid-row: ${a + 1}; grid-column: 1 / 3;"></div>
							`)}
...
var Nt = class {
  constructor() {
    this.view = "month", this.date = "", this.weekStartsOn = 0, this.maxVisibleEvents = 3, this.addButtonText = "Add event", this.hideNav = !1, this.hideTodayButton = !1, this.hideViewSelector = !1, this.hideAddButton = !1, this.events = [], this.isViewDropdownOpen = !1, this._miniCalYear = 0, this._miniCalMonth = 0, this._hasScrolledToTime = !1, this._boundCloseDropdown = null, this.navigatePrev = () => {
      ...
      let r;
      this.view === "month" ? r = At(t, -1) : this.view === "week" ? r = V(t, -7) : r = V(t, -1), this.setDate(r);
    }, this.navigateNext = () => {
      const t = this._currentDate;
      let r;
      this.view === "month" ? r = At(t, 1) : this.view === "week" ? r = V(t, 7) : r = V(t, 1), this.setDate(r);
  ...
  onCreate() {
    if (!this.date) {
      ...
      this.date = I(r.getFullYear(), r.getMonth(), r.getDate());
    }
    const t = this._currentDate;
    this._miniCalYear = t.getFullYear(), this._miniCalMonth = t.getMonth(), this._boundCloseDropdown = (r) => {
      ...
      const l = r.composedPath(), a = this.elementRef.shadowRoot;
      if (!a) return;
      const o = a.querySelector(".ml-cv__view-dropdown");
      o && !l.includes(o) && (this.isViewDropdownOpen = !1);
  ...
  get headerSubtitle() {
    ...
    if (this.view === "week") {
      const t = $r(this._currentDate, this.weekStartsOn);
      return io(t, V(t, 6));
    }
    return co(this._currentDate);
  }
  get currentIsoDate() {
    const t = this._currentDate;
  ...
  get weekdayHeaders() {
    return Pt(this.weekStartsOn);
  }
  get monthGrid() {
    const t = this._currentDate, r = Mt(t.getFullYear(), t.getMonth(), this.weekStartsOn);
    for (const l of r) l.events = le(this.events, l.iso);
    return r;
  }
  get weekColumns() {
    return po(this._currentDate, this.weekStartsOn, this.events);
  }
  get timeSlots() {
    return mo();
  }
  ...
  get dayEvents() {
    return le(this.events, this.currentIsoDate);
  }
  ...
  get miniCalendarTitle() {
    return It(new Date(this._miniCalYear, this._miniCalMonth, 1));
  }
  get miniCalendarWeekdays() {
    return Pt(this.weekStartsOn).map((t) => t.short.charAt(0));
  }
  get miniCalendarGrid() {
    return Mt(this._miniCalYear, this._miniCalMonth, this.weekStartsOn);
  }
  get miniCalendarDots() {
    return ho(this._miniCalYear, this._miniCalMonth, this.events);
  }
  setDate(t) {
    this.date = I(t.getFullYear(), t.getMonth(), t.getDate()), this._miniCalYear = t.getFullYear(), this._miniCalMonth = t.getMonth(), this.elementRef.dispatchEvent(new CustomEvent("ml:date-change", {
      bubbles: !0,
      composed: !0,
...
const zo = (e) => i`<i class="${e.format === "regular" ? "ph" : `ph-${e.format}`}">${e.format === "regular" ? e.icon : `${e.icon}-${e.format}`}</i>`, To = () => f`
	:host {
		display: inline-flex;
		align-items: center;
		justify-content: center;
    ...
    [`ml-tabs--${e.orientation}`]: !0
		...
		>
			<div
				...
				@keydown=${e.handleKeyDown}
			>
				${t ? $(e.tabs, (r) => `${r.value}-${e.value === r.value}`, (r) => Ao(e, r)) : i`<slot name="tab" @slotchange=${e.handleTabSlotChange}></slot>`}
			</div>
...
function Ao(e, t) {
  ...
  return i`
    ...
    "ml-tabs__tab--disabled": !!t.disabled
		...
		>
			${n(!!t.icon, () => i`<ml-icon icon=${t.icon} size="sm"></ml-icon>`)}
...
var Ft = class {
  constructor() {
    this.value = "", this.variant = "line", this.size = "md", this.orientation = "horizontal", this.routed = !1, this.tabs = [], this._slottedTabs = [], this._handleNavigation = this.onNavigation.bind(this), this._handleTabClick = (t) => {
      ...
      const r = this.getAllTabs().filter((o) => !o.disabled), l = r.findIndex((o) => o.value === this.value);
      let a = l;
      switch (t.key) {
        case "ArrowLeft":
        case "ArrowUp":
          t.preventDefault(), a = l > 0 ? l - 1 : r.length - 1;
          break;
        case "ArrowRight":
        case "ArrowDown":
          t.preventDefault(), a = l < r.length - 1 ? l + 1 : 0;
          break;
        case "Home":
          t.preventDefault(), a = 0;
          break;
        case "End":
          t.preventDefault(), a = r.length - 1;
          break;
        default:
          return;
      }
  ...
  syncWithRoute() {
    const t = window.location.pathname, r = this.getAllTabs().find((l) => l.href && t.startsWith(l.href));
...
var Ht = class {
  constructor() {
    this.page = 1, this.totalPages = 1, this.siblings = 1, this.goToPage = (t) => {
      const r = Number(this.page), l = Number(this.totalPages);
      t < 1 || t > l || t === r || (this.page = t, this.elementRef.dispatchEvent(new CustomEvent("ml:page-change", {
        bubbles: !0,
        composed: !0,
  ...
  get pages() {
    const t = Math.max(1, Number(this.totalPages)), r = Math.min(Math.max(1, Number(this.page)), t), l = Math.max(0, Number(this.siblings)), a = (m, p) => Array.from({ length: p - m + 1 }, (u, v) => ({
      type: "page",
      value: m + v
    })), o = Math.max(r - l, 1), s = Math.min(r + l, t), d = o > 2, c = s < t - 1;
    return !d && !c ? a(1, t) : !d && c ? [
      ...a(1, Math.max(s, 3 + l)),
      { type: "ellipsis" },
      {
        type: "page",
    ...
    "ml-sidebar--collapsed": l
		...
		>
			...
			<div class="ml-sidebar__main">
				${t ? $(e.navigation, (a, o) => `nav-group-${o}`, (a) => Ko(e, a)) : i`<slot @slotchange=${e.handleDefaultSlotChange}></slot>`}
			</div>

			<div class="ml-sidebar__footer">
				${r ? i`
						<div class="ml-sidebar__footer-nav">
							${$(e.footerNavigation, (a) => a.value, (a) => ze(e, a, 0))}
						</div>
					` : i`
						<div class="ml-sidebar__footer-nav">
  ...
  return i`
		<div class="ml-sidebar__group">
			...
			<div class="ml-sidebar__group-items">
				${$(t.items, (l) => l.value, (l) => ze(e, l, 0))}
			</div>
		</div>
	`;
}
function ze(e, t, r) {
  const l = e.active === t.value, a = !!t.children && t.children.length > 0, o = e._expandedItems.has(t.value), s = e.collapsed, d = h({
    ...
    "ml-sidebar__item-link--has-children": a
  }), c = (p) => {
    if (!t.disabled) {
      if (a) {
        p.preventDefault(), e.handleConfigToggle(t, e._expandedItems);
        return;
      }
    ...
    [`ml-sidebar__item-badge--${t.badgeColor || "default"}`]: !0
				...
				`)}
				${n(!!t.external, () => i`<ml-icon icon="arrow-square-out" size="xs"></ml-icon>`)}
				${n(a, () => i`
					<ml-icon
		...
		<div class="ml-sidebar__item" style="--level: ${r}">
			...
			${n(a && o && !s, () => i`
				<div class="ml-sidebar__item-submenu">
					${$(t.children, (p) => p.value, (p) => ze(e, p, r + 1))}
				</div>
			`)}
		</div>
	`;
...
var Kt = class {
  constructor() {
    this.variant = "default", this.active = "", this.collapsed = !1, this.navigation = [], this.footerNavigation = [], this._slottedItems = [], this._hoverTimer = null, this._handleItemClick = this.onItemClick.bind(this), this._handleMouseEnter = this.onMouseEnter.bind(this), this._handleMouseLeave = this.onMouseLeave.bind(this), this.handleDefaultSlotChange = (t) => {
      ...
      if (!r) return;
      const l = Array.from(r.querySelectorAll(".ml-sidebar__item-link:not([disabled]), button:not([disabled]), a")), a = l.indexOf(t.target);
      let o = a;
      switch (t.key) {
        case "ArrowUp":
          t.preventDefault(), o = a > 0 ? a - 1 : l.length - 1;
          break;
        case "ArrowDown":
          t.preventDefault(), o = a < l.length - 1 ? a + 1 : 0;
          break;
        case "Home":
          t.preventDefault(), o = 0;
          break;
        case "End":
          t.preventDefault(), o = l.length - 1;
          break;
        default:
          return;
      }
...
function Yo(e) {
  const t = parseInt(e.level, 10) || 0, r = e.collapsed, l = i`
    ...
    [`ml-sidebar-item__badge--${e["badge-color"]}`]: !0
					...
					`)}
					${n(e.external, () => i`<ml-icon icon="arrow-square-out" size="xs"></ml-icon>`)}
				</slot>
				${n(e.hasChildren, () => i`
					<ml-icon
  ...
  return i`
		<div class="ml-sidebar-item" style="--level: ${t}">
			${n(!!e.href && !e.hasChildren, () => i`
				...
				`)}
			${n(e.hasChildren && e.expanded && !r, () => i`
    ...
    "ml-steps--compact": r
		...
		>
			<div
				...
				@keydown=${e.handleKeyDown}
			>
				${t ? $(e.steps, (l) => `${l.value}-${e.active === l.value}`, (l, a) => Qo(e, l, a)) : i`<slot name="step" @slotchange=${e.handleStepSlotChange}></slot>`}
			</div>
...
function Qo(e, t, r) {
  const l = e.steps, a = r === 0, o = r === l.length - 1, s = e.getStepStatus(t.value), d = e.variant === "bar", c = e.compact;
  return i`
		<div
			class=${h({
    "ml-step": !0,
...
function Zo(e, t) {
  return i`
		...
		<div class="ml-step__content">
			...
			${n(!!t.description, () => i`<span class="ml-step__description">${t.description}</span>`)}
		</div>
	`;
}
function ei(e, t, r, l, a, o) {
  return i`
    ...
    case "numbered":
      return i`
				<div class="ml-step__indicator-inner ml-step__indicator-inner--numbered">
					${n(l === "completed", () => i`<ml-icon icon="check" size="sm"></ml-icon>`)}
					${n(l !== "completed", () => i`<span>${r + 1}</span>`)}
				</div>
			`;
    case "circles":
      return i`
				<div class="ml-step__indicator-inner ml-step__indicator-inner--circles">
					${n(l === "completed", () => i`<ml-icon icon="check" size="sm"></ml-icon>`)}
					${n(l !== "completed", () => i`<div class="ml-step__indicator-dot"></div>`)}
				</div>
			`;
    case "icons":
      return i`
...
var Ut = class {
  constructor() {
    this.active = "", this.variant = "numbered", this.orientation = "horizontal", this.connector = "solid", this.color = "primary", this.compact = !1, this.routed = !1, this.steps = [], this._slottedSteps = [], this._handleNavigation = this.onNavigation.bind(this), this.handleStepSlotChange = (t) => {
      if (this._slottedSteps = t.target.assignedElements({ flatten: !0 }), !this.active && this._slottedSteps.length > 0) {
        const r = this._slottedSteps.find((l) => !l.hasAttribute("disabled"));
      ...
      const { value: r, href: l } = t.detail;
      this.handleStepClick(r, l);
    }, this.handleKeyDown = (t) => {
      const r = this.getAllSteps().filter((s) => !s.disabled), l = r.findIndex((s) => s.value === this.active);
      let a = l;
  ...
  getStepStatus(t) {
    const r = this.getAllSteps(), l = r.findIndex((o) => o.value === this.active), a = r.findIndex((o) => o.value === t);
    return a < l ? "completed" : a === l ? "current" : "upcoming";
  }
  ...
  updateSlottedStepStates() {
    ...
    this._slottedSteps.forEach((r, l) => {
      const a = r.getAttribute("value") || "", o = this.getStepStatus(a);
      r.setAttribute("status", o), r.setAttribute("variant", this.variant), r.setAttribute("connector", this.connector), r.setAttribute("color", this.color), r.setAttribute("orientation", this.orientation), r.setAttribute("step-number", String(l + 1)), r.toggleAttribute("first", l === 0), r.toggleAttribute("last", l === t.length - 1), r.toggleAttribute("compact", this.compact);
    });
  }
  /** Update panel visibility */
  updatePanelVisibility() {
  ...
  syncWithRoute() {
    const t = window.location.pathname, r = this.getAllSteps().find((l) => l.href && t.startsWith(l.href));
...
function oi(e) {
  return i`
		...
		<div class="ml-step__content">
			...
			${n(!!e.description, () => i`<span class="ml-step__description">${e.description}</span>`)}
		</div>
	`;
}
function ii(e) {
...
function Yt(e) {
  ...
  return i`
		<div class="ml-step__indicator-inner ml-step__indicator-inner--numbered">
			${n(t, () => i`<ml-icon icon="check" size="sm"></ml-icon>`)}
			${n(!t, () => i`<span>${e["step-number"]}</span>`)}
		</div>
	`;
}
function di(e) {
  ...
  return i`
		<div class="ml-step__indicator-inner ml-step__indicator-inner--circles">
			${n(t, () => i`<ml-icon icon="check" size="sm"></ml-icon>`)}
			${n(!t, () => i`<div class="ml-step__indicator-dot"></div>`)}
		</div>
	`;
}
function ci(e) {
...
var gi = class {
  ...
  addDialog(t, r) {
    ...
    return this._dialogs.set(t, {
      ...
      this.cleanUpDialog(t, a?.dialogComponent);
    }), l;
  }
  removeDialog(t) {
...
g([F(G), O("design:type", typeof (Qt = typeof G < "u" && G) == "function" ? Qt : Object)], ye.prototype, "_dialogService", void 0);
ye = g([b({
  selector: "ml-dialog",
  template: hi,
  styles: vi,
...
var Zt = class {
  constructor() {
    this.side = "right", this.size = "md", this.showClose = !0, this.close = () => {
      ...
      const t = this._positionProp, r = this._panelEl.offsetWidth, l = this._panelEl.animate([{ [t]: "0px" }, { [t]: `${-r}px` }], {
        duration: 300,
...
function _i(e) {
  return i`
		<div class="ml-dropdown">
			...
			>
				<slot></slot>
				${n(e.arrow, () => i`<div class="ml-dropdown__arrow"></div>`)}
			</div>
		</div>
	`;
}
...
var er = class {
        ...
        switch (t.key) {
          ...
          case " ":
            if (t.preventDefault(), this._focusedIndex >= 0 && this._focusedIndex < r.length) {
              const l = r[this._focusedIndex];
              l.disabled || l.handleClick();
            }
            break;
          case "Escape":
            t.preventDefault(), this.close();
  ...
  getNavigableItems() {
    ...
    if (!t) return [];
    const r = [], l = t.assignedElements();
    for (const a of l) if (a.tagName === "ML-DROPDOWN-ITEM") r.push(a);
    else if (a.tagName === "ML-DROPDOWN-GROUP") {
      const o = a.shadowRoot?.querySelector("slot:not([name])");
      if (o)
  ...
  updatePosition(t, r) {
    ...
    const { x: o, y: s, placement: d, middlewareData: c } = ae(t, r, {
      placement: this.placement,
      middleware: a
    });
    r.style.left = `${o}px`, r.style.top = `${s}px`, r.dataset.placement = d, l && c.arrow && this.positionArrow(l, d, c.arrow);
  }
  positionArrow(t, r, l) {
    const a = r.split("-")[0];
    t.style.left = l.x === void 0 ? "" : `${l.x}px`, t.style.right = "", t.style.top = l.y === void 0 ? "" : `${l.y}px`, t.style.bottom = "", a === "top" && (t.style.bottom = "-4px"), a === "bottom" && (t.style.top = "-4px"), a === "left" && (t.style.right = "-4px"), a === "right" && (t.style.left = "-4px");
  }
  getTriggerEl() {
...
function yi(e) {
  return i`
    ...
    "ml-dropdown-item--destructive": e.destructive
			...
			@click=${e.handleClick}
		>
			${n(!!e.icon, () => i`<ml-icon class="ml-dropdown-item__icon" icon=${e.icon} size="sm"></ml-icon>`)}
			<span class="ml-dropdown-item__label"><slot></slot></span>
			${n(!!e.addon, () => i`<span class="ml-dropdown-item__addon">${e.addon}</span>`)}
		</div>
	`;
}
const wi = () => f`
...
function Ci(e) {
  return i`
		<div class="ml-dropdown-group" role="group">
			${n(!!e.label, () => i`<div class="ml-dropdown-group__label">${e.label}</div>`)}
			<slot></slot>
		</div>
	`;
}
...
var ar = class {
  ...
  updatePosition() {
    ...
    if (!t || !r) return;
    const { x: a, y: o, placement: s } = ae(t, r, {
      placement: this.placement,
      middleware: [
        oe(8),
        ie(),
    ...
    if (r.style.left = `${a}px`, r.style.top = `${o}px`, r.setAttribute("data-placement", s), l) {
      const d = s.split("-")[0];
      l.style.left = "", l.style.right = "", l.style.top = "", l.style.bottom = "", d === "top" || d === "bottom" ? (l.style.left = "50%", l.style.marginLeft = "-4px") : (l.style.top = "50%", l.style.marginTop = "-4px");
    }
  }
};
ar = g([b({
...
function zi(e) {
  return i`
		<div class="ml-popover">
			...
			>
				<slot></slot>
				${n(e.arrow, () => i`<div class="ml-popover__arrow"></div>`)}
			</div>
		</div>
	`;
}
...
function Di(e) {
  ...
  return i`
    ...
    "ml-app-shell--header-fixed": l,
    "ml-app-shell--mobile-open": a
  })}
		>
			${n(o, () => i`
				<div
    ...
    "ml-app-shell__backdrop--visible": a
  })}
    ...
    "ml-app-shell__sidebar--mobile-open": a
  })}
			>
				...
				<div class="ml-page-header__content">
					${n(t, () => i`
						<div class="ml-page-header__title">
							${n(e.hasTitleSlot, () => i`<slot name="title"></slot>`, () => i`<h1>${e.title}</h1>`)}
						</div>
					`)}

					${n(r, () => i`
						<div class="ml-page-header__description">
							${n(e.hasDescriptionSlot, () => i`<slot name="description"></slot>`, () => i`<p>${e.description}</p>`)}
						</div>
					`)}
...
export {
  Et as ActivityFeedComponent,
  Rt as ActivityFeedItemComponent,
  pt as AlertComponent,
  ir as AppShellComponent,
  yt as AvatarComponent,
  wt as BadgeComponent,
  kt as BadgeGroupComponent,
  Bt as BreadcrumbComponent,
  qt as BreadcrumbItemComponent,
  Ye as ButtonComponent,
  Xe as ButtonGroupComponent,
  Je as ButtonGroupItemComponent,
  ct as CalendarComponent,
  Nt as CalendarViewComponent,
  bt as CardComponent,
  et as CheckboxComponent,
  ...
  Zt as DrawerComponent,
  er as DropdownComponent,
  lr as DropdownGroupComponent,
  tr as DropdownItemComponent,
  rr as DropdownSeparatorComponent,
  nt as FormFieldComponent,
  sr as HeroSectionComponent,
  Lt as IconComponent,
  Qe as InputComponent,
  Ct as ListComponent,
  St as ListItemComponent,
  dr as LoginPageComponent,
  nr as PageHeaderComponent,
  Ht as PaginationComponent,
  or as PopoverComponent,
  gt as ProgressComponent,
  at as RadioCardComponent,
  lt as RadioCardGroupComponent,
  tt as RadioComponent,
  rt as RadioGroupComponent,
  it as SelectComponent,
  Kt as SidebarComponent,
  Wt as SidebarGroupComponent,
  Gt as SidebarItemComponent,
  cr as SignupPageComponent,
  st as SliderComponent,
  Ue as SpinnerComponent,
  _t as StackComponent,
  Xt as StepComponent,
  Jt as StepPanelComponent,
  Ut as StepsComponent,
  Vt as TabComponent,
  jt as TabPanelComponent,
  zt as TableComponent,
  Ft as TabsComponent,
  $t as TagComponent,
  Ze as TextareaComponent,
  ht as ToastComponent,
  vt as ToastContainerComponent,
  ut as ToastService,
  ot as ToggleComponent,
  ar as TooltipComponent,
  gr as VirtualScroller,
  Xa as activityFeedItemStyles,
  Ya as activityFeedItemTemplate,
  Ua as activityFeedStyles,
  Ga as activityFeedTemplate,
  Pr as allTokens,
  ls as announce,
  Ai as appShellStyles,
  Di as appShellTemplate,
  Fr as applyTheme,
  ur as arrow,
  we as autoUpdate,
  Wi as baseThemeCss,
  Ar as borderTokens,
  jo as breadcrumbItemStyles,
  Vo as breadcrumbItemTemplate,
  Fo as breadcrumbStyles,
  Lo as breadcrumbTemplate,
  Mr as breakpointTokens,
  qi as breakpoints,
  Ro as calendarViewStyles,
  Eo as calendarViewTemplate,
  ns as clickOutside,
  Rr as colorTokens,
  ss as componentBaseStyles,
  ae as computePosition,
  Ma as containerStyles,
  Ia as containerTemplate,
  Ji as createBrandTheme,
  Wr as createFocusTrap,
  as as createLiveRegion,
  pr as createTheme,
  Te as darkTheme,
  Ki as darkThemeCss,
  Bi as dashboardPageStyles,
  ji as dashboardPageTemplate,
  fi as drawerStyles,
  bi as drawerTemplate,
  Si as dropdownGroupStyles,
  Ci as dropdownGroupTemplate,
  wi as dropdownItemStyles,
  yi as dropdownItemTemplate,
  $i as dropdownSeparatorStyles,
  ki as dropdownSeparatorTemplate,
  xi as dropdownStyles,
  _i as dropdownTemplate,
  ie as flip,
  Qi as focusFirst,
  Zi as focusLast,
  es as focusTrap,
  rs as focusVisible,
  sa as formFieldStyles,
  ia as formFieldTemplate,
  hr as getFirstFocusable,
  ke as getFocusableElements,
  Kr as getLastFocusable,
  Lr as getResolvedTheme,
  Gi as getTheme,
  Mi as heroSectionStyles,
  Ii as heroSectionTemplate,
  Xi as injectTheme,
  ts as isFocusVisible,
  Nr as lightTheme,
  Hi as lightThemeCss,
  Wa as listItemStyles,
  Ka as listItemTemplate,
  Ha as listStyles,
  qa as listTemplate,
  Li as loginPageStyles,
  Ni as loginPageTemplate,
  Ur as newID,
  oe as offset,
  Ui as onThemeChange,
  Oi as pageHeaderStyles,
  Pi as pageHeaderTemplate,
  qo as paginationStyles,
  Bo as paginationTemplate,
  Er as primitiveColors,
  Sa as progressStyles,
  Ca as progressTemplate,
  os as resetStyles,
  la as selectStyles,
  Zl as selectTemplate,
  Dr as shadowTokens,
  se as shift,
  Uo as sidebarGroupStyles,
  Go as sidebarGroupTemplate,
  Xo as sidebarItemStyles,
  Yo as sidebarItemTemplate,
  Wo as sidebarStyles,
  Ho as sidebarTemplate,
  Vi as signupPageStyles,
  Fi as signupPageTemplate,
  oa as sliderStyles,
  aa as sliderTemplate,
  zr as spacingTokens,
  ui as stepPanelStyles,
  pi as stepPanelTemplate,
  mi as stepStyles,
  ai as stepTemplate,
  li as stepsStyles,
  Jo as stepsTemplate,
  No as tabPanelStyles,
  Oo as tabPanelTemplate,
  Po as tabStyles,
  Mo as tabTemplate,
  Za as tableStyles,
  Qa as tableTemplate,
  ...
  xa as toastContainerTemplate,
  _a as toastStyles,
  fa as toastTemplate,
  Yi as toggleTheme,
  Or as tokensToCss,
  cl as tooltipDirective,
  Ir as transitionTokens,
  Tr as typographyTokens,
  is as visuallyHiddenStyles
};
