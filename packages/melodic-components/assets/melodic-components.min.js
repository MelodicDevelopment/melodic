  ...
  for (const o of e) {
    ...
    if (o.children || o.loadChildren) {
      ...
      if (c && c.params !== null) {
        ...
        return Object.assign(l, c.params), a.push(h), o.children && c.remainingPath ? Gr(o.children, c.remainingPath, m, a, l) : {
          matches: a,
          params: l,
...
function ze(e, t, r = "") {
  const a = Gr(e, t.startsWith("/") ? t.slice(1) : t, r, [], {});
  return {
    matches: a.matches,
    params: a.params,
...
v([G(q), F("design:type", typeof (it = typeof q < "u" && q) == "function" ? it : Object)], Re.prototype, "_router", void 0);
Re = v([f({
...
v([G(q), F("design:type", typeof (nt = typeof q < "u" && q) == "function" ? nt : Object)], Te.prototype, "_router", void 0);
Te = v([f({
...
v([G(Ae), F("design:type", Object)], B.prototype, "_state", void 0);
v([G(De), F("design:type", Object)], B.prototype, "_reducerMap", void 0);
v([G(Ie), F("design:type", Object)], B.prototype, "_effectMap", void 0);
v([G(Ur), F("design:type", Boolean)], B.prototype, "_debug", void 0);
...
var Pt = class {
  ...
  isMonthDisabled(t, r) {
    const a = K(t, r, new Date(t, r + 1, 0).getDate()), l = K(t, r, 1);
			...
			<div class="ml-sidebar__footer">
				${r ? i`
						<div class="ml-sidebar__footer-nav">
							${k(e.footerNavigation, (l) => l.value, (l) => Ke(e, l, 0))}
						</div>
					` : i`
						<div class="ml-sidebar__footer-nav">
  ...
  return i`
		<div class="ml-sidebar__group">
			...
			<div class="ml-sidebar__group-items">
				${k(t.items, (a) => a.value, (a) => Ke(e, a, 0))}
			</div>
		</div>
	`;
}
		...
		<div class="ml-sidebar__item" style="--level: ${r}">
			...
			${d(l && o && !s, () => i`
				<div class="ml-sidebar__item-submenu">
					${k(t.children, (h) => h.value, (h) => Ke(e, h, r + 1))}
				</div>
			`)}
		</div>
	`;
...
v([G(le), F("design:type", typeof (xr = typeof le < "u" && le) == "function" ? xr : Object)], Ne.prototype, "_dialogService", void 0);
Ne = v([f({
  selector: "ml-dialog",
  template: fs,
  styles: _s,
...
export {
  ...
  Gt as BadgeComponent,
  Kt as BadgeGroupComponent,
  ye as Binding,
  ...
  Ki as paginationStyles,
  Gi as paginationTemplate,
