...
var al = class {
  ...
  */
  warnOnRebind(e) {
    ...
    t?.isSingleton && t.getInstance() !== void 0 && F(`rebind:${oe(e)}`, `'${oe(e)}' was re-bound after its singleton had already been resolved. Consumers holding the previous instance keep it, so two versions are now live. Bind before the first resolution, or call Injector.unbind() first.`);
  }
  bindValue(e, t) {
...
const bl = (e) => {
  ...
  ot.add(e), bt || (bt = fo().catch((t) => {
    F("global-styles-load", "Global styles could not be read. A cross-origin stylesheet cannot be adopted into shadow roots — serve it same-origin or inline it in a <style melodic-styles> element.", t);
  }).finally(() => {
...
`));
          ...
          F(`global-styles-cors:${t.href}`, `Global stylesheet "${t.href}" is cross-origin, so its rules cannot be copied into shadow roots. Serve it from the same origin to have it adopted.`, r);
        }
      }
    }
}, _t = (e) => {
...
var wo = 100, ke = 0, Ue = !1, le = /* @__PURE__ */ new Set(), J = /* @__PURE__ */ new Set(), lt = /* @__PURE__ */ new Map();
function xl() {
  return ke > 0 || Ue;
}
function kl(e) {
...
function dr() {
  return /* @__PURE__ */ new Error(`Circular dependency detected in effect: exceeded ${wo} synchronous re-runs. An effect is repeatedly writing to a signal it also reads.`);
}
function Sl(e) {
...
var cr = 100, Ie = class {
  ...
  */
  ...
  destroy() {
    this._destroyed = !0, this._needsRerun = !1, this.clearDependencies(), yo(this);
  }
...
function L(e, t = {}) {
  ...
  p.set = () => {
    ...
    o || (o = !0, d.destroy(), yo(h), i.clear(), l.clear());
  ...
  const u = Y();
  return u?.registerDisposable(p), u?.isRendering && F(`computed-in-render:${u.selector ?? "component"}${t.name ? `:${t.name}` : ""}`, `computed()${t.name ? ` '${t.name}'` : ""} was created while <${u.selector ?? "a component"}> was rendering. A new one is created on every render and they accumulate for the life of the component. Create it in a field initializer or onInit, or use store.select(key, fn, cacheKey), which is render-scoped.`), p;
}
function Uc(e, t = {}) {
  let r = null, a = !1;
  const o = () => {
...
function Al(e, t) {
  if (!G()) return;
  for (const a of ut(e.attributes)) /[A-Z]/.test(a) && F(`attr-case:${e.selector}:${a}`, `<${e.selector}> observes attribute "${a}", which can never fire — HTML lowercases attribute names. Use "${a.replace(/[A-Z]/g, (o) => `-${o.toLowerCase()}`)}" (it maps to the "${a}" property).`);
  const r = t.prototype;
  if (r)
    for (const a of ut(e.attributes)) {
      const o = a.replace(/-([a-z])/g, (l, i) => i.toUpperCase());
      typeof r[o] == "function" && F(`attr-method:${e.selector}:${a}`, `<${e.selector}> observes attribute "${a}", but "${o}" is a method. Setting the attribute would replace the method with the attribute string.`);
    }
}
function y(e) {
  return function(t) {
    ...
    if (r && r.componentClass !== t && F(`duplicate-selector:${e.selector}`, `Two classes were registered as <${e.selector}> ('${r.componentClass?.name ?? "unknown"}' and '${t.name}'). The first registration wins and the second is ignored — custom element names are global.`), customElements.get(e.selector) === void 0) {
...
function yt(e, t) {
  ...
  for (const a of Object.keys(t)) {
    ...
    const o = r[a], l = t[a];
    l !== null && typeof l == "object" && !Array.isArray(l) && o !== null && typeof o == "object" && !Array.isArray(o) ? r[a] = yt(o, l) : r[a] = l;
  }
  return r;
}
function Qc(e) {
  const t = e[Ml], r = t ? yt(e.base, t) : { ...e.base };
  return e.extends ? yt(e.extends, r) : r;
}
...
function Yl() {
  q((e) => e.tagName === "INPUT" || e.tagName === "TEXTAREA" || e.tagName === "SELECT", Bl), q((e) => e.tagName === "INPUT" && e.type === "radio", Kl), q((e) => e.tagName === "INPUT" && e.type === "checkbox", Hl);
}
Yl();
...
function Wl(e, t, r) {
  ...
  const l = [], i = (v) => {
    ...
    const w = v.target;
    w !== e && !e.contains(w) || a.updateOn === "change" && h();
  }, u = () => {
...
function Ul(e, t, r) {
  if (!vt(t)) {
    F("model-not-signal", ':model expects a signal — for example `:model=${this.name}` where `name = signal("")`. Received:', t);
    return;
  }
  const a = t, o = Co(e);
  if (!o) {
    F(`model-no-adapter:${e.tagName}`, `:model has no adapter registered for <${e.tagName.toLowerCase()}>, so it cannot read or write its value.`);
    return;
  }
  let l = !1;
  const i = (c) => {
...
var hm = class extends CustomEvent {
  constructor(e) {
    super(Xl, {
      bubbles: !1,
      composed: !0,
    ...
    if (n.children || n.loadChildren) {
      ...
      if (h && h.params !== null) {
        ...
        if (n.children && h.remainingPath) {
          ...
          for (const w of Object.keys(o)) delete o[w];
          Object.assign(o, g);
          continue;
        }
...
var st = /* @__PURE__ */ new WeakMap(), nt = /* @__PURE__ */ new WeakMap(), wr = 64, yr = 10, dt = "__melodicHistoryIndex";
function ti(e) {
  let t = st.get(e);
...
var B = class {
  ...
  */
  async resolveMatch(t, r) {
    ...
    return {
      ...
      error: `Route '${t}' exceeded ${wr} lazy child loads`
    };
  }
  ...
  */
  async navigateInternal(t, r, a) {
    const { data: o, replace: l = !1, queryParams: i, skipGuards: n = !1, skipResolvers: d = !1, scrollToTop: c = !0, onSameUrlNavigation: h = "ignore" } = r, p = ei(t, i), u = a ? a.chain : [], b = n || (a?.skipDeactivation ?? !1), g = ++this._navigationId, { pathname: v, search: w, hash: C } = this.parseUrl(p);
    if (this._pendingTarget = {
      pathname: v,
      queryParams: new URLSearchParams(w)
    }, this.emit("start", g, p, "imperative"), u.length >= yr) {
      const E = `Redirect limit (${yr}) exceeded: ${[...u, p].join(" → ")}`;
    ...
    try {
      ...
      const V = await this.resolveMatch(t, () => this._navigationId === g);
      if (V.superseded || this._navigationId !== g) return M();
      const S = V.result;
      if (S.redirectTo)
      ...
      if (V.error)
        return this.emit("error", g, p, "imperative", { error: V.error }), {
          success: !1,
          error: V.error
        };
...
var Me = `m${Math.random().toString(36).slice(2, 9)}`, ue = `<!--${Me}-->`, Oe = `__${Me}_`, $r = new RegExp(`${Oe}(\\d+)__`, "g"), ye = (e) => `${Oe}${e}__`, re = /* @__PURE__ */ new Map();
function Sr(e, t) {
  ...
  */
  ...
  getTemplate(t) {
    ...
    for (let k = 1; k < this.strings.length; k++) {
      ...
      const V = k - 1, S = d.inTag ? /([@.:?]?[\w:-]+)\s*=\s*["']?$/.exec(o) : null, A = d.inTag ? /([@.:?]?[\w:-]+)\s*=\s*(")([^"]*)$/.exec(o) : null, T = d.inTag ? /([@.:?]?[\w:-]+)\s*=\s*(')([^']*)$/.exec(o) : null, I = A && T ? A.index >= T.index ? A : T : A ?? T;
      let R = "___";
      if (i) o += ye(V);
      else {
        ...
        if (I && !Zo)
          ...
          if (R === "__" && S) {
            ...
            o = l[R](V, o, S ? S[1] : void 0, S), X && E.startsWith(X) && (E = E.slice(1));
          }
        }
      }
    ...
    const p = [];
    let u = 0;
    const b = [], g = /* @__PURE__ */ new Map(), v = /* @__PURE__ */ new Map(), w = /* @__PURE__ */ new Map(), C = /* @__PURE__ */ new Map();
    ...
    const M = (k, E) => {
      if (k.nodeType === Node.COMMENT_NODE) {
        ...
        for (let A = S.attributes.length - 1; A >= 0; A--) {
          ...
          if (T.name.startsWith("__event-")) {
            ...
            const I = parseInt(T.name.match(/__action-(\d+)__/)?.[1] || "0"), R = w.get(I);
            R && p.push({
              path: [...E],
              type: "action",
              index: R.index,
      ...
      const V = k.childNodes;
      for (let S = 0; S < V.length; S++)
        E.push(S), M(V[S], E), E.pop();
    };
  ...
  */
  renderArray(t, r) {
    ...
    if (o) {
      ...
      for (const h of o) {
        n.has(h.key) && F("array-duplicate-key", `An interpolated keyed array contains a duplicate key (${String(h.key)}). Keys must be unique — entries sharing a key cannot be tracked apart across renders.`), n.add(h.key);
...
function Ir(e, t, r, a) {
  ...
  for (let v = 0; v < e.length; v++) {
    const w = t(e[v], v);
    n[v] = w, !c && l.has(w) && (c = !0, d = w), l.set(w, v);
  }
  if (c && F("repeat-duplicate-key", `repeat() received a duplicate key (${String(d)}). Keys must be unique — with a repeated key one item shadows the other, leaving orphaned DOM behind on every update. Use a key that is unique per item (an id, not an index into a filtered list).`), o.length === e.length) {
    let v = !0;
    for (let w = 0; w < e.length; w++) if (o[w].key !== n[w]) {
      v = !1;
      break;
    }
    if (v) {
      for (let w = 0; w < e.length; w++) St(r(e[w], w), o[w].container, o[w].start, o[w].end);
      return;
    }
  }
  const h = /* @__PURE__ */ new Map(), p = /* @__PURE__ */ new Map();
  for (let v = 0; v < o.length; v++) {
    const w = o[v], C = h.get(w.key);
    C ? C.push(w) : (h.set(w.key, [w]), p.set(w.key, v));
  }
  for (let v = 0; v < e.length; v++) {
    const w = e[v], C = n[v], M = h.get(C);
    if (M && M.length > 0) {
      const k = M.shift();
      M.length === 0 && h.delete(C), St(r(w, v), k.container, k.start, k.end), i.push({
        item: k,
        oldIndex: p.get(C) ?? -1,
        isNew: !1
      });
  ...
  for (const v of h.values()) for (const w of v) ki(w);
  if (i.length === 0) {
    a.items = [];
    return;
  }
  ...
  for (let v = i.length - 1; v >= 0; v--) {
    const w = i[v];
    w.isNew ? yi(w.item, b, g) : u.has(v) || xi(w.item, g), g = w.item.start;
  }
...
function Lm(e, t) {
  ...
  return t.primary && we(r, "--ml-color-primary", t.primary, a), t.secondary && we(r, "--ml-color-secondary", t.secondary, a), t.success && we(r, "--ml-color-success", t.success, a), t.warning && we(r, "--ml-color-warning", t.warning, a), t.danger && we(r, "--ml-color-danger", t.danger, a), Mo(e, r);
}
function Wi(e, t, r) {
...
function as(e = {}) {
  ...
  return {
    ...
    fn(o) {
      ...
      let g = l, v = i;
      if (u) {
        const w = t, C = c.width - d.floating.width - t;
        g = Math.max(w, Math.min(g, C));
      }
      if (b) {
        const w = t, C = c.height - d.floating.height - t;
        v = Math.max(w, Math.min(v, C));
      }
      return {
        x: g,
        y: v
...
function Oo(e, t = {}) {
  ...
  function h(g) {
    ...
    const w = v[0], C = v[v.length - 1], M = Dt();
    g.shiftKey ? M === w && (g.preventDefault(), C.focus()) : M === C && (g.preventDefault(), w.focus());
  }
  function p() {
    if (!l) {
...
function ys(e) {
  ...
  const l = {
    ...
    show: a,
    hide: o
  }, i = t.shadowRoot?.querySelector(".ml-tooltip__content");
  return i && !e.hasAttribute("aria-describedby") && (Xt(e, [i]), l.ownsDescribedBy = !0), l;
}
function xs(e, t) {
...
function ks(e, t) {
  if (!t) return;
  const { content: r, placement: a } = ws(t);
  if (!r) return;
  let o = Qe.get(e);
  o ? o.pendingRemoval = !1 : (o = ys(e), Qe.set(e, o)), o.tooltip.getAttribute("content") !== r && o.tooltip.setAttribute("content", r);
  const l = a ?? "top";
  o.tooltip.getAttribute("placement") !== l && o.tooltip.setAttribute("placement", l), jo(e, o.tooltip);
  const i = o;
  return () => {
    i.pendingRemoval = !0, queueMicrotask(() => {
      i.pendingRemoval && xs(e, i);
    });
  };
}
Pe("tooltip", ks);
...
`;
q((e) => e.tagName === "ML-RADIO-CARD-GROUP", {
  inputEvent: "ml:change",
  blurEvent: "focusout",
  getValue: (e) => e.value ?? "",
  setValue: (e, t) => {
    ...
    "ml-select--multiple": e.multiple
		...
		>
			...
			<div class="ml-select__control">
				...
				>
					${e.filteredOptions.length ? $(e.filteredOptions, (t) => t.value, (t, r) => Qs(e, t, r)) : s`<div class="ml-select__empty">No results found</div>`}
				</div>
			</div>
...
var Zs = 700, oa = class {
  ...
  handleTypeahead(t) {
    ...
    t.preventDefault();
    const r = Date.now();
    r - this._typeaheadLastTime > Zs && (this._typeaheadBuffer = ""), this._typeaheadLastTime = r, this._typeaheadBuffer += t.key.toLowerCase();
...
var da = class {
  ...
  */
  ...
  get resolvedMinYear() {
    return na(this.minYear) ?? (/* @__PURE__ */ new Date()).getFullYear() - pn;
  }
  get resolvedMaxYear() {
    return na(this.maxYear) ?? (/* @__PURE__ */ new Date()).getFullYear() + un;
  }
  get days() {
...
function Rn(e) {
  return e.shape === "circle" ? Cn(e) : e.shape === "half-circle" ? En(e) : Sn(e);
}
const zn = () => x`
	:host {
...
var ed = /* @__PURE__ */ new Set([
  ...
  get isPresetColor() {
    return ed.has(this.indicatorColor);
  }
  onCreate() {
    const t = this.elementRef.shadowRoot;
    t && _e(t, (r, a) => {
...
function Ia(e) {
  return `${ld()[e.getMonth()]} ${e.getFullYear()}`;
}
function sd(e, t) {
...
function Xo(e) {
  ...
  for (const c of e) t.set(c.id, md(c));
  ...
  for (const c of i) for (const h of c.events) {
    const { start: p, end: u } = r(h), b = l.get(h.id), g = c.totalColumns, v = Oa(p), w = Math.max(Oa(u), v + 1);
    d.push({
      event: h,
      gridRowStart: v,
      gridRowEnd: w,
  ...
  return s`
		<div class="ml-cv__header">
			<div class="ml-cv__header-left">
				${m(e.hasHeaderLeftSlot, () => s`<slot name="header-left"></slot>`, () => bd(e))}
			</div>

			<div class="ml-cv__header-right">
				${m(e.hasHeaderActionsSlot, () => s`<slot name="header-actions"></slot>`, () => fd(e))}
			</div>
		</div>
	`;
}
...
function kd(e) {
  ...
  return s`
    ...
    pe: l,
    colIdx: o
  }))), (a) => a.pe.event.id, (a) => xd(e, a.pe, a.colIdx))}
				</div>
			</div>
		</div>
	`;
...
var La = class {
  ...
  get weekColumns() {
    return pd(this._currentDate, this.weekStartsOn, this.events);
  }
  get timeSlots() {
    return hd();
  }
  get dayColumn() {
    return ud(this._currentDate, this.events);
  }
  get dayEvents() {
  ...
  get miniCalendarDots() {
    return gd(this.miniCalYear, this.miniCalMonth, this.events);
  }
  get dayTabStop() {
...
const Td = {
  ...
  const t = e.format === "regular" ? "ph" : `ph-${e.format}`, r = Td[e.icon] ?? "";
  return e.icon && !r && F(`unknown-icon:${e.icon}`, `<ml-icon icon="${e.icon}"> is not a known Phosphor icon name, so nothing is rendered. Check the name against https://phosphoricons.com (kebab-case, e.g. "caret-double-left").`), s`<i class="${t}" aria-hidden="true">${r}</i>`;
}, Dd = () => x`
	:host {
		display: inline-flex;
		align-items: center;
    ...
    [`ml-tabs--${e.orientation}`]: !0
		...
		>
			<div
				...
				@keydown=${e.handleKeyDown}
			>
				${t ? $(e.tabs, (r) => r.value, (r) => Pd(e, r)) : s`<slot name="tab" @slotchange=${e.handleTabSlotChange}></slot>`}
			</div>
    ...
    "ml-sidebar--collapsed": a
		...
		>
			...
			<div class="ml-sidebar__main">
				${t ? $(e.navigation, (o, l) => `nav-group-${l}`, (o) => Gd(e, o)) : s`<slot @slotchange=${e.handleDefaultSlotChange}></slot>`}
			</div>
    ...
    "ml-steps--compact": r
		...
		>
			<div
				...
				@keydown=${e.handleKeyDown}
			>
				${t ? $(e.steps, (a) => a.value, (a, o) => ec(e, a, o)) : s`<slot name="step" @slotchange=${e.handleStepSlotChange}></slot>`}
			</div>
...
const vc = () => s`<dialog class="ml-dialog">
...
var fc = class {
  ...
  open() {
    this._closeNotified = !1, this._popoversDismissed = !1, this._pendingResult = void 0, this._dialogEl.showModal();
    const e = this._afterOpenedCallbacks;
    this._afterOpenedCallbacks = [], e.forEach((t) => t()), this._openedListeners.forEach((t) => t()), this._dialogEl.dispatchEvent(new CustomEvent("ml:open", {
      bubbles: !0,
      composed: !0
    }));
  }
  ...
  */
  afterOpened(e) {
    return this._afterOpenedCallbacks.push(e), () => {
  ...
  */
  afterClosed(e) {
    return this._afterClosedCallbacks.push(e), () => {
  ...
  onOpened(e) {
    return this._openedListeners.add(e), () => this._openedListeners.delete(e);
  }
  /** Listen to EVERY close of this dialog. Returns an unsubscribe function. */
  onClosed(e) {
    return this._closedListeners.add(e), () => this._closedListeners.delete(e);
  }
  onCancel(e) {
  ...
  notifyClosed() {
    ...
    const t = this._afterClosedCallbacks;
    this._afterClosedCallbacks = [], t.forEach((r) => r(e)), this._closedListeners.forEach((r) => r(e)), this._dialogEl.dispatchEvent(new CustomEvent("ml:close", {
      bubbles: !0,
      composed: !0,
      detail: { result: e }
    }));
...
export {
  ...
  Rl as ComponentBase,
  km as ComponentStateBaseService,
  wa as ContainerComponent,
  ...
  Zn as activityFeedItemStyles,
  Jn as activityFeedItemTemplate,
  Qn as activityFeedStyles,
  Xn as activityFeedTemplate,
  Ni as allTokens,
  jm as announce,
  Dc as appShellStyles,
  Ac as appShellTemplate,
  ...
  Gc as bootstrap,
  Mi as borderTokens,
  Bd as breadcrumbItemStyles,
  jd as breadcrumbItemTemplate,
  Fd as breadcrumbStyles,
  qd as breadcrumbTemplate,
  Li as breakpointTokens,
  Tm as breakpoints,
  Zl as buildPathFromRoute,
  zd as calendarViewStyles,
  Rd as calendarViewTemplate,
  Hl as checkboxAdapter,
  f as classMap,
  ps as clearCrossRootDescription,
  Wm as clickOutside,
  Ai as colorTokens,
  Gm as componentBaseStyles,
  Ui as computePosition,
  L as computed,
  Ln as containerStyles,
  On as containerTemplate,
  _m as createAction,
  om as createAsyncValidator,
  Lm as createBrandTheme,
  cm as createDeactivateGuard,
  Oo as createFocusTrap,
  tm as createFormArray,
  Zc as createFormControl,
  em as createFormGroup,
  dm as createGuard,
  Bm as createLiveRegion,
  wm as createReducer,
  mm as createResolver,
  ym as createState,
  Mo as createTheme,
  De as createToken,
  am as createValidator,
  x as css,
  Or as darkTheme,
  Dm as darkThemeCss,
  jc as dashboardPageStyles,
  Fc as dashboardPageTemplate,
  Qc as defineConfig,
  ...
  Yt as disposeParts,
  wc as drawerStyles,
  _c as drawerTemplate,
  Rc as dropdownGroupStyles,
  Ec as dropdownGroupTemplate,
  $c as dropdownItemStyles,
  kc as dropdownItemTemplate,
  Cc as dropdownSeparatorStyles,
  Sc as dropdownSeparatorTemplate,
  xc as dropdownStyles,
  yc as dropdownTemplate,
  Uc as effect,
  Xc as emit,
  Ml as environment,
  ...
  an as formFieldStyles,
  rn as formFieldTemplate,
  ...
  sm as getRegisteredDirectives,
  Bi as getResolvedTheme,
  ji as getTheme,
  H as getTokenKey,
  lm as hasAttributeDirective,
  ct as hasLightSlot,
  Pc as heroSectionStyles,
  Ic as heroSectionTemplate,
  s as html,
  Kc as inject,
  Yc as injectOptional,
  Om as injectTheme,
  ...
  G as isDevMode,
  Q as isDirective,
  qm as isFocusVisible,
  xr as isSafeUrl,
  vt as isSignal,
  qi as lightTheme,
  Am as lightThemeCss,
  Un as listItemStyles,
  Wn as listItemTemplate,
  Gn as listStyles,
  Yn as listTemplate,
  Em as live,
  Nc as loginPageStyles,
  Lc as loginPageTemplate,
  ...
  xm as onAction,
  Pm as onThemeChange,
  Oc as pageHeaderStyles,
  Mc as pageHeaderTemplate,
  Kd as paginationStyles,
  Hd as paginationTemplate,
  zo as parseUrlParts,
  zi as portalDirective,
  Ti as primitiveColors,
  zn as progressStyles,
  Rn as progressTemplate,
  fm as props,
  Jc as provideConfig,
  nm as provideHttp,
  Sm as provideRX,
  gm as provideRouter,
  Kl as radioAdapter,
  Wc as refreshGlobalStyles,
  q as registerAdapter,
  Pe as registerAttributeDirective,
  Cl as registerDefaultMessages,
  gt as render,
  $ as repeat,
  Cm as repeatRaw,
  Hc as resetDevWarnings,
  Ym as resetStyles,
  Il as resolveEnvironment,
  it as resolveMessage,
  vi as routerLinkDirective,
  Js as selectStyles,
  Ws as selectTemplate,
  K as setActiveComponent,
  ve as setActiveEffect,
  Br as setCrossRootActiveDescendant,
  Xt as setCrossRootDescription,
  Km as setCrossRootLabel,
  $o as setDefaultMessage,
  rl as setDevMode,
  Pi as shadowTokens,
  as as shift,
  Xd as sidebarGroupStyles,
  Ud as sidebarGroupTemplate,
  Jd as sidebarItemStyles,
  Qd as sidebarItemTemplate,
  Wd as sidebarStyles,
  Yd as sidebarTemplate,
  O as signal,
  qc as signupPageStyles,
  Vc as signupPageTemplate,
  tn as sliderStyles,
  en as sliderTemplate,
  Di as spacingTokens,
  gc as stepPanelStyles,
  uc as stepPanelTemplate,
  pc as stepStyles,
  ic as stepTemplate,
  lc as stepsStyles,
  Zd as stepsTemplate,
  ge as styleMap,
  Hm as supportsAriaElementReferences,
  Vd as tabPanelStyles,
  Nd as tabPanelTemplate,
  Ld as tabStyles,
  Od as tabTemplate,
  rd as tableStyles,
  td as tableTemplate,
  ...
  Id as tabsTemplate,
  Bl as textAdapter,
  $n as toastContainerStyles,
  kn as toastContainerTemplate,
  xn as toastStyles,
  yn as toastTemplate,
  Mm as toggleTheme,
  Vi as tokensToCss,
  ks as tooltipDirective,
  Oi as transitionTokens,
  Ii as typographyTokens,
  im as unregisterAttributeDirective,
  Rm as unsafeHTML,
  U as untracked,
