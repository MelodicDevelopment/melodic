...
var ve = class {
  ...
  bind(e, t, r) {
    ...
    const s = O(l), n = new ve(s, l, "class");
    return n.setClass(a), o?.singleton !== void 0 && n.setSingleton(o.singleton), o?.dependencies && n.withDependencies(o.dependencies), o?.args && n.withArgs(o.args), this._bindings.set(s, n), n;
  }
  bindValue(e, t) {
    const r = O(e), l = new ve(r, e, "value");
    return l.setInstance(t), l.setSingleton(!0), this._bindings.set(r, l), l;
  }
  bindFactory(e, t, r) {
    const l = O(e), a = new ve(l, e, "factory");
  ...
  return function(t, r) {
    ...
    t[l] = e, Object.defineProperty(t, r, {
      get() {
        ...
        return this[a] || (this[a] = L.get(e)), this[a];
      },
      enumerable: !0,
      configurable: !0
    });
...
async function bs(e = {}) {
  ...
  if (e.rootComponent && e.target) {
    ...
    l = document.createElement(e.rootComponent), o.appendChild(l), t && console.log("[Melodic] Mounted root component", {
  ...
  const a = {
    ...
    destroy() {
      ...
      l?.parentNode && l.parentNode.removeChild(l), t && console.log("[Melodic] Application destroyed");
    }
  };
...
`)));
  ...
  observe() {
    ...
    const l = e.filter((a) => {
      ...
      return a.startsWith("_") ? !1 : Gr(o) ? (this.subscribeToSignal(o), !1) : typeof o == "function" ? !1 : a !== "elementRef" && a !== "constructor";
    });
    for (const a of l) {
      const o = this.getPropertyDescriptor(this._component, a), s = Object.getOwnPropertyDescriptor(this, a)?.value;
      let n = s === void 0 ? this._component[a] : s;
      typeof n == "boolean" && this._booleanProperties.add(a);
      let c = () => n, m = (u) => {
        n !== u && (this._component.onPropertyChange?.(a, n, u), n = u, this.scheduleRender());
      };
      if (o?.get) {
        const u = o.get;
        c = () => u.call(this._component) ?? n;
      }
      if (o?.set) {
        const u = o.set, h = m;
        m = (p) => {
          u.call(this._component, p), h(p);
        };
      }
...
function _(e) {
  return function(t) {
    if (customElements.get(e.selector) === void 0) {
      const r = class extends Qr {
        constructor() {
          const a = [], o = t.params;
          if (o && Array.isArray(o)) for (const s of o) {
            const n = o[s];
            n && typeof n == "object" && n.__injectionToken ? a.push(L.get(n.__injectionToken)) : a.push(void 0);
          }
...
function kr(e, t) {
  ...
  for (const l of Object.keys(t)) {
    const a = r[l], o = t[l];
    o !== null && typeof o == "object" && !Array.isArray(o) && a !== null && typeof a == "object" && !Array.isArray(a) ? r[l] = kr(a, o) : r[l] = o;
  }
  return r;
}
function fs(e) {
...
var Ae = class $r extends Error {
  ...
  async internalRequest(e) {
    ...
    if (t = await this.executeRequestInterceptors(t), t.cancel?.cancelled) {
      ...
      return t.cancel.cancelledResponse && (l = {
        ...l,
  ...
  buildUrl(e, t) {
    ...
    if (t) {
      const l = Object.entries(t).map(([a, o]) => `${encodeURIComponent(a)}=${encodeURIComponent(String(o))}`).join("&");
      r += `${r.includes("?") ? "&" : "?"}${l}`;
    }
    return r;
  }
  ...
  async parseResponse(e, t) {
    const r = e.headers.get("content-type") || "", l = parseInt(e.headers.get("content-length") || "0", 10);
    if (t && e.body && l > 0) {
      const a = e.body.getReader();
      let o = 0;
      const s = [];
      for (; ; ) {
        const { done: c, value: m } = await a.read();
        if (c) break;
...
const ol = "melodic:route-context";
...
function Rr(e, t, r, l, a) {
  for (const o of e) {
    ...
    if (n !== null) {
      ...
      return Object.assign(a, n), l.push(m), {
        matches: l,
        params: a,
        isExactMatch: !0
      };
    ...
    if (o.children || o.loadChildren) {
      ...
      if (c && c.params !== null) {
        const m = r ? `${r}/${c.matchedPath}` : c.matchedPath, u = {
          route: o,
          params: c.params,
        ...
        return Object.assign(a, c.params), l.push(u), o.children && c.remainingPath ? Rr(o.children, c.remainingPath, m, l, a) : {
          matches: l,
          params: a,
...
var V = class {
  ...
  async navigate(t, r = {}) {
    const { data: l, replace: a = !1, queryParams: o, skipGuards: s = !1, skipResolvers: n = !1, scrollToTop: c = !0 } = r;
    let m = t;
    ...
    const u = this.matchPath(t);
    if (u.redirectTo) return this.navigate(u.redirectTo, {
      ...r,
      replace: !0
    });
    if (!s && u.matches.length > 0) {
      const h = await this.runGuards(u);
      if (h !== !0)
        return typeof h == "string" ? this.navigate(h, {
          ...r,
          skipGuards: !0
    ...
    if (!n && u.matches.length > 0) {
      const h = await this.runResolversInternal(u);
      if (!h.success) return {
        success: !1,
  ...
  async runResolversInternal(t) {
    ...
    for (let r = 0; r < t.matches.length; r++) {
      ...
      for (const [n, c] of Object.entries(a)) try {
...
var W = /* @__PURE__ */ new Map(), Tr = (e) => {
  ...
  for (const [r, l] of W) if (r.toLowerCase() === t) return l;
};
function he(e, t) {
  W.set(e, t);
}
...
var ul = class X {
  ...
  */
  ...
  renderInto(t) {
    ...
    if (!t.__parts) {
      const s = l.content.cloneNode(!0), n = this.prepareParts(s, this.getTemplate(r));
  ...
  getTemplate(t) {
    ...
    let s = null, n = null;
    for (let w = 1; w < this.strings.length; w++) {
      const S = this.strings[w], T = w - 1, k = /([@.:?]?[\w:-]+)\s*=\s*["']?$/.exec(a), D = /([@.:?]?[\w:-]+)\s*=\s*(["'])([^"']*)$/.exec(a);
      let R = "___";
      if (s) a += ie(T);
      else {
        const A = D?.[1]?.charAt(0), E = A !== void 0 && Object.keys(o).includes(A);
        if (D && !E)
          a += ie(T), s = D[1], n = D[2];
        else {
          if (k) {
            ...
            Object.keys(o).includes(q) && (R = q);
          }
          if (R === "__" && k) {
            a += ie(T), s = k[1];
            const q = /(["'])$/.exec(k[0]);
            n = q ? q[1] : null;
          } else a = o[R](T, a, k ? k[1] : void 0, k);
        }
      }
      a += S, s && (n ? S.includes(n) && (s = null, n = null) : /[\s>]/.test(S) && (s = null, n = null));
    }
    const c = document.createElement("template");
    c.innerHTML = a;
    const m = [];
    let u = 0;
    const h = [], p = /* @__PURE__ */ new Map(), b = /* @__PURE__ */ new Map(), x = /* @__PURE__ */ new Map(), f = /* @__PURE__ */ new Map();
    for (const w of l) switch (w.type) {
      case "event":
        p.set(w.index, w);
        break;
      case "property":
    ...
    const C = (w, S) => {
      if (w.nodeType === Node.COMMENT_NODE) {
        if (w.data === pe) {
          const k = h[u++];
          k && m.push({
            path: [...S],
        ...
        const k = w;
        for (let D = k.attributes.length - 1; D >= 0; D--) {
          const R = k.attributes[D];
          if (R.name.startsWith("__event-")) {
            const A = parseInt(R.name.match(/__event-(\d+)__/)?.[1] || "0"), E = p.get(A);
            E && m.push({
              path: [...S],
              type: "event",
              index: E.index,
            ...
            const A = parseInt(R.name.match(/__prop-(\d+)__/)?.[1] || "0"), E = b.get(A);
            E && m.push({
              path: [...S],
              type: "property",
              index: E.index,
            ...
            const A = parseInt(R.name.match(/__action-(\d+)__/)?.[1] || "0"), E = x.get(A);
            E && m.push({
              path: [...S],
              type: "action",
              index: E.index,
            ...
            const A = parseInt(R.name.match(/__bool-(\d+)__/)?.[1] || "0"), E = f.get(A);
            E && m.push({
              path: [...S],
          ...
          } else if (R.name.startsWith(":")) m.push({
            path: [...S],
            type: "action",
            index: -1,
            name: R.name.slice(1),
            ...
            if (A) {
              ...
              m.push({
                ...
                index: A.indices[0],
                name: R.name,
                attributeStrings: E ? A.strings : void 0,
                attributeIndices: E ? A.indices : void 0
              });
            }
          }
        }
  ...
  getAttributePreProcessor(t) {
    return {
      ...
      "?": (r, l, a, o) => (t.push({
        ...
        index: r,
        name: a?.slice(1)
      }), l.slice(0, -(o?.[0].length ?? 0)) + `__bool-${r}__=""`),
      __: (r, l, a) => l + ie(r),
      ___: (r, l) => (t.push({
        type: "node",
        index: r
  ...
  prepareParts(t, r) {
    ...
    for (const o of a) {
      ...
      if (o.type === "node") {
        ...
        s.parentNode.replaceChild(n, s), l.push({
          type: "node",
          index: o.index,
          node: n
        });
        ...
        const n = s;
        n.removeAttribute(`__event-${o.index}__`), l.push({
          type: "event",
          index: o.index,
          name: o.name,
          node: n
        ...
        const n = s;
        n.removeAttribute(`__prop-${o.index}__`), l.push({
          type: "property",
          index: o.index,
          name: o.name,
          node: n
        ...
        const n = s;
        o.index >= 0 ? n.removeAttribute(`__action-${o.index}__`) : n.removeAttribute(`:${o.name}`), l.push({
          type: "action",
          index: o.index,
          name: o.name,
          node: n,
        ...
        const n = s;
        n.removeAttribute(`__bool-${o.index}__`), l.push({
          type: "boolean-attribute",
          index: o.index,
          name: o.name,
          node: n
        ...
        const n = s;
        n.removeAttribute(o.name), l.push({
          type: "attribute",
          index: o.index,
          name: o.name,
          node: n,
  ...
  */
  renderArray(t, r) {
    ...
    if (a) {
      ...
      for (const u of a) {
        const h = s.items.get(u.key);
        if (h)
          this.updateArrayItem(h, u.value, l, t.endMarker), n.set(u.key, h);
        else {
          const p = this.createArrayItem(u.value, l, t.endMarker);
          n.set(u.key, {
            key: u.key,
            value: u.value,
      ...
      for (const [u, h] of s.items.entries()) if (!n.has(u)) for (const p of h.nodes) p.parentNode?.removeChild(p);
      ...
      for (const u of c) {
        ...
        for (const p of h.nodes) {
          ...
          l.insertBefore(p, m ?? t.endMarker);
        }
      }
      t.arrayState = {
        items: n,
        keys: c
      }, t.renderedNodes = c.flatMap((u) => n.get(u).nodes);
      return;
    }
      ...
      if (!(!a && !oe(l) && r.type !== "action" && r.previousValue === l)) {
        switch (r.type) {
          ...
          case "boolean-attribute":
            if (r.node && r.name) {
              const o = r.node;
              l ? o.setAttribute(r.name, "") : o.removeAttribute(r.name);
            }
            break;
          case "property":
...
var We, Ge = "melodic:outlet-register", we = class {
  ...
  onInit() {
    ...
    window.addEventListener("NavigationEvent", t), this._navigationCleanup = () => window.removeEventListener("NavigationEvent", t), this.elementRef.addEventListener(Ge, ((r) => {
  ...
  */
  async matchAndRender(t) {
    ...
    if (l.matches.length > 0) {
      const a = await this._router.runGuards(l);
      if (a !== !0) {
        typeof a == "string" && this._router.navigate(a, {
          replace: !0,
          skipGuards: !0
        });
        return;
...
function hl(e, t, r) {
  ...
  const { href: a, activeClass: o = "active", exactMatch: s = !1, replace: n = !1, data: c = null, queryParams: m = {} } = l, u = L.get(V), h = () => {
    let f = a;
  ...
  const p = () => {
    const f = window.location.pathname, C = a.startsWith("/") ? a : `/${a}`, w = f.replace(/\/$/, "") || "/", S = C.replace(/\/$/, "") || "/";
    let T;
    s ? T = w === S : T = w === S || w.startsWith(S + "/"), T ? (e.classList.add(o), e.tagName.toLowerCase() === "a" && e.setAttribute("aria-current", "page")) : (e.classList.remove(o), e.removeAttribute("aria-current")), e.setAttribute("router-link", "");
  }, b = (f) => {
    const C = f;
  ...
  return e.addEventListener("click", b), window.addEventListener("NavigationEvent", x), p(), (() => {
...
var pl = class {
  ...
  executeEffects(e) {
    this.getEffects().filter((t) => t.actions.some((r) => r().type === e.type)).forEach((t) => {
      t.effect(e).then((r) => {
        r !== void 0 && (Array.isArray(r) ? r : [r]).forEach((l) => this.dispatch(l));
      });
    });
  }
}, F = class {
  ...
  getEffectsForActionWithoutKey(t) {
    ...
    for (const l of r) {
      ...
      if (a) {
        const o = L.get(a).getEffects().filter((s) => s.actions.some((n) => n().type === t.type));
  ...
  getEffectsForActionWithKey(t, r) {
    ...
    return l ? L.get(l).getEffects().filter((a) => a.actions.some((o) => o().type === r.type)) : [];
  }
  getCurrentState() {
...
var Xe = /* @__PURE__ */ new WeakMap(), vl = class Mr {
  constructor(t) {
  ...
  */
  analyzeAndCompile(t) {
    ...
    const c = s.slice(0, -n.length), m = [], u = /([\w-]+)\s*=\s*(?:"([^"]*)"|'([^']*)'|\$\{(\d+)\})/g;
    let h;
    for (; (h = u.exec(o)) !== null; ) {
      const w = h[1], S = h[2] ?? h[3], T = h[4];
      if (T !== void 0) m.push({
        name: w,
        valueIndex: parseInt(T, 10)
      });
      else if (S !== void 0) {
        const k = S.match(/\$\{(\d+)\}/);
        k ? m.push({
    ...
    const p = [], b = c, x = /\$\{(\d+)\}/g;
    let f = 0, C;
    for (x.lastIndex = 0; (C = x.exec(b)) !== null; )
      C.index > f && p.push({ static: b.slice(f, C.index) }), p.push({ valueIndex: parseInt(C[1], 10) }), f = C.index + C[0].length;
    f < b.length && p.push({ static: b.slice(f) }), this._factory = (w) => {
      const S = document.createElement(a);
      for (const k of m) if (k.valueIndex !== null) {
        const D = w[k.valueIndex];
        D != null && D !== !1 && S.setAttribute(k.name, D === !0 ? "" : String(D));
      } else k.staticValue !== void 0 && S.setAttribute(k.name, k.staticValue);
      let T = "";
      for (const k of p) "static" in k ? T += k.static : T += w[k.valueIndex] ?? "";
...
function $(e, t, r) {
  return U((l, a) => {
    if (!a) {
      ...
      o.replaceChild(s, l), o.insertBefore(n, s.nextSibling);
      const c = {
...
function Je(e, t, r, l) {
  ...
  if (a.length === e.length) {
    ...
    for (let b = 0; b < e.length; b++) {
      const x = t(e[b], b);
      if (b >= a.length || a[b].key !== x) {
        p = !1;
        break;
      }
    }
    if (p) {
      for (let b = 0; b < e.length; b++) r(e[b], b).renderInto(a[b].container);
      return;
    }
  }
  if (l.useCompiledPath === void 0 && e.length > 0) {
    const p = r(e[0], 0), b = vl.compile(p.strings);
  ...
  for (let p = 0; p < e.length; p++) {
    ...
    if (n.has(x)) {
      const f = n.get(x);
      n.delete(x), r(b, p).renderInto(f.container), s.push({
        item: f,
        oldIndex: c.get(x) ?? -1,
        isNew: !1
      });
    } else {
      const f = gl(b, p, x, r, l);
      s.push({
        item: f,
        oldIndex: -1,
        isNew: !0
  ...
  for (const p of n.values()) _l(p);
  if (s.length === 0) {
    l.keyToIndex = o, l.items = [];
    return;
  }
  const m = yl(s), u = l.startMarker.parentElement;
  let h = l.endMarker;
  for (let p = s.length - 1; p >= 0; p--) {
    const b = s[p];
    b.isNew ? bl(b.item, u, h) : m.has(p) || fl(b.item, h), h = b.item.start;
  }
  l.keyToIndex = o, l.items = s.map((p) => p.item);
}
function gl(e, t, r, l, a) {
  const o = l(e, t);
  let s, n;
...
function yl(e) {
  ...
  const l = xl(t), a = /* @__PURE__ */ new Set();
  for (const o of l) {
    const s = r[o];
    s !== void 0 && a.add(s);
  }
...
function wl(e, t, r, l) {
  ...
  if (a.size === e.length) {
    ...
    if (u) {
      h = 0;
      for (const [p, { element: b }] of a) {
        const x = e[h], f = r(x, h);
        b !== f ? (b.replaceWith(f), o.set(p, {
          key: p,
          element: f
        })) : o.set(p, {
          key: p,
  ...
  for (let u = 0; u < e.length; u++) {
    ...
    if (b) {
      ...
      b.element !== x ? (o.set(p, {
        key: p,
        element: x
      }), c.appendChild(x)) : (o.set(p, b), c.appendChild(b.element));
    } else {
      const x = r(h, u);
      o.set(p, {
        key: p,
  ...
  for (const [u, { element: h }] of a) m.has(u) || h.remove();
  s.insertBefore(c, n), l.keyToItem = o;
}
function d(e, t, r) {
  return U((l, a) => {
    if (!a) {
    ...
    if (e && !a.condition)
      Qe(a), a.template = t(), se(a, !0);
    else if (!e && a.condition)
      Qe(a), r && (a.falseTemplate = r(), se(a, !1));
    else if (e && a.condition) {
      const o = t();
...
function Fs(e) {
  return U((t, r) => {
    if (!r) {
      ...
      if (!l) throw new Error("unsafeHTML() directive: container must be attached to a parent node");
      const a = document.createComment("unsafeHTML-start"), o = document.createComment("unsafeHTML-end");
      l.replaceChild(a, t), l.insertBefore(o, a.nextSibling);
      const s = {
        html: "",
        startMarker: a,
        endMarker: o,
...
function Ze(e, t) {
  ...
  t.nodes = Array.from(a.childNodes);
...
var Sl = class {
  ...
  async runValidation() {
    ...
    if (this._asyncValidators.length > 0) {
      ...
      this._pending.set(!0);
      try {
        const l = await Promise.all(this._asyncValidators.map((a) => a(e)));
        if (r !== this._asyncValidationId) return;
        for (const a of l) a !== null && (t = {
          ...t ?? {},
          ...a
        });
      } finally {
...
var Rl = class {
  ...
  async runGroupValidation() {
    ...
    if (this._asyncValidators.length > 0 && t === null) {
      const r = await Promise.all(this._asyncValidators.map((l) => l(e)));
      for (const l of r) l !== null && (t = {
        ...t ?? {},
        ...l
      });
    }
...
const Ks = {
  ...
  composeAsync: (...e) => async (t) => {
    const r = await Promise.all(e.map((a) => a(t)));
    let l = null;
    for (const a of r) a !== null && (l = {
      ...l ?? {},
      ...a
    });
    return l;
...
function Al(e, t, r) {
  ...
  const l = t, a = zl(e), o = [], s = (f) => {
    ...
    e.classList.toggle("mf-valid", l.valid()), e.classList.toggle("mf-invalid", l.invalid()), e.classList.toggle("mf-dirty", l.dirty()), e.classList.toggle("mf-pristine", l.pristine()), e.classList.toggle("mf-touched", l.touched()), e.classList.toggle("mf-pending", l.pending()), e.classList.toggle("mf-disabled", l.disabled());
  }, m = (f) => {
    const C = f.target;
    a === "checkbox" ? l.setValue(C.checked) : a === "radio" ? C.checked && l.setValue(C.value) : l.setValue(C.value);
  }, u = () => {
    l.markAsTouched();
  };
  s(l.value());
  const h = l.value.subscribe((f) => {
    s(f);
  });
  o.push(h), n(l.disabled());
  const p = l.disabled.subscribe((f) => {
    n(f);
  });
  o.push(p);
  const b = l.state.subscribe(() => {
    c();
  });
  o.push(b), c();
  const x = l.updateOn === "blur" ? "change" : "input";
  return e.addEventListener(x, m), e.addEventListener("blur", u), e.setAttribute("data-form-control", ""), () => {
...
const ql = {
  ...
  "--ml-color-border-strong": "var(--ml-gray-300)",
  "--ml-color-border-muted": "var(--ml-gray-100)"
}, Ys = `:root, [data-theme="light"] {
	${Object.entries(ql).map(([e, t]) => `${e}: ${t};`).join(`
	`)}
...
function te(e, t, r = {}) {
  const { placement: l = "bottom", middleware: a = [] } = r, o = e.getBoundingClientRect(), s = t.getBoundingClientRect(), { x: n, y: c } = Kl(o, s, l);
  let m = {
    x: n,
    y: c,
    placement: l,
...
function Me(e, t, r, l = {}) {
  ...
  if (n) {
    let m;
    const u = () => {
      r(), m = requestAnimationFrame(u);
    };
    m = requestAnimationFrame(u), c.push(() => cancelAnimationFrame(m));
  }
  return () => {
    c.forEach((m) => m());
  };
...
function re(e = 0) {
  ...
  return {
    name: "offset",
    fn(l) {
      const { x: a, y: o, placement: s } = l, n = me(s);
      let c = a, m = o;
      switch (n) {
        case "top":
          m -= t, c += r;
...
function le(e = {}) {
  ...
  return {
    ...
    fn(r) {
      ...
      const c = Wl(o), m = e.fallbackPlacements ?? [c];
      for (const u of m) {
        const h = Ul(s.reference, s.floating, u);
...
function ae(e = {}) {
  ...
  return {
    name: "shift",
    fn(a) {
      const { x: o, y: s, rects: n } = a, c = {
        width: window.innerWidth,
        height: window.innerHeight
      };
      let m = o, u = s;
      if (l || r) {
        const h = t, p = c.width - n.floating.width - t;
        m = Math.max(h, Math.min(m, p));
      }
      if (l || r) {
        const h = t, p = c.height - n.floating.height - t;
        u = Math.max(h, Math.min(u, p));
      }
      return {
        x: m,
        y: u
...
function Nr(e) {
  ...
  return {
    name: "arrow",
    fn(l) {
      const { rects: a, placement: o } = l, s = me(o), n = t.getBoundingClientRect(), c = n.width, m = n.height;
      let u, h;
      if (s === "top" || s === "bottom") {
        u = a.reference.left + a.reference.width / 2 - l.x - c / 2;
        const p = r, b = a.floating.width - c - r;
        u = Math.max(p, Math.min(u, b));
      } else {
        h = a.reference.top + a.reference.height / 2 - l.y - m / 2;
        const p = r, b = a.floating.height - m - r;
...
const Zl = () => "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replaceAll(/[xy]/g, function(e) {
...
function ta(e, t) {
  if (!t) return;
  const { content: r, placement: l } = ea(t);
  if (!r) return;
    ...
    "ml-select--multiple": e.multiple
		...
		>
			...
			<div class="ml-select__control">
				...
				>
					${e.filteredOptions.length ? $(e.filteredOptions, (t) => `${t.value}-${e.multiple ? e.values.includes(t.value) : e.value === t.value}`, (t, r) => Ta(e, t, r)) : i`<div class="ml-select__empty">No results found</div>`}
				</div>
			</div>
  ...
  return i`
    ...
    "ml-select__option--disabled": !!t.disabled
		...
		>
			...
			${d(l, () => i`<ml-icon icon="check" size="sm" format="regular" class="ml-select__option-check"></ml-icon>`)}
		</div>
	`;
}
const za = () => y`
		...
		>
			...
			<div class="ml-slider__track-wrapper">
				<div class="ml-slider__track">
					<div class="ml-slider__fill" style=${G({ width: e.fillWidth })}></div>
				</div>
				<input
...
var yt = class {
  ...
  get monthLabel() {
    return `${Na[this.viewMonth]} ${this.viewYear}`;
  }
  get weekdays() {
    return La;
  }
  get days() {
    ...
    const u = r === 11 ? 0 : r + 1, h = r === 11 ? t + 1 : t, p = n.length % 7;
    if (p > 0) {
      const b = 7 - p;
      for (let x = 1; x <= b; x++) {
        const f = de(h, u, x);
    ...
    "ml-progress--label-right": r
			...
			<div class="ml-progress__bar-row">
				<div class="ml-progress__track-wrapper">
					${d(a, () => i`
						<div class="ml-progress__floating ml-progress__floating--top" style=${G({ left: `${e.percentage}%` })}>
					...
					<div class="ml-progress__track" role="progressbar" aria-valuenow=${e.value} aria-valuemin="0" aria-valuemax=${e.max} aria-label=${e.label || "Progress"}>
						<div class="ml-progress__fill" style=${G({ width: `${e.percentage}%` })}></div>
					</div>

					${d(o, () => i`
						<div class="ml-progress__floating ml-progress__floating--bottom" style=${G({ left: `${e.percentage}%` })}>
			...
			${d(l, () => i`<span class="ml-progress__value ml-progress__value--bottom">${e.displayValue}</span>`)}
		</div>
	`;
}
function Xa(e) {
...
function Qa(e) {
  return e.shape === "circle" ? Xa(e) : e.shape === "half-circle" ? Ja(e) : Ya(e);
}
const Za = () => y`
	:host {
		display: block;
...
function Ht(e, t, r = 0) {
  const l = new Date(e, t, 1).getDay(), a = new Date(e, t + 1, 0).getDate(), o = new Date(e, t, 0).getDate(), s = /* @__PURE__ */ new Date(), n = N(s.getFullYear(), s.getMonth(), s.getDate()), c = [], m = (l - r + 7) % 7, u = t === 0 ? 11 : t - 1, h = t === 0 ? e - 1 : e;
  for (let f = m - 1; f >= 0; f--) {
    const C = o - f, w = N(h, u, C);
    c.push({
      date: C,
      month: u,
      year: h,
  ...
  const p = Math.ceil(c.length / 7) * 7, b = t === 11 ? 0 : t + 1, x = t === 11 ? e + 1 : e;
  for (let f = 1; c.length < p; f++) {
    const C = N(x, b, f);
    c.push({
      date: f,
      month: b,
...
function Hr(e) {
  ...
  for (const n of t) {
    ...
    for (let h = 0; h < r.length; h++) if (r[h][r[h].length - 1].end <= c) {
      r[h].push({ end: m }), l.set(n.id, h), u = !0;
      break;
    }
    u || (r.push([{ end: m }]), l.set(n.id, r.length - 1));
  }
  ...
  for (const n of t) {
    ...
    const c = [n];
    o.add(n.id);
    let m = M(n.end), u = l.get(n.id) + 1;
    for (const h of t)
      o.has(h.id) || M(h.start) < m && (c.push(h), o.add(h.id), m = Math.max(m, M(h.end)), u = Math.max(u, l.get(h.id) + 1));
    a.push({
      events: c,
      totalColumns: u
    });
  ...
  const s = [];
  for (const n of a) for (const c of n.events) {
    const m = M(c.start), u = M(c.end), h = l.get(c.id), p = n.totalColumns;
    s.push({
      event: c,
      gridRowStart: Wt(m),
      gridRowEnd: Wt(u),
...
function Fo(e, t, r) {
  ...
  for (let o = 1; o <= a; o++) {
    const s = N(e, t, o);
    r.some((n) => n.start.split("T")[0] === s) && l.add(s);
  }
  return l;
}
var qo = {
  ...
  return i`
		<div class="ml-cv__header">
			<div class="ml-cv__header-left">
				${d(e.hasHeaderLeftSlot, () => i`<slot name="header-left"></slot>`, () => Bo(e))}
			</div>

			<div class="ml-cv__header-right">
				${d(e.hasHeaderActionsSlot, () => i`<slot name="header-actions"></slot>`, () => Ho(e))}
			</div>
		</div>
	`;
}
...
function Yo(e) {
  ...
  return i`
    ...
    pe: o,
    colIdx: a
  }))), (l) => l.pe.event.id, (l) => Uo(e, l.pe, l.colIdx))}
				</div>
			</div>
		</div>
	`;
...
function Jo(e) {
  ...
  return i`
    ...
    "ml-cv__mini-cal-day--selected": o.iso === a
					...
					>
						${o.date}
						${d(l.has(o.iso), () => i`<span class="ml-cv__mini-cal-dot"></span>`)}
					</button>
				`)}
			</div>
		</div>
    ...
    "ml-cv__time-header-day--today": t.isToday
					...
					<div class="ml-cv__time-scroll">
						<div class="ml-cv__time-body ml-cv__time-body--day" style="--cv-rows: ${48};">
							...
							<!-- Events -->
							${$(t.events, (l) => l.event.id, (l) => Xo(e, l))}
						</div>
					</div>
				</div>
			</div>
...
var Gt = class {
  constructor() {
    this.view = "month", this.date = "", this.weekStartsOn = 0, this.maxVisibleEvents = 3, this.addButtonText = "Add event", this.hideNav = !1, this.hideTodayButton = !1, this.hideViewSelector = !1, this.hideAddButton = !1, this.events = [], this.isViewDropdownOpen = !1, this._miniCalYear = 0, this._miniCalMonth = 0, this._hasScrolledToTime = !1, this._boundCloseDropdown = null, this.navigatePrev = () => {
      ...
      let r;
      this.view === "month" ? r = qt(t, -1) : this.view === "week" ? r = K(t, -7) : r = K(t, -1), this.setDate(r);
    }, this.navigateNext = () => {
      const t = this._currentDate;
      let r;
      this.view === "month" ? r = qt(t, 1) : this.view === "week" ? r = K(t, 7) : r = K(t, 1), this.setDate(r);
  ...
  get weekNumber() {
    return Io(this._currentDate);
  }
  get headerSubtitle() {
    if (this.view === "month") return `Week ${this.weekNumber}`;
    if (this.view === "week") {
      const t = Br(this._currentDate, this.weekStartsOn);
      return Mo(t, K(t, 6));
    }
  ...
  get monthGrid() {
    ...
    for (const l of r) l.events = ue(this.events, l.iso);
    return r;
  }
  get weekColumns() {
...
const ri = (e) => i`<i class="${e.format === "regular" ? "ph" : `ph-${e.format}`}">${e.format === "regular" ? e.icon : `${e.icon}-${e.format}`}</i>`, li = () => y`
	:host {
		display: inline-flex;
		align-items: center;
		justify-content: center;
    ...
    [`ml-tabs--${e.orientation}`]: !0
		...
		>
			<div
				...
				@keydown=${e.handleKeyDown}
			>
				${t ? $(e.tabs, (r) => `${r.value}-${e.value === r.value}`, (r) => oi(e, r)) : i`<slot name="tab" @slotchange=${e.handleTabSlotChange}></slot>`}
			</div>
...
var er = class {
  ...
  get pages() {
    const t = Math.max(1, Number(this.totalPages)), r = Math.min(Math.max(1, Number(this.page)), t), l = Math.max(0, Number(this.siblings)), a = (m, u) => Array.from({ length: u - m + 1 }, (h, p) => ({
      type: "page",
      value: m + p
    })), o = Math.max(r - l, 1), s = Math.min(r + l, t), n = o > 2, c = s < t - 1;
    return !n && !c ? a(1, t) : !n && c ? [
      ...a(1, Math.max(s, 3 + l)),
      { type: "ellipsis" },
      {
        type: "page",
    ...
    "ml-sidebar--collapsed": l
		...
		>
			...
			<div class="ml-sidebar__main">
				${t ? $(e.navigation, (a, o) => `nav-group-${o}`, (a) => fi(e, a)) : i`<slot @slotchange=${e.handleDefaultSlotChange}></slot>`}
			</div>
    ...
    "ml-steps--compact": r
		...
		>
			<div
				...
				@keydown=${e.handleKeyDown}
			>
				${t ? $(e.steps, (l) => `${l.value}-${e.active === l.value}`, (l, a) => Ci(e, l, a)) : i`<slot name="step" @slotchange=${e.handleStepSlotChange}></slot>`}
			</div>
    ...
    case "numbered":
      return i`
				<div class="ml-step__indicator-inner ml-step__indicator-inner--numbered">
					${d(l === "completed", () => i`<ml-icon icon="check" size="sm"></ml-icon>`)}
					${d(l !== "completed", () => i`<span>${r + 1}</span>`)}
				</div>
			`;
    case "circles":
      return i`
				<div class="ml-step__indicator-inner ml-step__indicator-inner--circles">
					${d(l === "completed", () => i`<ml-icon icon="check" size="sm"></ml-icon>`)}
					${d(l !== "completed", () => i`<div class="ml-step__indicator-dot"></div>`)}
				</div>
			`;
    case "icons":
      return i`
...
var cr = class {
  ...
  updatePosition(t, r) {
    ...
    r.style.left = `${o}px`, r.style.top = `${s}px`, r.dataset.placement = n, l && c.arrow && this.positionArrow(l, n, c.arrow);
  }
  positionArrow(t, r, l) {
    const a = r.split("-")[0];
...
var pr = class {
  ...
  updatePosition() {
    ...
    if (r.style.left = `${a}px`, r.style.top = `${o}px`, r.setAttribute("data-placement", s), l) {
      const n = s.split("-")[0];
      l.style.left = "", l.style.right = "", l.style.top = "", l.style.bottom = "", n === "top" || n === "bottom" ? (l.style.left = "50%", l.style.marginLeft = "-4px") : (l.style.top = "50%", l.style.marginTop = "-4px");
    }
  }
};
pr = g([_({
...
export {
  ...
  At as AvatarComponent,
  Dt as BadgeComponent,
  ...
  yt as CalendarComponent,
  Gt as CalendarViewComponent,
  Et as CardComponent,
  ct as CheckboxComponent,
  Qr as ComponentBase,
  Ns as ComponentStateBaseService,
  ...
  bs as bootstrap,
  Nl as borderTokens,
  pi as breadcrumbItemStyles,
  hi as breadcrumbItemTemplate,
  ui as breadcrumbStyles,
  mi as breadcrumbTemplate,
  Vl as breakpointTokens,
  Us as breakpoints,
  sl as buildPathFromRoute,
  ti as calendarViewStyles,
  ei as calendarViewTemplate,
  v as classMap,
  pn as clickOutside,
  Il as colorTokens,
  ...
  z as computed,
  so as containerStyles,
  io as containerTemplate,
  Is as createAction,
  Gs as createAsyncValidator,
  rn as createBrandTheme,
  ws as createDeactivateGuard,
  Jl as createFocusTrap,
  Bs as createFormControl,
  Hs as createFormGroup,
  xs as createGuard,
  cn as createLiveRegion,
  Ms as createReducer,
  ks as createResolver,
  Ps as createState,
  Or as createTheme,
  ee as createToken,
  Ws as createValidator,
  y as css,
  et as darkTheme,
  Xs as darkThemeCss,
  vs as dashboardPageStyles,
  ps as dashboardPageTemplate,
  fs as defineConfig,
  U as directive,
  Ki as drawerStyles,
  Hi as drawerTemplate,
  Zi as dropdownGroupStyles,
  Qi as dropdownGroupTemplate,
  Yi as dropdownItemStyles,
  Ui as dropdownItemTemplate,
  Ji as dropdownSeparatorStyles,
  Xi as dropdownSeparatorTemplate,
  Gi as dropdownStyles,
  Wi as dropdownTemplate,
  el as environment,
  il as findRouteByName,
  le as flip,
  ln as focusFirst,
  an as focusLast,
  on as focusTrap,
  nn as focusVisible,
  Al as formControlDirective,
  Ma as formFieldStyles,
  ...
  Qs as getTheme,
  O as getTokenKey,
  Es as hasAttributeDirective,
  ss as heroSectionStyles,
  is as heroSectionTemplate,
  i as html,
  tn as injectTheme,
  oe as isDirective,
  sn as isFocusVisible,
  Gr as isSignal,
  ql as lightTheme,
  Ys as lightThemeCss,
  yo as listItemStyles,
  _o as listItemTemplate,
  fo as listStyles,
  bo as listTemplate,
  ...
  ns as pageHeaderTemplate,
  gi as paginationStyles,
  vi as paginationTemplate,
  Cl as portalDirective,
  Dl as primitiveColors,
  Za as progressStyles,
  Qa as progressTemplate,
  Ds as props,
  _s as provideConfig,
  ys as provideHttp,
  Vs as provideRX,
  ...
  ii as tabsStyles,
  ai as tabsTemplate,
  Ua as toastContainerStyles,
  Ga as toastContainerTemplate,
  Wa as toastStyles,
  Ka as toastTemplate,
  en as toggleTheme,
  Fl as tokensToCss,
