  ...
  return function(t, r) {
    ...
    t[a] = e, Object.defineProperty(t, r, {
      get() {
        ...
        return this[l] || (this[l] = N.get(e)), this[l];
      },
      enumerable: !0,
      configurable: !0
    });
...
async function ws(e = {}) {
  ...
  if (e.onBefore && (t && console.log("[Melodic] Running onBefore hook..."), await e.onBefore()), e.providers) {
    for (const o of e.providers) o(N);
  ...
  return e.onReady && e.onReady(), t && console.log("[Melodic] Bootstrap complete"), N.bindValue("IMelodicApp", l), l;
}
function Ne(e, t) {
  e.renderInto(t);
}
const xr = Symbol("melodic.signal"), Ur = (e) => typeof e == "function" && xr in e;
var Ve = "melodic-styles", Yr = `style[${Ve}], link[rel="stylesheet"][${Ve}]`, Te = [], ge = null;
const Xr = (e) => {
  if (Qr()) {
    Fe(e);
    return;
  }
  ge || (ge = Jr()), ge.then(() => Fe(e));
};
var Jr = async () => {
...
`)));
...
}, Qr = () => Te.length > 0, Zr = class extends HTMLElement {
  constructor(e, t) {
  ...
  observe() {
    ...
    const a = e.filter((l) => {
      ...
      return l.startsWith("_") ? !1 : Ur(o) ? (this.subscribeToSignal(o), !1) : typeof o == "function" ? !1 : l !== "elementRef" && l !== "constructor";
    });
    for (const l of a) {
      ...
      const r = class extends Zr {
        constructor() {
          ...
          if (o && Array.isArray(o)) for (const s of o) {
            const n = o[s];
            n && typeof n == "object" && n.__injectionToken ? l.push(N.get(n.__injectionToken)) : l.push(void 0);
          }
...
function kr(e, t) {
  ...
  for (const a of Object.keys(t)) {
    const l = r[a], o = t[a];
    o !== null && typeof o == "object" && !Array.isArray(o) && l !== null && typeof l == "object" && !Array.isArray(l) ? r[a] = kr(l, o) : r[a] = o;
  }
  return r;
}
function ys(e) {
...
var De = class $r extends Error {
  constructor(t, r, a) {
    super(t), this.config = r, this.code = a, this.name = "HttpBaseError", Object.setPrototypeOf(this, $r.prototype);
  }
}, qe = class Cr extends De {
  constructor(t, r, a) {
    super(t, a, `HTTP_${r.status}`), this.response = r, this.name = "HttpError", Object.setPrototypeOf(this, Cr.prototype);
  }
}, aa = class zr extends De {
  constructor(t, r) {
    super(t, r, "NETWORK_ERROR"), this.name = "NetworkError", Object.setPrototypeOf(this, zr.prototype);
  }
}, la = class Sr extends De {
  constructor(t, r) {
    super(t, r, "ABORTED"), this.name = "AbortError", Object.setPrototypeOf(this, Sr.prototype);
  }
}, oa = class {
  constructor() {
  ...
  async executeRequest(e) {
    ...
    const t = fetch(e.url, {
      ...
      if (!r.ok) throw new qe(`HTTP Error: ${r.status} ${r.statusText}`, a, e);
      return a;
    }).catch((r) => {
      throw r instanceof qe ? r : r instanceof Error && r.name === "AbortError" ? new la("Request aborted", e) : new aa((r instanceof Error ? r.message : "Network error") || "Network error", e);
    });
  ...
  for (const o of e) {
    ...
    if (o.children || o.loadChildren) {
      ...
      if (c && c.params !== null) {
        ...
        return Object.assign(l, c.params), a.push(p), o.children && c.remainingPath ? Er(o.children, c.remainingPath, m, a, l) : {
          matches: a,
          params: l,
...
function we(e, t, r = "") {
  const a = Er(e, t.startsWith("/") ? t.slice(1) : t, r, [], {});
  return {
    matches: a.matches,
    params: a.params,
...
history.pushState = (e, t, r) => {
  ...
  const a = new CustomEvent("NavigationEvent", { detail: Ae("push", e, t, r) });
  window.dispatchEvent(a);
};
var ca = history.replaceState;
...
var V = class {
  ...
  async handlePopState(t) {
    ...
    const o = new CustomEvent("NavigationEvent", { detail: Ae("push", t.state, "", window.location.pathname) });
...
V = g([ee(), F("design:paramtypes", [])], V);
var K = /* @__PURE__ */ new Map(), Rr = (e) => {
  if (K.has(e)) return K.get(e);
  const t = e.toLowerCase();
  for (const [r, a] of K) if (r.toLowerCase() === t) return a;
};
function he(e, t) {
  K.set(e, t);
}
...
var ue = `m${Math.random().toString(36).slice(2, 9)}`, pa = `<!--${ue}-->`, Ie = `__${ue}_`, He = new RegExp(`${Ie}(\\d+)__`, "g"), ie = (e) => `${Ie}${e}__`, X = /* @__PURE__ */ new Map(), Ge = /* @__PURE__ */ new WeakMap();
function be(e) {
  let t = Ge.get(e);
  return t === void 0 && (t = e.join(ue), Ge.set(e, t)), t;
}
var ha = class J {
  constructor(t, r) {
  ...
  */
  renderOnce(t) {
    const r = be(this.strings), a = this.getTemplate(r), l = a.element.content.cloneNode(!0), o = this.prepareParts(l, a);
    return this.commit(o), t.appendChild(l), t.__parts = o, t.__templateKey = r, Array.from(t.childNodes);
  }
  renderInto(t) {
    const r = be(this.strings), { element: a } = this.getTemplate(r), l = t.__templateKey;
    if (l && l !== r) {
      const s = t.__parts;
  ...
  getTemplate(t) {
    ...
    for (let x = 1; x < this.strings.length; x++) {
      const z = this.strings[x], R = x - 1, k = /([@.:?]?[\w:-]+)\s*=\s*["']?$/.exec(l), A = /([@.:?]?[\w:-]+)\s*=\s*(["'])([^"']*)$/.exec(l);
      let E = "___";
      if (s) l += ie(R);
      else {
        ...
        if (A && !S)
          ...
          if (k) {
            E = "__";
            const q = k[1].charAt(0);
            Object.keys(o).includes(q) && (E = q);
          }
          if (E === "__" && k) {
            l += ie(R), s = k[1];
            const q = /(["'])$/.exec(k[0]);
    ...
    const C = (x, z) => {
      if (x.nodeType === Node.COMMENT_NODE) {
        ...
        const k = x;
        for (let A = k.attributes.length - 1; A >= 0; A--) {
          const E = k.attributes[A];
          if (E.name.startsWith("__event-")) {
            ...
            if (D) {
              const S = D.indices.length > 1 || D.strings.some((q) => q.length > 0);
              m.push({
                path: [...z],
                type: "attribute",
                index: D.indices[0],
  ...
  */
  ...
  createArrayItem(t, r, a) {
    ...
    t instanceof J ? t.renderInto(l) : t instanceof Node ? l.appendChild(t) : t != null && l.appendChild(document.createTextNode(String(t)));
  ...
  commit(t) {
    for (const r of t) {
      ...
      if (!(!l && !Y(a) && r.type !== "action" && r.previousValue === a)) {
        switch (r.type) {
          case "node":
            if (r.node) {
              const o = Y(r.previousValue), s = Y(a);
              o && !s && r.directiveState && this.clearDirectiveDOM(r), !o && s && this.clearRenderedNodes(r), s ? r.directiveState = a.render(r.node, r.directiveState) : a instanceof J ? this.renderNestedTemplate(r, a) : a instanceof Node ? this.renderNode(r, a) : Array.isArray(a) ? this.renderArray(r, a) : (this.clearRenderedNodes(r), r.node.textContent = String(a ?? ""));
            }
            break;
          case "attribute":
            if (r.node && r.name) {
              const o = r.node;
              if (Y(a)) r.directiveState = a.render(o, r.directiveState);
              else if (l) {
          ...
          case "boolean-attribute":
            ...
            break;
          case "property":
            r.node && r.name && (Y(a) ? r.directiveState = a.render(r.node, r.directiveState) : r.node[r.name] = a);
            break;
          case "event":
            if (r.node && r.name) {
              const o = r.node;
...
const w = i;
var Ke, We = "melodic:outlet-register", xe = class {
  constructor() {
  ...
  */
  ...
  async renderFromContext() {
    ...
    const t = this._context.remainingPath, r = we(this.routes, t, this._context.basePath);
    if (r.redirectTo) {
...
g([H(V), F("design:type", typeof (Ke = typeof V < "u" && V) == "function" ? Ke : Object)], xe.prototype, "_router", void 0);
xe = g([_({
...
g([H(V), F("design:type", typeof (Ue = typeof V < "u" && V) == "function" ? Ue : Object)], ke.prototype, "_router", void 0);
ke = g([_({
...
function ua(e, t, r) {
  ...
  const { href: l, activeClass: o = "active", exactMatch: s = !1, replace: n = !1, data: c = null, queryParams: m = {} } = a, p = N.get(V), h = () => {
    let f = l;
...
var va = class {
  ...
  getEffectsForActionWithoutKey(t) {
    ...
    for (const a of r) {
      ...
      if (l) {
        const o = N.get(l).getEffects().filter((s) => s.actions.some((n) => n().type === t.type));
  ...
  getEffectsForActionWithKey(t, r) {
    ...
    return a ? N.get(a).getEffects().filter((l) => l.actions.some((o) => o().type === r.type)) : [];
  }
  getCurrentState() {
    return Object.keys(this._state).reduce((t, r) => (t[r] = this._state[r](), t), {});
  }
};
g([H($e), F("design:type", Object)], B.prototype, "_state", void 0);
g([H(Ce), F("design:type", Object)], B.prototype, "_reducerMap", void 0);
g([H(ze), F("design:type", Object)], B.prototype, "_effectMap", void 0);
g([H(Ir), F("design:type", Boolean)], B.prototype, "_debug", void 0);
B = g([ee(), F("design:paramtypes", [])], B);
function qs(e, t, r, a = !1) {
  return (l) => {
    l.bindValue($e, e), l.bindValue(Ce, t), l.bindValue(ze, r), l.bindValue(Ir, a), l.bind(B, B, { dependencies: [
      $e,
      Ce,
      ze
    ] });
  ...
  */
  analyzeAndCompile(t) {
    ...
    f < b.length && u.push({ static: b.slice(f) }), this._factory = (x) => {
      ...
      for (const k of m) if (k.valueIndex !== null) {
        const A = x[k.valueIndex];
        A != null && A !== !1 && z.setAttribute(k.name, A === !0 ? "" : String(A));
      } else k.staticValue !== void 0 && z.setAttribute(k.name, k.staticValue);
      let R = "";
      for (const k of u) "static" in k ? R += k.static : R += x[k.valueIndex] ?? "";
...
function Je(e, t, r, a) {
  ...
  if (a.useCompiledPath === void 0 && e.length > 0) {
    const u = r(e[0], 0), b = ga.compile(u.strings);
  ...
  for (const u of n.values()) wa(u);
  if (s.length === 0) {
    a.keyToIndex = o, a.items = [];
    return;
  }
  const m = ya(s), p = a.startMarker.parentElement;
  let h = a.endMarker;
  for (let u = s.length - 1; u >= 0; u--) {
    const b = s[u];
    b.isNew ? fa(b.item, p, h) : m.has(u) || _a(b.item, h), h = b.item.start;
  }
  a.keyToIndex = o, a.items = s.map((u) => u.item);
}
function ba(e, t, r, a, l) {
  const o = a(e, t);
  let s, n;
...
function ya(e) {
  ...
  const a = xa(t), l = /* @__PURE__ */ new Set();
  for (const o of a) {
    const s = r[o];
    s !== void 0 && l.add(s);
  }
...
function d(e, t, r) {
  return U((a, l) => {
    if (!l) {
      ...
      return e ? se(c, !0) : c.falseTemplate && se(c, !1), c.condition = e, c;
    }
    if (!l.startMarker.parentNode) throw new Error("when() directive: markers were removed from DOM");
    if (e && !l.condition)
      Qe(l), l.template = t(), se(l, !0);
    else if (!e && l.condition)
      Qe(l), r && (l.falseTemplate = r(), se(l, !1));
    else if (e && l.condition) {
      const o = t();
...
function re(e, t, r = {}) {
  const { placement: a = "bottom", middleware: l = [] } = r, o = e.getBoundingClientRect(), s = t.getBoundingClientRect(), { x: n, y: c } = Ka(o, s, a);
  let m = {
    x: n,
    y: c,
    placement: a,
...
function ae(e = 0) {
  ...
  return {
    name: "offset",
    fn(a) {
      const { x: l, y: o, placement: s } = a, n = me(s);
      let c = l, m = o;
      switch (n) {
        case "top":
          m -= t, c += r;
...
function le(e = {}) {
  ...
  return {
    name: "flip",
    fn(r) {
      const { x: a, y: l, placement: o, rects: s } = r, n = me(o);
      if (!rt(tt(a, l, s.floating, t), n)) return;
      const c = Wa(o), m = e.fallbackPlacements ?? [c];
      for (const p of m) {
        const h = Ya(s.reference, s.floating, p);
        if (!rt(tt(h.x, h.y, s.floating, t), me(p))) return {
          x: h.x,
          y: h.y,
          placement: p
        };
...
function Lr(e) {
  ...
  return {
    name: "arrow",
    fn(a) {
      const { rects: l, placement: o } = a, s = me(o), n = t.getBoundingClientRect(), c = n.width, m = n.height;
      let p, h;
      if (s === "top" || s === "bottom") {
...
const el = () => "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replaceAll(/[xy]/g, function(e) {
...
function rl(e, t) {
  if (!t) return;
  const { content: r, placement: a } = tl(t);
  if (!r) return;
    ...
    "ml-select--multiple": e.multiple
		...
		>
			...
			<div class="ml-select__control">
				...
				>
					${e.filteredOptions.length ? $(e.filteredOptions, (t) => `${t.value}-${e.multiple ? e.values.includes(t.value) : e.value === t.value}`, (t, r) => Tl(e, t, r)) : i`<div class="ml-select__empty">No results found</div>`}
				</div>
			</div>
...
function Rl(e) {
  return i`
		...
		<span class="ml-select__tags">
			${$(e.selectedOptions, (t) => t.value, (t) => i`
		...
		>
			...
			<div class="ml-slider__track-wrapper">
				<div class="ml-slider__track">
					<div class="ml-slider__fill" style=${W({ width: e.fillWidth })}></div>
				</div>
				<input
		...
		<div class="ml-calendar" role="grid" aria-label=${e.monthLabel}>
			<div class="ml-calendar__header">
				<div class="ml-calendar__nav-group">
					<button type="button" class="ml-calendar__nav" aria-label="Previous year" @click=${e.prevYear}>
				...
				<span class="ml-calendar__month-label">${e.monthLabel}</span>
				<div class="ml-calendar__nav-group">
					...
					<button type="button" class="ml-calendar__nav" aria-label="Next year" @click=${e.nextYear}>
...
function _t() {
  ...
  return de(e.getFullYear(), e.getMonth(), e.getDate());
}
var wt = class {
  constructor() {
    this.value = "", this.min = "", this.max = "", this.viewMonth = (/* @__PURE__ */ new Date()).getMonth(), this.viewYear = (/* @__PURE__ */ new Date()).getFullYear(), this.prevYear = () => {
      this.viewYear--;
    }, this.nextYear = () => {
      this.viewYear++;
    }, this.prevMonth = () => {
      ...
      this.viewMonth = t.getMonth(), this.viewYear = t.getFullYear();
      const r = _t();
  ...
  onAttributeChange(t, r, a) {
    t === "value" && a && this.navigateToValue();
  }
  navigateToValue() {
...
function Fl(e) {
  return i`
    ...
    "ml-date-picker__value--placeholder": !e.value
					...
					${e.value ? e.displayValue : e.placeholder}
				</span>
			</button>
...
var yt = class {
  constructor() {
    this.value = "", this.placeholder = "Select date", this.label = "", this.hint = "", this.error = "", this.size = "md", this.disabled = !1, this.required = !1, this.min = "", this.max = "", this.isOpen = !1, this._cleanupAutoUpdate = null, this.toggleCalendar = () => {
      ...
      t.key === "Escape" && this.isOpen ? (t.preventDefault(), this.closePopover()) : (t.key === "Enter" || t.key === " " || t.key === "ArrowDown") && !this.isOpen && (t.preventDefault(), this.toggleCalendar());
    ...
    "ml-progress--label-right": r
			...
			<div class="ml-progress__bar-row">
				<div class="ml-progress__track-wrapper">
					${d(l, () => i`
						<div class="ml-progress__floating ml-progress__floating--top" style=${W({ left: `${e.percentage}%` })}>
					...
					<div class="ml-progress__track" role="progressbar" aria-valuenow=${e.value} aria-valuemin="0" aria-valuemax=${e.max} aria-label=${e.label || "Progress"}>
						<div class="ml-progress__fill" style=${W({ width: `${e.percentage}%` })}></div>
					</div>

					${d(o, () => i`
						<div class="ml-progress__floating ml-progress__floating--bottom" style=${W({ left: `${e.percentage}%` })}>
...
function Zl(e) {
  return e.shape === "circle" ? Jl(e) : e.shape === "half-circle" ? Ql(e) : Xl(e);
}
const eo = () => w`
	:host {
		display: block;
...
`;
var Br = /* @__PURE__ */ new WeakSet(), To = EventTarget.prototype.addEventListener;
EventTarget.prototype.addEventListener = function(e, t, r) {
  e === "ml:row-click" && Br.add(this), To.call(this, e, t, r);
};
var Vt = class {
  constructor() {
  ...
  onInit() {
    this._rowClickable = Br.has(this.elementRef);
  }
  onCreate() {
...
function Gr(e) {
  ...
  for (const n of t) {
    ...
    const c = [n];
    o.add(n.id);
    let m = M(n.end), p = a.get(n.id) + 1;
    for (const h of t)
      o.has(h.id) || M(h.start) < m && (c.push(h), o.add(h.id), m = Math.max(m, M(h.end)), p = Math.max(p, a.get(h.id) + 1));
    l.push({
      events: c,
      totalColumns: p
    });
  ...
  for (const n of l) for (const c of n.events) {
    const m = M(c.start), p = M(c.end), h = a.get(c.id), u = n.totalColumns;
    s.push({
      event: c,
      gridRowStart: Kt(m),
      gridRowEnd: Kt(p),
...
function Yo(e, t) {
  ...
  return i`
    ...
    a.stopPropagation(), e.handleEventClick(t);
		...
		>
			${d(!t.allDay, () => i`
				<span class="ml-cv__event-pill-time">${j(t.start)}</span>
			`)}
  ...
  return i`
    ...
    l.stopPropagation(), e.handleEventClick(t.event);
		...
		>
			...
			<div class="ml-cv__time-event-time">${j(t.event.start)} – ${j(t.event.end)}</div>
		</div>
	`;
}
function Qo(e) {
  ...
  return i`
    ...
    pe: o,
    colIdx: l
  }))), (a) => a.pe.event.id, (a) => Jo(e, a.pe, a.colIdx))}
				</div>
			</div>
		</div>
	`;
						...
						<div class="ml-cv__sidebar-event" @click=${() => e.handleEventClick(r)}>
							...
							<div class="ml-cv__sidebar-event-content">
								...
								<div class="ml-cv__sidebar-event-time">
									${r.allDay ? "All day" : `${j(r.start)} – ${j(r.end)}`}
								</div>
							</div>
						</div>
					`)}
    ...
    "ml-cv__time-header-day--today": t.isToday
					...
					<div class="ml-cv__time-scroll">
						<div class="ml-cv__time-body ml-cv__time-body--day" style="--cv-rows: ${48};">
							...
							<!-- Events -->
							${$(t.events, (a) => a.event.id, (a) => Zo(e, a))}
						</div>
					</div>
				</div>
			</div>
...
var Wt = class {
  constructor() {
    this.view = "month", this.date = "", this.weekStartsOn = 0, this.maxVisibleEvents = 3, this.addButtonText = "Add event", this.hideNav = !1, this.hideTodayButton = !1, this.hideViewSelector = !1, this.hideAddButton = !1, this.events = [], this.isViewDropdownOpen = !1, this._miniCalYear = 0, this._miniCalMonth = 0, this._hasScrolledToTime = !1, this._boundCloseDropdown = null, this.navigatePrev = () => {
      ...
      let r;
      this.view === "month" ? r = qt(t, -1) : this.view === "week" ? r = G(t, -7) : r = G(t, -1), this.setDate(r);
    }, this.navigateNext = () => {
      const t = this._currentDate;
      let r;
      this.view === "month" ? r = qt(t, 1) : this.view === "week" ? r = G(t, 7) : r = G(t, 1), this.setDate(r);
  ...
  get _currentDate() {
    return this.date ? Bt(this.date) : /* @__PURE__ */ new Date();
  }
  onCreate() {
    if (!this.date) {
  ...
  get weekdayHeaders() {
    return Gt(this.weekStartsOn);
  }
  get monthGrid() {
    const t = this._currentDate, r = Ht(t.getFullYear(), t.getMonth(), this.weekStartsOn);
    for (const a of r) a.events = pe(this.events, a.iso);
    return r;
  }
  get weekColumns() {
...
const oi = (e) => i`<i class="${e.format === "regular" ? "ph" : `ph-${e.format}`}">${e.format === "regular" ? e.icon : `${e.icon}-${e.format}`}</i>`, ii = () => w`
	:host {
		display: inline-flex;
		align-items: center;
		justify-content: center;
    ...
    "ml-sidebar--collapsed": a
		...
		>
			...
			<div class="ml-sidebar__main">
				${t ? $(e.navigation, (l, o) => `nav-group-${o}`, (l) => yi(e, l)) : i`<slot @slotchange=${e.handleDefaultSlotChange}></slot>`}
			</div>

			<div class="ml-sidebar__footer">
				${r ? i`
						<div class="ml-sidebar__footer-nav">
							${$(e.footerNavigation, (l) => l.value, (l) => Le(e, l, 0))}
						</div>
					` : i`
						<div class="ml-sidebar__footer-nav">
  ...
  return i`
		<div class="ml-sidebar__group">
			...
			<div class="ml-sidebar__group-items">
				${$(t.items, (a) => a.value, (a) => Le(e, a, 0))}
			</div>
		</div>
	`;
}
function Le(e, t, r) {
  const a = e.active === t.value, l = !!t.children && t.children.length > 0, o = e.expandedItems.has(t.value), s = e.collapsed, n = v({
		...
		<div class="ml-sidebar__item" style="--level: ${r}">
			...
			${d(l && o && !s, () => i`
				<div class="ml-sidebar__item-submenu">
					${$(t.children, (p) => p.value, (p) => Le(e, p, r + 1))}
				</div>
			`)}
		</div>
	`;
    ...
    "ml-steps--compact": r
		...
		>
			<div
				...
				@keydown=${e.handleKeyDown}
			>
				${t ? $(e.steps, (a) => `${a.value}-${e.active === a.value}`, (a, l) => Ei(e, a, l)) : i`<slot name="step" @slotchange=${e.handleStepSlotChange}></slot>`}
			</div>
...
g([H(Z), F("design:type", typeof (nr = typeof Z < "u" && Z) == "function" ? nr : Object)], Re.prototype, "_dialogService", void 0);
Re = g([_({
  selector: "ml-dialog",
  template: Hi,
  styles: Gi,
...
var ur = class {
  ...
  updatePosition() {
    ...
    if (!t || !r) return;
    const { x: l, y: o, placement: s } = re(t, r, {
      placement: this.placement,
      middleware: [
        ae(8),
        le(),
...
export {
  ...
  it as ButtonGroupComponent,
  st as ButtonGroupItemComponent,
  wt as CalendarComponent,
  Wt as CalendarViewComponent,
  St as CardComponent,
  ct as CheckboxComponent,
  Zr as ComponentBase,
  Fs as ComponentStateBaseService,
  ...
  Rt as StackComponent,
  ir as StepComponent,
  sr as StepPanelComponent,
  ...
  ui as breadcrumbTemplate,
  Fa as breakpointTokens,
  Js as breakpoints,
  ...
  Pl as formFieldStyles,
  Ml as formFieldTemplate,
  ...
  Va as transitionTokens,
  Oa as typographyTokens,
  Ds as unregisterAttributeDirective,
  Hs as unsafeHTML,
