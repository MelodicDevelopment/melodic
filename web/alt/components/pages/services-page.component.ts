		...
		<div class="page">
			<section class="hero">
				<div class="hero-content">
					...
					<p class="hero-lead">
						We offer flexible engagement models designed for teams at every stage &mdash;
						from early validation to production scaling.
					</p>
				</div>
			</section>
				...
				<div class="offerings-grid">
					<article class="offering-card">
						...
						<p class="offering-desc">
							Align stakeholders, validate assumptions, and produce a detailed technical blueprint
					...
					<article class="offering-card featured">
						...
						<h2>Product Build</h2>
						<p class="offering-desc">
							Full-stack product development from concept to launch. We handle architecture,
					...
					<article class="offering-card">
						...
						<p class="offering-desc">
							Embed senior engineers directly with your team to accelerate delivery
							and level up your existing developers.
						</p>
						<ul class="offering-includes">
