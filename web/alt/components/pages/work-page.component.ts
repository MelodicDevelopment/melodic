		...
		<div class="page">
			<section class="hero">
				<div class="hero-content">
					...
					<p class="hero-lead">
						A selection of projects where thoughtful engineering created measurable business impact.
					</p>
				</div>
			</section>
				...
				<div class="cases-grid">
					<article class="case-card">
						...
						<div class="case-content">
							...
							<p>
								A legacy loan approval system was creating bottlenecks for a growing lending platform.
								We rebuilt it as a modern, rules-based workflow engine with real-time decisioning.
							</p>
					...
					<article class="case-card">
						...
						<div class="case-content">
							...
							<p>
								A regional health system needed visibility across 12 disconnected systems.
								We built a unified real-time dashboard that transformed their operations.
							</p>
							<div class="case-results">
								<div class="result">
					...
					<article class="case-card">
						...
						<div class="case-content">
							...
							<p>
								A logistics company was missing SLAs due to delayed delivery visibility.
								We built a real-time tracking system that enabled proactive issue resolution.
							</p>
							<div class="case-results">
								<div class="result">
					...
					<article class="case-card">
						...
						<div class="case-content">
							...
							<p>
								An AI startup needed to scale from prototype to production while maintaining
								sub-second response times. We rebuilt their architecture for 100x scale.
							</p>
							<div class="case-results">
								<div class="result">
