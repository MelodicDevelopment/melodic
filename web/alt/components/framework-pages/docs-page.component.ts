			...
			<section class="docs">
				...
				<main class="doc-content">
					<article>
						<h2>Introduction</h2>
						<p>
							Melodic is a lightweight web component framework built on native browser APIs.
							It provides a familiar, expressive syntax while delivering exceptional performance
...
<span class="keyword">export class</span> <span class="class">HelloWorld</span> {
  <span class="property">name</span> = <span class="string">'World'</span>;
						...
						<p>
							...
							your first Melodic project, or dive into the <a href="#">Quick Start</a> for a
							hands-on tutorial.
						</p>
					</article>
	...
	styles: () => css`
		...
		.code-example .decorator { color: #fbbf24; }
		.code-example .function { color: #60a5fa; }
		.code-example .property { color: #93c5fd; }
		.code-example .class { color: #67e8f9; }
		.code-example .tag { color: #f87171; }
