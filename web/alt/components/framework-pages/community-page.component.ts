...
@MelodicComponent({
	selector: 'alt-framework-community',
	template: () => html`
		<div class="page">
			<section class="hero">
			...
			<section class="community">
				<div class="channels-grid">
					<a href="https://github.com/melodicdev/melodic" class="channel-card">
					...
					<a href="https://github.com/melodicdev/melodic/discussions" class="channel-card">
					...
					<a href="https://discord.gg/melodicdev" class="channel-card">
					...
					<a href="https://twitter.com/melodicdev" class="channel-card">
...
export class AltFrameworkCommunityPageComponent {}
