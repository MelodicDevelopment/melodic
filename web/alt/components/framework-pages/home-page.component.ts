			...
			<section class="hero">
				<div class="hero-content">
					...
					<div class="hero-actions">
						<a class="btn btn-primary btn-lg" :routerLink="/framework/docs">
							Get started
							<svg width="16" height="16" viewBox="0 0 16 16" fill="none">
								<path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
							</svg>
						</a>
						<a class="btn btn-ghost btn-lg" href="https://github.com/melodicdev/melodic">
  ...
  <span class="function">greet</span>() {
    <span class="function">alert</span>(<span class="string">\`Hello, \${<span class="keyword">this</span>.name}!\`</span>);
			...
			<section class="install">
				<div class="install-inner">
					<code class="install-command">npm install @melodicdev/core</code>
	...
	styles: () => css`
		...
		.code-card {
			...
			overflow: hidden;
			box-shadow: var(--alt-shadow-xl), 0 0 40px rgba(6, 182, 212, 0.1);
		}
...
export class AltFrameworkHomePageComponent {}
