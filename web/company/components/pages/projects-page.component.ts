		...
		<div class="page">
			<section class="hero">
				<div class="hero-content">
					...
					<p class="hero-lead">Tools I've built, shared, and continue to maintain for the developer community.</p>
				</div>
			</section>
			...
			<section class="projects">
				<div class="projects-grid">
					<article class="project-card featured">
						<div class="project-header">
							...
							<div class="project-links">
								<a href="https://github.com/melodicdevelopment/melodic" class="project-link">
								...
								<a href="https://framework.melodic.dev/docs" class="project-link">
					...
					<article class="project-card">
						...
						<h3>Melodic Router</h3>
						<p>Built-in routing with nested routes, guards, and lazy loading support.</p>
						<div class="project-tech">
							<span>TypeScript</span>
							<span>Routing</span>
						</div>
					...
					<article class="project-card">
						...
						<h3>Melodic Directives</h3>
						<p>Plugin-friendly directive system for DOM manipulation including repeat, when, classMap, and more.</p>
						<div class="project-tech">
							<span>TypeScript</span>
...
export class CompanyProjectsPageComponent {}
