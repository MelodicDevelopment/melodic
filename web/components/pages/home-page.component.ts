		...
		<div class="page">
			...
			<section class="hero">
				...
				<div class="hero-content">
					...
					<p class="hero-lead">
						A senior engineering studio partnering with ambitious teams to design, build, and ship exceptional digital products.
					</p>
			...
			<section class="framework">
				<div class="framework-inner">
					<div class="framework-content">
						...
						<p>
							The lightweight web component framework we built and use every day. Fast templates, reactive state, built-in routing &mdash; no
