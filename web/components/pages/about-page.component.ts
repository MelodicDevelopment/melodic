		...
		<div class="page">
			<section class="hero">
				<div class="hero-content">
					...
					<p class="hero-lead">We're a small, senior team that's spent years building products at scale. Now we help other teams do the same.</p>
				</div>
			</section>
			...
			<section class="story">
				<div class="story-inner">
					<div class="story-content">
						<h2>Our story</h2>
						<p>
							Melodic Development started from a simple observation: most software projects don't fail because of technology choices. They fail
							because of unclear scope, poor communication, and architecture that doesn't scale.
						</p>
						<p>
							After a decade building products at startups and enterprises, we founded Melodic to offer something different &mdash; a studio that
							combines senior engineering talent with the discipline of a product team.
						</p>
						<p>
							We're remote-first, intentionally small, and selective about the projects we take on. This lets us go deep with every client and
							deliver work we're genuinely proud of.
						</p>
					</div>
				...
				<div class="team-inner">
					...
					<div class="team-grid">
						<div class="team-member">
							...
							<p>15+ years building web applications. Former tech lead at multiple startups. Creator of the Melodic Framework.</p>
