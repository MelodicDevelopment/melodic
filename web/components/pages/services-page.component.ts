		...
		<div class="page">
			<section class="hero">
				<div class="hero-content">
					...
					<p class="hero-lead">
						We offer flexible engagement models designed for teams at every stage &mdash; from early validation to production scaling.
					</p>
				</div>
			</section>
				...
				<div class="offerings-grid">
					<article class="offering-card">
						<div class="offering-header">
							...
							<div class="offering-meta">
								...
								<span class="starting">Starting at $15k</span>
							</div>
						</div>
						<h2>Discovery Sprint</h2>
						<p class="offering-desc">
							Align stakeholders, validate assumptions, and produce a detailed technical blueprint before committing to a full build.
						</p>
						...
						<div class="offering-ideal">
							<h4>Ideal for:</h4>
							<p>Teams validating a new product direction or planning a significant refactor.</p>
						</div>
					</article>
					...
					<article class="offering-card featured">
						...
						<div class="offering-header">
							...
							<div class="offering-meta">
								<span class="duration">8-16 weeks</span>
								<span class="starting">Starting at $80k</span>
							</div>
						</div>
						<h2>Product Build</h2>
						<p class="offering-desc">
							Full-stack product development from concept to launch. We handle architecture, implementation, testing, and deployment.
						</p>
						<ul class="offering-includes">
							<li>Product & technical discovery</li>
							<li>UI/UX design & design system</li>
							<li>Full-stack implementation</li>
							<li>Automated testing & CI/CD</li>
							<li>Launch preparation & handoff</li>
							<li>30-day post-launch support</li>
						</ul>
						<div class="offering-ideal">
							<h4>Ideal for:</h4>
							<p>Teams building a new product or major feature from scratch.</p>
						</div>
					</article>
					...
					<article class="offering-card">
						<div class="offering-header">
							...
							<div class="offering-meta">
								...
								<span class="starting">Starting at $25k/mo</span>
							</div>
						</div>
						<h2>Team Augmentation</h2>
						<p class="offering-desc">
							Embed senior engineers directly with your team to accelerate delivery and level up your existing developers.
						</p>
						<ul class="offering-includes">
							<li>Senior full-stack engineers</li>
							<li>Architecture & code review</li>
							<li>Knowledge transfer & mentoring</li>
							<li>Process optimization</li>
							<li>Technical debt reduction</li>
						</ul>
						<div class="offering-ideal">
							<h4>Ideal for:</h4>
							<p>Teams that need to scale quickly without compromising quality.</p>
						</div>
					</article>
				</div>
			</section>
			...
			<section class="specialties">
				<div class="specialties-inner">
					<div class="section-header">
						...
						<p>We've built production systems across these domains.</p>
					</div>
					<div class="specialties-grid">
						<div class="specialty-item">
							<h3>Web Applications</h3>
							<p>React, Vue, TypeScript, Next.js, custom frameworks</p>
						</div>
						<div class="specialty-item">
							<h3>API Development</h3>
							<p>REST, GraphQL, real-time systems, microservices</p>
						</div>
						<div class="specialty-item">
							<h3>Cloud Infrastructure</h3>
							<p>AWS, GCP, Kubernetes, Terraform, CI/CD</p>
						</div>
						<div class="specialty-item">
							<h3>Data Engineering</h3>
							<p>Pipelines, warehousing, analytics, ML infrastructure</p>
						</div>
						<div class="specialty-item">
							<h3>Design Systems</h3>
							<p>Component libraries, Figma, documentation, accessibility</p>
						</div>
						<div class="specialty-item">
							<h3>Performance</h3>
							<p>Profiling, optimization, caching, load testing</p>
						</div>
					</div>
				</div>
			</section>
				...
				<div class="process-inner">
					...
					<div class="process-steps">
						<div class="step">
							...
							<p>We learn about your goals, constraints, and timeline to see if we're a good fit.</p>
						</div>
						<div class="step">
						...
						<div class="step">
							...
							<h3>Delivery</h3>
							<p>Weekly demos, continuous deployment, and clear communication throughout.</p>
						</div>
					</div>
				</div>
			</section>
			...
			<section class="cta">
				<div class="cta-content">
					...
					<p>Book a 30-minute call to explore how we can help.</p>
...
export class AltServicesPageComponent {}
