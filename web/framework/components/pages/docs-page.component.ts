				...
				<main class="doc-content">
					<article>
						...
						<div class="code-example">
							<pre><code><span class="keyword">import</span> { MelodicComponent } <span class="keyword">from</span> <span class="string">'@nickhoppy/melodic'</span>;
<span class="keyword">import</span> { html } <span class="keyword">from</span> <span class="string">'@nickhoppy/melodic'</span>;
...
export class FrameworkDocsPageComponent {}
