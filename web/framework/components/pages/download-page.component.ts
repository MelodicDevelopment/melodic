		...
		<div class="page">
			...
			<section class="download">
				<div class="download-grid">
					<div class="download-option">
						...
						<div class="code-block">
							<code>npm install @nickhoppy/melodic</code>
					...
					<div class="download-option">
						...
						<div class="code-block">
							<code>yarn add @nickhoppy/melodic</code>
							<button class="copy-btn" title="Copy">
								<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
									<rect x="9" y="9" width="13" height="13" rx="2" ry="2" />
									<path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" />
					...
					<div class="download-option">
						...
						<div class="code-block">
							<code>pnpm add @nickhoppy/melodic</code>
							<button class="copy-btn" title="Copy">
								<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
									<rect x="9" y="9" width="13" height="13" rx="2" ry="2" />
									<path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" />
					...
					<div class="download-option full-width">
						...
						<div class="code-block">
							<code>&lt;script type="module" src="https://unpkg.com/@nickhoppy/melodic"&gt;&lt;/script&gt;</code>
							<button class="copy-btn" title="Copy">
								<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
									<rect x="9" y="9" width="13" height="13" rx="2" ry="2" />
									<path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" />
				...
				<div class="cli-section">
					...
					<div class="code-block">
						<code>npx @nickhoppy/melodic-cli create my-app</code>
						<button class="copy-btn" title="Copy">
							<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
								<rect x="9" y="9" width="13" height="13" rx="2" ry="2" />
								<path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" />
...
export class FrameworkDownloadPageComponent {}
