/**
 * Modified ComponentBase with Signal support
...
export abstract class ComponentBase extends HTMLElement {
	...
	// NEW: Track signal cleanup functions
	...
	disconnectedCallback(): void {
		// NEW: Clean up all signal subscriptions
	...
	/**
	 * NEW: Subscribe to a signal and automatically clean up when component is destroyed
	 */
	...
	private observe(): void {
		...
		for (const prop of properties) {
			...
			// NEW: Auto-subscribe to signals
			if (value instanceof Signal) {
				this.subscribeToSignal(value);
				continue; // Don't wrap signals themselves
			}

			let _val = this[prop as keyof this] !== undefined ? this[prop as keyof this] : value;
