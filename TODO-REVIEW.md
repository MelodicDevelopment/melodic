...
- [x] **[NEW 2026-07-06, found during remediation]** Quoted kebab-case class fields (`public 'dot-color' = …`) never received their attributes — `attributeChangedCallback` camelCases attribute names. Fixed across tag, stat-card, activity-feed-item, profile-card, app-shell, sidebar-item, step (camelCase fields + deprecated quoted aliases).
